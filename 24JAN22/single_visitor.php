...
font-size:16px;
  ...
  <div class="modal-dialog my-auto">
      <div class="modal-content border-0">
        ...
        <img src="https://gjepc.org/iijs-signature/assets/images/popup-31.12.2021.jpg" class="w-100 d-block">
      </div>
    </div>
  </div>
    </div>
      ...
      <div class="container_wrap my-5">
        <div class="container">
          ...
          <img src="images/iijs-signature-postpond.jpg" class="img-fluid" alt="">

		  <p class="d-none"><span class='blink d-block'>2 Vaccine Doses Mandatory For Entry</span> </p>
...
.modal .close {/* top:auto; *//* right:auto; *//* margin:0 15px 0 0; *//* float:none; *//* position:relative; */right: 0;top: -40px;}
