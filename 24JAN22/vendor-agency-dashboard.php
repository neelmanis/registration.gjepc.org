				...
				<div class="content_area box-shadow">
			    	...
			    	<?php if(isset($_REQUEST['action']) && $_REQUEST['action']=='addnew'){?>
                        ...
                        <div class="field">
						    ...
						    <select name="payment_made_for" id="payment_made_for" class="selectField">
						     <option value="signature22" selected="selected">IIJS SIGNATURE 2022 Show</option>
						    </select>
						</div>
						 <div class="field">
			        ...
			        <?php if(!isset($_REQUEST['action']) || $_REQUEST['action']=='view'){?>
			        	...
			        	<div class="d-block p-2">
			        		<h3>Registered Visitors for IIJS SIGNATURE 2022</h3>
			        				...
			        				<?php if($visitorCount  > 0){?>
                                       <tbody>
                                       	<?php 
                                            ...
                                            $global_status = getVendorStatusFromGlobal($registration_id,$rowVisitors['id'],"CONTR",$conn);
                                            switch ($covid_status) {
                                            	case 'P':
                                        ...
                                        <tr>
                                       		...
                                       		<td><?php if ($global_status =="P" && $dose2_status=="Y" ){?>
																							<button class="cta confirmShow" data-visitorid="<?php echo $rowVisitors['id']; ?>" > Click here to confirmed</button>
                                       			<?php }else if($global_status =="Y"){ ?>
                                              <button class="label success"><i class="fa fa-check"></i></button>
                                       		  <?php 	} ?></td>
                                       		<?php if($covid_report_link =='Y'){?>
                                       		<td>
