...
if($action == 'send_otp'){
	...
	if($count>0) 
	{
	  ...
	  $message ='<table cellpadding="10" width="100%" style="margin:0px auto;font-family: Roboto; background-color:#fff;padding:30px; border-collapse:collapse;border:1px solid #000"><tr><td colspan="2" style="background-color:#a89c5d;padding:3px;"></td></tr><tr><td align="left" ><img src="https://registration.gjepc.org/images/logo.png"></td><td align="right"><img src="https://registration.gjepc.org/images/signature-logo.png"></td></tr><tr ><td colspan="2">One Time Password for International Visitor Verification is <b>'.$otp.'</b></td></tr><tr><td colspan="2"><p> For Any Queries : </p><b>Email us on :</b> snehal.rane@gjepcindia.com, naheed@gjepcindia.com </td></tr><tr><td colspan="2"><p>Kind Regards,<br><b>GJEPC Web Team.</b></p></td></tr></table>';
