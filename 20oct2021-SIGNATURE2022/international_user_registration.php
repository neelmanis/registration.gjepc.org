...
<style>
	#regisForm .textField, #form .textField{width: 100%; height:40px; border:1px solid #ccc; color:#6c757d; transition:all 0.3s ease-in-out; -webkit-transition:all 0.3s ease-in-out; -moz-transition:all 0.3s ease-in-out; -o-transition:all 0.3s ease-in-out; border-radius:0; font-size:13px; padding: .375rem .75rem}

#regisForm .textField:focus {border:1px solid #999; color:#000; box-shadow:none; outline:none; transition:all 0.3s ease-in-out; }
...
.title h4 {font-style:normal; font-weight: bold; padding: 7px 7px 7px 0;font-size:14px;/* background:#000; */border-bottom: 1px dashed #a89c5d; color: #9e9457; margin-bottom: 15px;}

#form .field {padding: 0 15px!important;}
</style>
</head>
...
<div class="title">
   ...
   <!--  <div class="borderBottom"></div>  --> 
    ...
    <div id="form" class="row">
        ...
        <div class="field col-sm-6 col-md-4" id="otherDiv" style="display: none;">
    ...
    <div class="row"></div>
    <div class="col-12 body_text">These are the general terms and conditions of&nbsp;Gems and Jewellery Export Promotion Council&nbsp;(GJEPC) for use of the GJEPC web site. Please read these terms and conditions carefully as your use of the Site is subject to them. GJEPC reserves the right at its sole discretion to change, modify or add to these terms and conditions without prior notice to you. By continuing to use the Site you agree to be bound by such amended terms.
    <ol>
    ...
    <div class="form-item col-12" id="edit-terms-checkbox-wrapper">
    ...
    <div class="clear"></div>
    <div><button type="submit" id="register" class="btn btn-default cta ">Submit</button>
		<button type="reset" class="btn btn-default cta ">Reset</button></div>
    <div class="clear"></div>
    </div>      
   </div>
   </div>
