    ...
    function panAction(){
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          $('.loaderWrapper').delay(1000).fadeOut();
          $("#chkPendingPANStatus").html("Already registered for IIJS PREMIERE 2021. To get your badge please upload your vaccination certificate on below given link. <a href='https://registration.gjepc.org/visitor-covid-report-upload.php'>Click here</a>");
                ...
                <div class="d-flex flex-column ">
                  <div class="d-flex flex-row">
                    <div class="col-50 col-m-100 d-flex  flex-wrap form-group">
                     ...
                     <div class="d-flex flex-row">
                    <div class="col-100 d-flex  flex-wrap form-group flex-column">
                    ...
                    <p style="font-size: 15px"><span>International Visitor Registration</span> <a href="https://registration.gjepc.org/single_intl_registration.php" class="gold_text">Click Here</a></p>
                     <p style="font-size: 15px"><span>Vaccination Certificate Upload</span> <a href="https://registration.gjepc.org/visitor-covid-report-upload.php" class="gold_text">Click Here</a></p>
                    </div>                    
                  </div>
              </form> 
