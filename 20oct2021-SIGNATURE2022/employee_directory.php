...
?>
	...
	<div class="clear"></div>
          ...
          <table class="table_responsive">
			...
			?>
              <tr>
                <td data-label="Name"><?php echo strtoupper($owner['name']); ?></td>
                <td data-label="Designation"><?php echo getVisitorDesignationID($owner['designation'],$conn); ?></td>
                <td data-label="Mobile"><?php echo $owner['mobile']; ?></td>
				<td data-label="Photo"><?php if($owner_photo_ext =="pdf" || $owner_photo_ext =="PDF"){?><a href="images/employee_directory/<?php echo $_SESSION['USERID'];?>/photo/<?php echo $owner['photo'];?>" target="_blank"><img src="images/pdf_icon.png"></a><?php }else{?> <img src="images/employee_directory/<?php echo $_SESSION['USERID'];?>/photo/<?php echo $owner['photo'];?>" class="emp_img"><?php } ?></td>
...
(IIJS Signature 2020+IIJS 2020+IIJS Signature 2021+ IIJS 2021+ IIJS Signature 2022) +IGJME 2020</b>"; } 
		  ...
		  ?>
              <tr>
                <td data-label="Name"><?php echo strtoupper($emp['name']); ?></td>  
                <td data-label="Designation"><?php echo getVisitorDesignationID($emp['designation'],$conn); ?></td>
                <td data-label="Mobile"><?php echo $emp['mobile']; ?></td>
				<td data-label="Photo"><?php if($employee_photo_ext =="pdf" || $employee_photo_ext =="PDF"){?><a href="images/employee_directory/<?php echo $_SESSION['USERID'];?>/photo/<?php echo $emp['photo'];?>" target="_blank"> <img src="images/pdf_icon.png"></a><?php }else{?>
