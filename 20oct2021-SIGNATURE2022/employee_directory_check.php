...
$sql = "select * from exh_reg_payment_details where uid='$registration_id' AND `show`='IIJS 2021' AND `year`='2021' AND allow_visitor='N' order by payment_id desc limit 0,1";
...
if (($_REQUEST['action']=='del') && ($_REQUEST['id']!=''))
{
	...
	echo"<meta http-equiv=refresh content=\"0;url=employee_directory_check.php\">";
} 
...
$sqlx1="SELECT registration_id,mobile, email, aadhar_no, pan_no FROM visitor_directory WHERE 1";
...
{
//echo '<pre>'; print_r($mysqlrow); exit;
...
//echo '<pre>'; print_r($match_mob); exit;
if($degn_type == "Owner")
...
elseif(in_array($mobile, $match_mob)){
	$getRegistration = getRegisIDMobile($mobile,$conn);
...
{     
	...
	if($resultx)
	{
	$message = "Dear ".$name.", Welcome to IIJS Premiere 2021, your data for Visitor badge has been updated successfully, you will be notified on approval/disapproval";
//	get_data($message,$mobile); 
	header('location:employee_directory_check.php');
	}	
}
}
...
{	
	...
	if($sqlResult){	header('location:employee_directory_check.php'); }
} 
?>
...
<div class="inner_container">
  ...
  <div class=" content_area">
    ...
    <div class="container_leftn">
      ...
      <div><p style="color:#FF0000;float:left;display: inline;margin-top: 18px"><b>Visitor can apply Registration / make Payment after Approval of Below records</b></p><!--<a href="visitor_registration.php" style="float: right;" class="cta" title="Select Show And Make Payment">Registration Application</a>--></div>
     <div class="clear"></div>
      ...
      <div class="box-shadow">
        ...
        <div class="gp_wrp">			
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="cmxform" method="POST" name="formupload" id="formupload" enctype="multipart/form-data">		  		
				...
				<b>Kindly upload Max 2MB. jpeg, png</b></div>                
              	<div class="field">
		...
		<table class="table_responsive">
			...
			<tbody>
              <tr>
				<td data-label="GST" valign="top" > <?php if($gst_copy_ext =="pdf"){?><a href="images/gst_copy/<?php echo $gst_copy;?>
				...
				<td data-label="PAN" valign="top" > <?php if($pan_no_copy_ext =="pdf"){?><a href="images/gst_copy/<?php echo $gst_copy;?>
        ...
        <div id="formContainer">
          ...
          <div class="title" id="title_open">
            <h4 class="cta">NEW REGISTRATION / ADD VISITOR<div class="plus">+</div> <div class="minus">-</div></h4>            
          </div>
          <?php } else { ?>
          <div class="title" id="title_open">
            <h4 class="cta">NEW REGISTRATION / ADD VISITOR <div class="plus">+</div> <div class="minus">-</div></h4>            
...
?>
          ...
          <form action="" class=" col-100" method="post" name="from" id="form" enctype="multipart/form-data">
            ...
            <div id="form1">
              ...
              <div class="clear"></div>
              <div class="field">
                <label style="height: 65px;"> <sup>*</sup>Photo Passport size with white background : (Max 2MB.jpg, .png)<br></label>
              ...
              <div class="field">
                <label style="height: 65px;"><sup>*</sup> Individual Pan Card : (Max 2MB.jpg, .png)<br></label>
			  ...
			  ?>
                <label style="height: 65px;"><label  id="emp_text" style="display:inline;"> Salary Slip / Bank Statment</label>: (Max 2MB.jpg, .png)</label>
          ...
          <table class="table_responsive">
			...
			?>
              <tr>
                ...
                <td data-label="SIZE"><?php echo getVisitorDesignationID($owner['designation'],$conn); ?></td>
...
(IIJS Signature 2020+IIJS 2020+IIJS Signature 2021+ IIJS 2021+ IIJS Signature 2022) +IGJME 2020</b>"; } 
                ...
                <?php } else { ?>                
                <a href="employee_directory_check.php?action=edit&id=<?php echo $owner['visitor_id'];?>"><img src="images/edit.png" title="Edit" border="0" /></a> /
                <a href="employee_directory_check.php?action=del&id=<?php echo $owner['visitor_id']?>" onclick="return(window.confirm('Are you sure you want to delete?'));">
		  ...
		  ?>
              <tr>
                ...
                <td data-label="SIZE"><?php echo getVisitorDesignationID($emp['designation'],$conn); ?></td>
                ...
                <img src="images/done.png" title="Approved" border="0" /> / <img src="images/eye.png" onclick="window.location.href='employee_details.php?id=<?php echo $encrypted_id;?>'"  title="View Details" border="0" />
                <?php } else { ?>
                <a href="employee_directory_check.php?action=edit&id=<?php echo $emp['visitor_id'];?>"><img src="images/edit.png" title="Edit"/></a> / 
                <a  href="employee_directory_check.php?action=del&id=<?php echo $emp['visitor_id']?>" onclick="return(window.confirm('Are you sure you want to delete?'));"> 
