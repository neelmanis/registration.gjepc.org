...
if(isset($_REQUEST['action']))
{
	...
	if($action=="login")
	{
		...
		{				
			...
			$_SESSION['url']="admin_manual_list.php";
...
<style>
    ...
    height: 100%;
    z-index: 9999;
    background: url('https://registration.gjepc.org/images/loaderp.gif') 50% 50% no-repeat rgb(249,249,249);
    opacity: .80;
	}
	.loader p{
	position: fixed;
