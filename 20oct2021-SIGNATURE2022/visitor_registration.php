            ...
            <table class="table_responsive">
                ...
                <tbody>
                  <tr>
                    ...
                    <td data-label="TRACode"><input type="button" name="add_visitor" id="add_visitor" value="ADD" class="cta" disabled/></td>
...
<input type="hidden" name="billing_delivery_id" id="billing_delivery_id"/>
              ...
              <table class="table_responsive">
                ...
                <tbody>
                  ...
                  <tr>
                    <td data-label="GST">GST(18%)</td>
                    <td data-label="GST">: <?php echo $gst_amount = round($amount*18/100);?>
					<input type="hidden" name="gst_amount" id="gst_amount" value="<?php echo base64_encode($gst_amount);?>"/></td>
                  </tr>
                  <tr>
                    <td data-label="Total Payable">Total Payable</td>
                    <td data-label="Total Payable">: <?php echo $total_payable;?> 
