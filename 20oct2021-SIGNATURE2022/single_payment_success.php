...
?>
	...
	{ 
		...
		$message = "Thank you for registration at IIJS PREMIERE 2021. Your ORDER ID for Visitor registration is $clnt_txn_ref. Your badge will be couriered shortly.";
		//	get_data($message,$ownerMobile); 

		//$messagev = "Thank you for registration at IIJS PREMIERE 2021. Your Unique ID number is $clnt_txn_ref. Please make sure to do your RT PCR Covid-19 test 72 hours before the show visit. Please download GJEPC App to get the E-Badge of the show. Your E Badge will get activated Only after successful submission of negative report.";
		
		$website = "IIJS PREMIERE 2021";
		$messagev = "Thank you for registration at $website. Your Unique ID number is $clnt_txn_ref. Please download GJEPC App to get the E-Badge of the show. Your E Badge will be available Only after approval of vaccination certificate.";
		if($isSecondary=='Y'){
        ...
        <tr>
            <td align="center" colspan="3">
                <p style="line-height:25px;">
					...
					<b>Toll Free Number :</b> 1800-103-4353, <b>Missed Call Number :</b> +91-7208048100<br>Website: https://gjepc.org/iijs-premiere/ Email: visitors@gjepcindia.com</p>
            </td>
        </tr>            
	...
	//	header("Refresh: 2; url=https://registration.gjepc.org/visitor_registration.php");
		...
		<div id="">
		<p>Your transaction is successfully Completed. Thank you for your Visitor Registration in IIJS PREMIERE 2021 SHOW.</p>
