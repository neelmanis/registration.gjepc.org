...
$closetime = strtotime("31-08-2021 23:55:00");
?>
	<?php
	/* IVR Start */
				...
				<div class="content_area">					
					...
					if($_SESSION['COUNTRY']=="IN")
					{
					   ...
					   if($show_status_pvr['obmp_application_status']==1) {
						// echo '<a href="visitor_registration.php" class="btn col-100" title="Select Show And Make Payment">IIJS premier Registration 2021</a>';
						...
						echo '<a href="member_obmp_profile.php" class="btn col-100 " title="Select Show And Make Payment">IIJS premier Registration 2021</a>';
						  //echo '<a href="#" class="btn col-100 " title="Select Show And Make Payment"><span>Step 2 - </span>Registration Application</a>';
						} 
					//	echo '<a href="visitor-covid-report-upload.php" class="btn col-100 "  title="">Vaccination Certificate Upload</a>';
					...
					{			
						...
						echo '<a href="exhibitor_registration_print_application.php" target="_blank" class="btn col-100" title="View Summary">Click here to access Exhibitor Manual/Stall Payment Details </a>';
						}	
						echo '</div></div>';
					} 
