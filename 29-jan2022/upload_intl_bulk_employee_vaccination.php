            ...
            <form method="POST" name="regisForm" id="regisForm">
                ...
                <div class="row">
					<div class="col-md-6 form-group">
						<?php
						$checkHistory = "SELECT * FROM `ivr_registration_history` WHERE registration_id='$registration_id' AND (`show`='signature22' || `show`='iijstritiya22') AND `status`='1' AND payment_status='Y' group by visitor_id";
