                        ...
                        <div class="modal-content ">
                            ...
                            <div class="modal-body text-center p-0  border-0">
                               <div class="img-container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <img src="" id="crop_image" class="img-fluid h-100 w-50" />
                                    </div>
                                    <div class="col-md-4">
                    ...
                    <div id="loginForm">
                        <div class="box-shadow">
                            ...
                            <div class="col-sm-6 col-md-4 form-group">
                                ...
                                <input type="file" class="form-control preview_crop" id="photo" name="photo" autocomplete="off" data-ref='photo'    data-crop="1"  accept=".jpg,.jpeg,.png" data-toggle="tooltip" data-placement="top" title="Photo Passport size with white background"/>
