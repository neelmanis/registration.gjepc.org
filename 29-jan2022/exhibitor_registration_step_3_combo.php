...
//echo '<pre>'; print_r($_SESSION['signatureInfo']);
?>
		...
		if(submitid =="submitIijs"){
			...
			success:function(result){
				...
				if(result.status==result.name+'_empty'){
					...
					$('#form2').removeClass('overlay_blur');
					$("#submitIijs").attr('value',"Submit IIJS Signature 2020 Data");
...
<div class="inner_container">
    ...
    <div class="form_wrp">	
        <p style="text-align: center;"><strong>Note:</strong><span  style="color: red"> Kindly submit the IIJS Premiere 2020 form first,  in order to submit the IIJS signature registration form 2020</span></p>
    ...
    <form  method="post" name="form1" id="form1" style="width:50%; float:left; border-right:2px dotted #ddd; box-sizing:border-box;" >
	...
	$last_query = "select * from exh_registration where uid='$registration_id' AND `show`='IIJS 2019' AND last_yr_section_flag='1' AND  curr_last_yr_check='N' order by exh_id desc limit 0,1";
	...
	$query=$conn->query("select * from exh_registration where uid='$registration_id' AND `show`='IIJS 2020'");
	...
	?>
        ...
        <div class="field_box">
         ...
         <div class="field_input" style="padding-top:5px;">
         <div class="chkbox" style="width:100px;"><?php echo $_SESSION['member_type'];?></div>
         </div>
         <div class="clear"></div>
        </div>
        <?php if($num1>0){ ?>
        ...
        <?php } ?>
       <div class="field">
        <strong> Please select any of the option </strong> <span>*</span> : <br/>
       ...
       <div style="margin-top:175"></div>
        ...
        Same area but different location as of previous year IIJS<br/>  
	...
	<form  method="post" name="form2" id="form2" style="width:50%; float:left;" class="overlay_blur">
	...
	?>
        <div class="field_box">
            ...
            <div class="chkbox" style="width:100px;">
              <span class="chkbox" style="width:100px;">
              <?php if($result_signature1['last_yr_participant']=='YES'){ echo $last_yr_signature="YES"; } else {echo $last_yr_signature="NO";}?>
              </span>
    ...
    <input type="submit" id="submitIijs" class="button" value="Submit IIJS Premiere 2020 Information" disabled='disabled' />
    </div>
