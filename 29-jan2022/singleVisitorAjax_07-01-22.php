...
if(isset($registration_id) && $registration_id!=""){
	...
	{
	// 	 For Machinery Start
		if($payment_made_for=="igjme22" && $temp_total_amount==0 )
		{
...
// 	$message = "Dear ".$first_name.", Welcome to IIJS SIGNATURE 2022, your data for Visitor badge has been updated successfully, you will be notified on approval/disapproval";
	$message = "Dear ".$first_name.", Thank you for showing your interest in visiting $website. Your documents are successfully uploaded for visitor registration, you will be notified shortly on approval/disapproval of documents. For any further query please contact $tollNumber GJEPC";
