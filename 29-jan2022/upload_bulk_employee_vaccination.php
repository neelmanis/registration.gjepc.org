            ...
            <form method="POST" name="regisForm" id="regisForm">
                ...
                <div class="row">
					<div class="col-md-6 form-group">
						<?php
						$checkHistory = "SELECT * FROM `visitor_order_history` WHERE registration_id='$registration_id' AND (`show`='signature22' || `show`='iijs21') AND `status`='1' AND payment_status='Y' group by visitor_id";
					...
					</div>Select Visitor Add & Update Vaccine Certificate
				  <div class="col-12">
