             ...
             //    } else {
              ...
              <form class="" method="POST" id="singleVisitorRegistration" autocomplete="off">
                ...
                <div class="row">
                  ...
                  <div class="col-12 form-group">
                    <input type="checkbox" name="agree" value="YES" checked="">I also agree to receive information from GJEPC via Whatsapp & other Media <a href="pdf/<?php echo $evt_term_condition_file; ?>" target="_blank" style="color: red; text-decoration: underline;font-size: 12px;">Read More...</a>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4 form-group">
                    ...
                    <select name="payment_made_for" id="payment_made_for" onchange="fees_calculate(this.value,<?php echo $registration_id;?>)" class="select-control" style="width:100%">
                      <option value="">--- Please Select One ---</option>
                    <?php
                      $sql_history  = "SELECT `payment_made_for` FROM  `visitor_order_history` WHERE visitor_id='$visitor_id' and registration_id ='$registration_id' ";
                  ...
                  <div class="col-12 form-group" style="padding-left: 10px">
                    ...
                    I also agree to receive information from GJEPC via Whatsapp & other Media <a href="pdf/<?php echo $evt_term_condition_file; ?>" target="_blank" style="color: red; text-decoration: underline;font-size: 12px;">Read More...</a>
                  </div>
