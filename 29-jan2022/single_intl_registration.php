        ...
        <!--<form method="POST" id="passportForm" autocomplete="off">            
            <div class="row justify-content-between">
              ...
              <!--<div class="col-md-1 d-none d-md-block">
                <div class="md_border"></div>
              </div>

              <div class="col-md-5 nvv_btn align-self-center">
                <a href="https://registration.gjepc.org/international_user_registration.php" class="fade_anim gold_text"><strong>New International Company Visitor Registration</strong></a>
              </div>
			  --
