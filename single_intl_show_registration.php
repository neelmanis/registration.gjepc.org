...
$uid = $_SESSION['uid'];
$eid = $_SESSION['eid'];
if(empty($uid)){ header("location:international_visitor_event_registration.php"); }
...
if($isVerified == 0){
header("location:international_visitor_event_registration.php");
}
} else { header("location:international_visitor_event_registration.php"); } 
?>
              ...
              <form class="" method="POST" id="singleVisitorRegistration" autocomplete="off">
                ...
                <div class="row">
                 ...
                 <!--  <div class="col-12 form-group">
                  ...
                  <div class="col-md-4 form-group">
                    ...
                    <select name="trade_show" id="trade_show" class="select-control">
                     <!--  <option value="">--- Please Select One ---</option> -->
                      <?php
                      $sql_history = "SELECT `show` FROM `ivr_registration_history` WHERE visitor_id='$eid' and registration_id ='$uid'";
                      $result_history = $conn->query($sql_history);
                      $registered_events = array();                      
                      while($row_history = $result_history->fetch_assoc()){
                        $registered_events[] = $row_history['show'];
                      }
                  ...
                  <div class="col-12 form-group">
                  <a class="" style="color: blue; cursor: pointer; font-size: 15px;" data-toggle="modal" data-target="#exampleModal133" > <input type="checkbox" name="agree_plantation" /> I agree to plant 10 trees with the cost of 155/- per tree.  <span class="blink">Click Here.</span></a>
                </div>
