...
//	$amountPaid = $payment->amountPaid;
    ...
    $logo_path = "https://registration.gjepc.org/images/signature_logo_new_2023.jpg";
    } else if($eventDescription == "IGJME"){
    $logo_path = "https://registration.gjepc.org/images/igjme-logo.png";
    } else { 
    $logo_path = "https://registration.gjepc.org/images/Tritiya_Logo__new_2023.jpg";
    }
...
<table width="100%" border="0" background="#fff" cellpadding="0" cellspacing="0">
	<tr>
    	...
    	<td align="right"><a href="https://registration.gjepc.org/"><img src="'.$logo_path.'"/></a></td>
    </tr> 
	...
	<tr>
    	...
    	<p>Thank you for applying Online for '.$eventDescription.' Exhibitor Registration. Please note your application is under approval process.</p>    	
    	</td>
    </tr>
...
<table width="100%" border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="8" bgcolor="#f4f4f4" style="border-collapse:collapse; float:right;">
 ...
 <!-- <tr valign="top">
  ...
  <tr valign="top">
	...
	$subject = "Exhibitor Registration For $eventDescription";
	$cc = "";
