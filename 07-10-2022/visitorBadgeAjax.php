...
if($action == 'pan_number'){
	...
	if($count>0) 
	{
		...
		$checkHistory = "SELECT * FROM `visitor_order_history` WHERE visitor_id='$visitorID' AND (payment_made_for='combo23' OR payment_made_for='iijs22' OR payment_made_for='igjme22')  AND `status`='1' AND payment_status='Y'";
