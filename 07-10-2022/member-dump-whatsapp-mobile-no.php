...
$checkHistory = "SELECT distinct(mobile) FROM gjepclivedatabase.whatsapp_number_directory where `type`='member' and isPush='N' limit 2000 ";
...
if($num>0)
{
	...
	{ //echo '<pre>'; print_r($resultHistory);
		  ...
		  $checks = "SELECT mobile_no FROM gjepclivedatabase.communication_address_master where mobile_no='$mobile_no' AND whatsapp_verified='0' ";
			echo '<br/>';
