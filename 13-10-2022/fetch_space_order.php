...
$sqlAPI = "SELECT * FROM `utr_history` WHERE 1 AND registration_id='".$_SESSION['USERID']."' AND (`event_selected` = 'iijs') AND (payment_status='pending' || payment_status='')";
...
//	print_r($payment['items']);
	...
	/*$update_query = "update exh_reg_payment_details set payment_status='approved', document_status='approved',application_status='approved',application_comment='dashboard' where uid='$registration_id' and `show`='IIJS PREMIERE 2022'";
