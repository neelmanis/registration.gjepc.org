  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%; border:5px solid #D4B5A6;height:553.7px;overflow:hidden;" valign="top">
            <div style="height:553.7px; position:relative">
              <table cellpadding="8" cellspacing="0" style="width: 100%;">
                ...
                <div style="background: #D4B5A6; width:100%; color:#000; padding:10px 0; position:absolute; bottom:0; text-align:center">
          ...
          <td style="width: 50%; height:553.7px; border:5px solid #D4B5A6;">
            <div style="height:553.7px; position:relative">
              ...
              <div style="background: #D4B5A6; width:100%; color:#000; padding:22.5px 0; position:absolute; bottom:0; text-align:center">
        ...
        <tr>
          ...
          <td align="center" style="width: 50%; border:5px solid #D4B5A6; height:553.7px; overflow:hidden" valign="middle">
          ...
          <td style="width: 50%; border:5px solid #D4B5A6; height:549px" valign="top">
