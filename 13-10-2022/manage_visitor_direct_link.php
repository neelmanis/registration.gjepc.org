...
$_SESSION['regis_id'] = $_REQUEST['registration_id'];
...
if($_REQUEST['action'] =="save")
{
	...
	elseif(isset($_SESSION['regis_id']) && $_SESSION['regis_id']!="")
	{
		...
		if($resultx){ 
			...
			header("Refresh:5; url=manage_visitor_direct_link.php?registration_id=$registration_id");
        }
	}else{
...
if($_REQUEST['action'] == "update")
{
	...
	elseif(isset($_SESSION['regis_id']) && $_SESSION['regis_id']!="" && $visitor_id !=="")
	{
		...
		if($resultx){ 
			...
			//header('location:manage_visitor_direct_link.php');
			header("Refresh:5; url=manage_visitor_direct_link.php?registration_id=$registration_id");
        }
	}else{
	 	header('location:domestic_user_registration_step1.php');
...
<noscript><img height="1" width="1" style="display:none"
    ...
    <div class="container_wrap">
           ...
           <h2 class="title2">Manage employee directory</h2>
					...
					<form class="" method="POST" enctype="multipart/form-data" name="regisForm" id="regisForm" autocomplete="off"> 
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-4 form-group">
					      		...
					      		<input id="photo"  name="photo" type="file"  class="imgsel form-control" value="<?php echo $photo; ?>" data-imgsrc="blah1" accept="image/*" capture="camera" /> <p class="fail" id="photoSizeError"></p> 
          ...
          <!-- <div class="borderBottom"></div> -->
            ...
            <?php
            //echo "select * from visitor_directory where degn_type = 'Owner' and registration_id='$registration_id' and status='1'";
...
(IIJS Signature 2020+IIJS 2020+IIJS Signature 2021+ IIJS 2021+ IIJS Signature 2022) +IGJME 2020</b>"; } 
                ...
                <?php } else { ?>                
                <a href="manage_visitor_direct_link.php?action=edit&id=<?php echo $owner['visitor_id'];?>&registration_id=<?php echo $registration_id; ?>"><img src="images/edit.png" title="Edit" border="0" /></a> /
      ...
      <?php } ?>
		  ...
		  ?>
              <tr>
                ...
                <?php } else { ?>
                <a href="manage_visitor_direct_link.php?action=edit&id=<?php echo $emp['visitor_id'];?>&registration_id=<?php echo $registration_id; ?>"><img src="images/edit.png" title="Edit"/></a> / 
