							...
							<div class="col-12 mb-2">
								<div class="d-block">
									<input type="checkbox" name="agree" value="YES"> I Accept that <br/>
										...
										<li>I have read and understood the <a href="pdf/Visitor-Terms-Conditions-IIJS-Signature-2022.pdf" target="_blank"><strong>terms and conditions</strong></a> with regard to the visitor's registration at IIJS PREMIERE 2022</li>
