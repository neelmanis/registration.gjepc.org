...
if((@$_REQUEST['action']=='del') && ($_REQUEST['id']!==''))
{
	...
	echo "<meta http-equiv=refresh content=\"0;url=student_directory.php\">";
} 
...
elseif(empty($pan_no))
{$signup_error="Please Enter College ID";}
...
{ $signup_error="ID not uploaded due to server error";
}
else
{     
...
{ 	
	$sqlm.="update visitor_directory set registration_id='$registration_id', shows='$shows', year='$year', gender='$gender', name='$name', lname='$lname', degn_type ='$degn_type', designation='18', mobile='$mobile', email='$email',aadhar_no='$aadhar_no', pan_no='$pan_no'";
...
{	
	...
	if($sqlResult){	header('location:student_directory.php'); }
} 
?>
...
var par = $('#p').val();
	...
	$("#form").validate({
		...
		messages: {	
			...
			pan_copy:{
				required: "Please Upload ID Card Copy",
				accept: "Only Image Type JPG/PNG/JPEG is allowed"
			},
			salary:{
...
<div class="wrapper">
	...
	<div id="preloader">
  	...
  	<div class="container my-5">
		...
		<h2 class="title2 text-center">Institute Register / make Payment after Approval of Below records</h2>
        <div class="box-shadow">
		<a href="institute_dashboard.php" class="submitbtn"> Back</a>
        	...
        	<div id="formContainer" class="p-0 mt-4">
         	...
         	<?php if($_REQUEST['action']=="edit"){ ?>
          	...
          	<div class="title m-0 float-none" id="title_open">
            	<h4 class="cta border-0">NEW REGISTRATION / ADD Student<div class="plus">+</div> <div class="minus">-</div></h4>  
            </div>
          	...
          	<div class="form_detailp"></div>          	
          		...
          		<form action="" method="POST" name="from" id="form" enctype="multipart/form-data">
		    			...
		    			<div class="row">
		              	...
		              	<div class="col-sm-6 col-md-4 form-group">
			               ...
			               <select class="select_v form-control" name="gender" id="gender">                                  
							...
							<div class="col-sm-6 col-md-4 form-group">
								<label><sup>*</sup>Student College ID </label>
								<input id="pan_no" name="pan_no" type="text" class="form-control" maxlength="20" value="<?php echo $pan_no; ?>"/> 
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-4 form-group">
								<label><sup>*</sup> Individual ID Card : (Max 2MB.jpg, .png)<br></label>
							...
							<div class="col-sm-6 col-md-4 form-group" id="salary_slip">
								...
								?>
								<label><label  id="emp_text" style="display:inline;"> Recommendation Letter</label>: (Max 2MB.jpg, .png)</label>
		  ...
		  ?>
              <tr>
                ...
                <?php } else { ?>
                <a href="student_directory.php?action=edit&id=<?php echo $emp['visitor_id'];?>"><img src="images/edit.png" title="Edit"/></a> / 
                <a  href="student_directory.php?action=del&id=<?php echo $emp['visitor_id']?>" onclick="return(window.confirm('Are you sure you want to delete?'));"> 
