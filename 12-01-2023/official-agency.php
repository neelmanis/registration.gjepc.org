              ...
              <div style="border:5px solid #000;height:551px;">
                <table cellpadding="8" cellspacing="0" style="width: 100%;">
                  <tbody>
                    ...
                    <tr>
                      <td colspan="2" align="center" style="background:magenta; padding:21px 0; font-size: 28px; color: #fff;;font-weight:bold;">
                        OFFICIAL AGENCY
                      </td>
                    </tr>
                  </tbody>
                      ...
                      <td style="text-align:center">
                        <table style="width:100%">
                          ...
                          <tr>
                            ...
                            <td> 
                              <p style="margin:0 0 4px 0">Any time during the exhibition</p>
                            </td>
                          </tr>
                        </table>
                      </td>
