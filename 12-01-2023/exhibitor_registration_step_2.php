...
/*  Check Event */
/*
 if($_SESSION['eventInfo']['event_selected']=="signature"){ $show="IIJS SIGNATURE 2022"; } 
 if($_SESSION['eventInfo']['event_selected']=="iijs") { $show="IIJS 2022"; } 
*/

$event_selected = $_SESSION['eventInfo']['event_selected'];
$show = getExhEventDescriptionEvent($event_selected,$conn);
/*  Check Event */
?>
<?php
...
//echo '<pre>'; print_r($_SESSION['companyInfo']);
	...
	{
	$getcompanyInfo = stripslashes($_SESSION['companyInfo']);
...
if($action=="Save")
{
	...
	if($_SESSION['eventInfo']['event_selected']=='combo'){
		header("location:exhibitor_registration_step_3_combo.php"); exit; 
	} else if($_SESSION['eventInfo']['event_selected'] == "igjme23") { header("location:exhibitor_registration_igjme_step_3.php"); exit; } 
	else { header("location:exhibitor_registration_step_3.php"); exit; }
}
?>
...
<div class="inner_container">
    ...
    <div class="form_main">    
        ...
        <div class="field_input"><input type="text" id="last_yr_turn_over" name="last_yr_turn_over" value="<?php echo $last_yr_turn_over;?>" />
