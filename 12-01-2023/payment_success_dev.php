...
if(isset($_POST))
{
	...
	$clnt_txn_ref = "SIGN221555776"; //Merchant Reference Number i.e. orderID
	...
	//	$messagev = "Thank you for registration at IIJS SIGNATURE 2022. Your Registration Number is $visitor_id for ORDER ID $orderId.Your badge will be couriered shortly";
		$messagev = "Thank you for registration at $website. Your Unique ID number is $orderId. Please download GJEPC App to get the E-Badge of the show. Your E Badge will available Only after approval of vaccination certificate.";
	...
	/*	$to = $email;
		...
		*/
		...
		//header('Location: https://iijs.org/visitor_registration.php');
		 header("Refresh: 2; url=https://registration.gjepc.org/visitor_registration");
		...
		<div id="formWrapper">
		<p>Your transaction is successfully Completed. Thank you for your participation in IIJS SIGNATURE 2022 Show.</p>
