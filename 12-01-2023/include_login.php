...
{  //echo '<pre>'; print_r($_SESSION); echo '---->'.$_SESSION['captcha_code']; exit;
	...
	$login_for = mysqli_real_escape_string($conn,trim($_POST['login_for']));	
	...
	$sql  = "select * from registration_master where email_id='$email_id' and company_secret='$password' and status=1 and type_of_company!='institute'";
	...
	if($num>0)
	{
	  ...
	  if($login_for =="tree_plantation"){
	  	header('location:exhibitor_registration_print_application.php?show=signature&year=2023');
	  }else{
...
?>
	...
	<?php token(); ?>
	<input type="hidden" name="login_for" value="<?php echo $login_for; ?>">
	...
	<div class="col-12 form-group"> <img src="captcha_code_file.php?rand=<?php echo rand();    ?> <div class="col-12 form-group"><input type="submit" value="Login" /></div>
    ...
    <?php if(isset($_REQUEST['visitor']) && $_REQUEST['visitor']=="international" ){?> 
   <!-- <div class="application_notes black_bg ">
    <h3>Registration Process</h3>
    <p>For Approved/Registered Visitors</p>
    <ul class="inner_under_listing">
        <li>Login with username and password</li>
        <li>Add new visitor or select registered profile</li>
    ...
    <ul class="inner_under_listing">
        ...
        <li>After approval of your profile  you will be considered as registered visitor</li>
    </ul>
...
<!-- <div class="application_notes black_bg ">
    ...
    <ul class="inner_under_listing">
        <li>Login with username and password</li>
        <li>Add new visitor or go to registration application</li>
        <li>Select the show and submit your application</li>
    </ul>
    <p>For New Registration</p>
    <ul class="inner_under_listing">
        <li>Click on New Registration  </li>
        <li>Update the data, upload necessary documents and submit</li>
        <li>After approval of your profile you can select show and register for IIJS Virtual Show 2020</li>
    </ul>
