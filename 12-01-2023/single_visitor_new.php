            ...
            success:function(data){
              ...
              if(data.status=="success"){
                 $('label[for="company_pan_no"]').removeClass("text-danger").addClass("text-success").text(data.message);
                   ...
                   $('label[for="company_pan_no"]').removeClass("text-success").addClass("text-danger").text(data.message);
        ...
        success:function(data){
          ...
          if(data.status=="success"){
             $('label[for="company_pan_no"]').removeClass("text-danger").addClass("text-success").text(data.message);
                ...
                $("#company_div").show();
                $("#fetchedCompanyName").text(data.company_name);
            ...
            <form method="POST" id="companyChangeForm" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                      <label><strong>Company Pan Number</strong></label>
