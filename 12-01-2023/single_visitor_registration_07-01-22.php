  ...
  <body>
    <div class="wrapper">
      ...
      <div class="container_wrap">
        <div class="container">
          <h2 class="title2">IIJS SIGNATURE SHOW - Visitor Registration </h2>
          <div id="loginForm">
            ...
            <div class="box-shadow">
              ...
              $checkHistory = "SELECT * FROM `visitor_order_history` WHERE registration_id='$registration_id' AND visitor_id='$visitor_id' AND (payment_made_for='6show' OR payment_made_for='5show' OR payment_made_for='4show' OR payment_made_for='combo') AND `status`='1' AND payment_status='Y'";
              ...
              <form class="" method="POST" id="singleVisitorRegistration" autocomplete="off">
                ...
                <div class="row">
                  ...
                  <div class="col-12 form-group">
                    <input type="checkbox" name="agree" value="YES" checked="">I also agree to receive information from GJEPC via Whatsapp & other Media <a href="pdf/Visitor-Terms-Conditions-IIJS-Signature-2022.pdf" target="_blank" style="color: red; text-decoration: underline;font-size: 12px;">Read More...</a>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4 form-group">
                    ...
                    <select name="payment_made_for" id="payment_made_for" onchange="fees_calculate(this.value,<?php echo $registration_id;?>)" class="select-control" style="width:100%">
                      <option value="">--- Please Select One ---</option>
                      <option value="signature22" <?php if($payment_made_for=="signature22") echo "selected"; ?>>IIJS SIGNATURE 2022 Show</option>
                      <!--<option value="igjme22" <?php if($payment_made_for=="igjme22") echo "selected"; ?>>Machinery</option>-->
                    </select>
                    <?php
                    }
                    ?>
                  ...
                  <div class="col-12 form-group" style="padding-left: 10px">
                    ...
                    I also agree to receive information from GJEPC via Whatsapp & other Media <a href="pdf/Visitor-Terms-Conditions-IIJS-Signature-2022.pdf" target="_blank" style="color: red; text-decoration: underline;font-size: 12px;">Read More...</a>
                  </div>
