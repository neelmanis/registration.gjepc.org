...
//	$amountPaid = $payment->amountPaid;
	...
	$sqlmx="select contact_person,region from exh_reg_general_info where uid='$registration_id' and event_selected='iijs' AND event_for='IIJS 2022' order by id desc limit 0,1";
	...
	$sqlm = "SELECT * FROM `exh_registration` WHERE uid='$registration_id' AND gid='$gid' AND `show`='IIJS 2022' AND event_selected='iijs' order by exh_id desc limit 0,1";
...
<table width="100%" border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="8" bgcolor="#f4f4f4" style="border-collapse:collapse; float:right;">
 ...
 <!-- <tr valign="top">
  ...
  <tr valign="top">
    ...
    $return['redirect'] = "my_dashboard_uat.php";
