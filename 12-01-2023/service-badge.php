  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%; border:5px solid #ea80fc;height:553.7px;overflow:hidden;" valign="top">
            <div style="height:553.7px; position:relative">
              ...
              <div style="text-align:center;position:absolute; bottom:75px;width:100%">
              <p style="font-size: 18px;"><strong>No Entry Into Any Exhibition Hall</strong></p>
              </div>
                <div style="background: #ea80fc; width:100%; color:#fff; padding:10px 0; position:absolute; bottom:0; text-align:center">
                  <strong style="font-size: 30px;">SV</strong><br>
                  <p style="font-size: 28px; margin: 0; font-size: 20px; ">Service</p>
                </div>
          ...
          <td style="width: 50%; height:553.7px; border:5px solid #ea80fc;">
            <div style="height:553.7px; position:relative">
              ...
              <div style="background: #ea80fc; width:100%; color:#fff; padding:22.5px 0; position:absolute; bottom:0; text-align:center">
        ...
        <tr>
          ...
          <td align="center" style="width: 50%; border:5px solid #ea80fc; height:553.7px; overflow:hidden" valign="middle">
          ...
          <td style="width: 50%; border:5px solid #ea80fc; height:549px" valign="top">
