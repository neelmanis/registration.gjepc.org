...
<div class="container_wrap">
  <div class="container">
    <div class="btnwrap" style="display: flex;justify-content: space-around;"> 
    <button type="button" class=" col-sm-5 col-xs-12 gold_bg" style="padding: 20px 15px ;width: 45%;outline: none;font-size: 21px;font-weight: bold; cursor: pointer;"  onclick="window.location.href='single_visitor.php';"/>Domestic  Registration </button>
<!--<button type="button" class="btnw col-sm-5 col-xs-12 reg_btn"  onclick="window.location.href='#';"/>  Registration Closed</button>-->
       
      <button type="button" class="col-sm-5 col-xs-12 gold_bg" style="padding: 20px 15px;width: 45%;outline: none;font-size: 21px;font-weight: bold;cursor: pointer;" onclick="window.location.href='login.php?visitor=international';"/>International  Registration </button>
      </div>
<style>
.sequal_logo_wrp {
		margin-top:20px; 
...
@media (min-width: 900px) {
  .btnwrap{margin-bottom:165px;margin-top: 165px}
}
