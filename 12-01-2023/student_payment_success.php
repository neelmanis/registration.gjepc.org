	...
	*/
	...
	//	$to = $email;
		...
		/*  Email End */		
		 ...
		 header("Refresh: 20; url=https://registration.gjepc.org/institute_dashboard.php");
		?>
		...
		header("Refresh: 10; url=https://registration.gjepc.org/institute_dashboard.php");
