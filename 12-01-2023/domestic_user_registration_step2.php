...
<!-- Event snippet for Virtual IIJS Sign-up-Step1 conversion page --> <script>  
</script> 
...
<!-- Event snippet for Step 2 Conversion conversion page
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
<script>
function gtag_report_conversion(url) {
  var callback = function () {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-679097911/01WBCOfeu-0CELfs6MMC',
...
<body>
    ...
    <div class="container_wrap">
       <div class="container">
        ...
        <h2 class="title2">Domestic User Registration Step - 2</h2>
		...
		<?php token(); ?>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4 form-group">
				  ...
				  <input type="text" class="form-control" id="city" name="city" onkeypress="return onlyAlphabets(event,this);" value="<?php echo $city;?>" autocomplete="off" maxlength='19'/>
				</div>
				...
				<div class="col-sm-6 col-md-4 form-group">
				  <label>GSTIN : </label>
				  <input type="text" class="form-control" id="gst_number" name="gst_number" value="<?php echo $gst_number;?>" maxlength="15" autocomplete="off"/>
			  </div>
