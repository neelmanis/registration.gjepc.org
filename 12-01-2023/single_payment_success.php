...
?>
	...
	{ 
		...
		$sqlx1 = "INSERT INTO `visitor_order_history`(`create_date`, `registration_id`, `orderId`,`visitor_id`, `payment_made_for`, `amount`,`show`, `year`,`payment_status`, `status`,`paymentThrough`) VALUES ('$day','$registration_id','$clnt_txn_ref','$visitor_id','$payment_made_for','$amount','$show','$year','Y','1','single')";
        ...
        <tr>           
        	<td colspan="3" id="content">
				...
				<tr>
                 ...
                 Thank you for registering for '.$event_name.'.Your Unique ID number is '.$orderId.'.</p>
