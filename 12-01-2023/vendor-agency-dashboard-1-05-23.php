			        	...
			        	<div class="d-block p-2">
			        		...
			        		<table class="table_responsive">
			        			...
			        			<!-- 	<th>Vaccine Status</th> -->
                                    ...
                                    <th class="text-center">View/Upload VC Report</th>
			        				<?php } ?>
			        				...
			        				<?php if($visitorCount  > 0){?>
                                       <tbody>
                                       	<?php 
                                            ...
                                            $dose2_status = getCovidDose($registration_id,$rowVisitors['id'],"CONTR",$conn);
                                            $global_status_signature = getVendorStatusFromGlobal($registration_id,$rowVisitors['id'],"signature22","CONTR",$conn);
                                            $global_status_tritiya = getVendorStatusFromGlobal($registration_id,$rowVisitors['id'],"iijstritiya22","CONTR",$conn);
                                            switch ($covid_status) {
                                            	case 'P':
                                            ...
                                            //  switch ($dose2_status) {
                                            // 	case 'P':
                                            // 		$dose2_result = "<span class=' label warning'>Pending</span>"; 
                                            // 		break;
                                            // 	case 'Y':
                                            // 		$dose2_result = "<span class=' label success'>Approved</span>"; 
                                            // 		break;
                                            // 	case 'N':
                                            // 		$dose2_result = "<span class=' label danger'>Disapproved</span>"; 
                                            // 		break;
                                          		// case 'U':
                                            // 		$dose2_result = "<span class=' label danger'>Updated</span>"; 
                                            // 		break;		
                                            // 	default:
                                            // 		$dose2_result = "<span class=' label warning'>Pending</span>"; 
                                            // 		break;
                                        ...
                                        <tr>
                                       		...
                                       		<td><?php echo $dose2_result;?></td>
                                       		<td><?php echo $person_status;?></td>
                                       		<td>

                                       			<?php if ($global_status_tritiya =="P" && $dose2_status=="Y" ){?>
																							<button class="cta confirmShow" data-visitorid="<?php echo $rowVisitors['id']; ?>" data-event="iijstritiya22" > Click here to confirmed IIJA TRITIYA 2022</button>
                                       			<?php } ?>
                                       			<?php if ($global_status_signature =="P" && $dose2_status=="Y" ){?>
																							<button class="cta confirmShow" data-visitorid="<?php echo $rowVisitors['id']; ?>" data-event="signature22" > Click here to confirmed IIJS SIGNATURE 22</button>
                                       			<?php } ?>
                                       			<?php if($global_status_signature =="Y"){ ?>
                                              <button class="label success"><i class="fa fa-check">IIJS SIGNATURE 22</i></button>
                                       		  <?php 	} ?>

                                       		  <?php if($global_status_tritiya =="Y"){ ?>
                                              <button class="label success"><i class="fa fa-check">IIJS TRITIYA 22</i></button>
                                       		  <?php 	} ?>
                                       		</td>
                                       		<?php if($covid_report_link =='Y'){?>
                                       		<td>
                                       			<?php if($rowVisitors['person_status'] =='Y'){?>
                                                      ...
                                                      if($dose2_status !=='Y'){?>
                                                         <a href="https://registration.gjepc.org/vendor-agency-dashboard.php?action=upload-covid-report&agency-visitor=<?php echo base64_encode($rowVisitors['id']);?>&agency=<?php echo base64_encode($rowVisitors['agency_id']);?>" class="cta">Upload VC Report</a>
                                                     <?php }else{ ?>
                                                    
                                                      <a href="https://registration.gjepc.org/vendor-agency-dashboard.php?action=upload-covid-report&agency-visitor=<?php echo base64_encode($rowVisitors['id']);?>&agency=<?php echo base64_encode($rowVisitors['agency_id']);?>" class="label success">View VC Report</a>
                                                    		<?php }
                                       								?>
	    ...
	    $(".confirmShow").on("click",function(){
	    	if(confirm("Are you sure continue for IIJS signature registration ?")){
         	...
         	$.ajax({
				    ...
				    data:{visitor_id:visitor_id,action:action},
				    dataType: "json",
				    beforeSend: function(){
