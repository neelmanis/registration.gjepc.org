							...
							<div class="col-12 mb-2">
								<div class="d-block">
									...
									<ul class="inner_under_listing mt-3">
										<li>I have read and understood the <a href="pdf/<?php echo $evt_term_condition_file; ?>" target="_blank"><strong>terms and conditions</strong></a> with regard to the visitor's registration</li>
