...
<html>
  ...
  <body>
      ...
      <table cellpadding="20" style="margin-left: -46px;margin-top: -46px;margin-bottom: -100px;font-size:12px; font-family:Arial, Helvetica, sans-serif; width:113.1%;">
        <tbody>
          <tr>
    ...
    margin-top: -22px;padding:10px 10px 0px 10px">
    ...
    margin-top: -22px;text-align:right;padding:10px 10px 0px 10px" >
    ...
    <img src="https://gjepc.org/iijs-premiere/assets/images/gjepc_logo.png" style="max-width: 200px; text-align:right">
                  ...
                  <tr>
                    <td style="width: 50%;vertical-align: baseline;">
                        <h3 style="display: block; font-weight: 900; letter-spacing: 1px;font-size: 15px;color: #000;">ATHUL EASWARAN PARAMESWARAN</h3>
                        <h3 style="font-size: 13px;margin-bottom: 0px;padding-bottom:0px" >Ape Brothers Sisters & Sons Electronics Pvt. Ltd.</h3>
                        <h3 style="font-size: 13px;margin-bottom: 0px;padding-bottom:0px;">Chairman</h3>
                        <h3 style="font-size: 13px;margin-bottom: 0px;padding-bottom:0px;">Mumbai</h3>
                    </td>
                    <td style="width:50%;vertical-align: baseline;">
                      <h3 style="font-size: 13px;">000000001</h3>
                      <h3 style="color: #f58220;font-size: 13px;margin-bottom: 0px;padding-bottom:0px">Entry to the show</h3>
                      <h3 style="color: #f58220;font-size: 13px;margin-bottom: 0px;padding-bottom:0px"><b>4th to 8th August</b></h3>
                      <h3  style="font-size: 13px;margin-bottom: 0px;padding-bottom:0px" >Vaccination status</h3>
                  ...
                  <td colspan="2" style="text-align:center">
                     <div style="background:#f97918; width: 104.3%;margin-left: -23px; width: 113%;"><p style="margin:0px;padding:5px"><b>Combo</b></p></div>
                  </td>
                  </tr>
   ...
   text-align:center;margin-bottom:-21.5px">
                     <p style="font-size: 25px;color: #fff;;font-weight:bold;" >TRADE VISITOR</p></div>
