...
<!-- End Facebook Pixel Code -->
    ...
    if(data['status'] == "success"){  
     $('#verifyOTP').hide();
         ...
         $("#badgeSuccess").show();
        setTimeout(function(){
		    window.location = "international_visitor_info_update.php";
		}, 3000);
...
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=398834417477910&ev=PageView&noscript=1"/></noscript>
  ...
  <div class="wrapper">
    ...
    <div class="container my-5">
      ...
      <div class="bold_font text-center">
        <div class="d-block">
         ...
         International Visitor Photo update. 
      </div>
   <!--  <p><span class='blink d-block'>Fully vaccinated visitors are mandatory.</span> </p> -->
              ...
              <div class="col-12 mb-4 mb-md-0">                
                <div class="row">
                  <div class="col-6 form-group">
                    ...
                    <input type="email" class="form-control" id="email_id" value="<?php echo $email; ?>" name="email_id" autocomplete="off"/ >
     ...
     <div id="badgeSuccess">
                  <p> Please wait.. you will redirect shortly.  </p>
                </div>
