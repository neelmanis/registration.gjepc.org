      	...
      	<div class="userName"></div>
        	<div id="formContainer" class="p-0 mt-4">
          	<div class="title m-0 float-none" id="title_open">
            	<a href="i_v_r.php?action=addnew" target="_blank" class="btn col-100">Click here for NEW REGISTRATION / ADD VISITOR </a>
            </div>    	
			</div>
	...
	<div class="clear"></div>
		  ...
		  ?>
              <tr>
                ...
                <td data-column="Designation"><?php echo strtoupper($emp['email']); ?></td>
