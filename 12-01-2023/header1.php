...
<div class="head_main">
    ...
    <?php if(isset($evt_logo)){ ?>
      ...
      <div class="logo pr-3"><a href="#"><img src="https://gjepc.org/iijs-signature/assets/images/SIGNATURE-LOGO-4.jpg" class="logo_img"></a></div>
    <?php }?>
  ...
  <div class="text-center">
    <span>Welcome 
	<strong>
	<a <?php if($_SESSION['redirectLink'] =="institute"){ ?> href="#" <?php } else { ?> href="my_dashboard.php" <?php } ?>><?php echo $_SESSION['COMPANYNAME'];?></a>
	</strong> </span>  <br /> <br />
          ...
          <ul data-breakpoint="800" class="flexnav nav navigation-menu new_menu">
            ...
            <!--<li>
             ...
             <!--    <ul> -->
              ...
              <!-- <ul>
                  <li><a href="https://gjepc.org/emailer_gjepc/11.10.2022/index.html" target="_blank" class="d-block"> Circular for Booth Allotment for IIJS Signature 2023 </a></li>
              </ul> -->
            </li>
...
<style>
  .flexnav {max-height: inherit!important;}
</style>
