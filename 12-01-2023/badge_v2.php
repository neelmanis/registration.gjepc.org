  ...
  <body style="margin:0; padding:0;">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
        <tbody style="height:100%">
          <tr>
            <td style="width: 50%;">
              <div style="border:5px solid #000;height:551px;">
                <table cellpadding="8" cellspacing="0" style="width: 100%;">
                  <tbody>
                    <tr style="background:gray; height: 50px;">
                      <td align="left">
                    ...
                    <tr>
                      <td align="center">
                          <img src="images/employee_directory/600865078/photo/1656312388-photo-451296.jpg" style="max-height:160px; max-width: auto; display:table; margin:0 auto;" alt="">
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td style="width:50%;vertical-align: baseline;">
                        ...
                        <p style="color: #f58220;font-size: 13px;"><b>Entry to the show<b></p>
                        <p style="color: #f58220;font-size: 13px;"><b>4th to 8th August</b></p>
                    ...
                    <tr>
                      <td colspan="2" style="text-align:center">
                         <p style="margin-bottom:0; background:#000; color:#fff; display:table; margin-left:auto; border-radius:100%; width:50px; height:50px; line-height:35px;margin-top:-30px;"><b>3SR</b></p>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2" align="center" style="background:grey; padding:21px 0; font-size: 28px; color: #fff;;font-weight:bold;">
                        TRADE VISITOR
                      </td>
                    </tr>
                  </tbody>
              ...
              <div>
                <table cellpadding="8" cellspacing="0" style="width: 100%;">
                  <tbody>
                    ...
                    <tr>
                      <td  align="center" style="background: #f97918;">
                    ...
                    <tr>
                      <td style="text-align:center">
                        <h3 style="font-size:18px;margin: 0px;padding:0">TWO COVID VACCINE IS MANDATORY <br> TO VISIT THE SHOW</h3>
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align:center">
                        <table style="width:100%">
                          <tr>
                            <td  width="50%">
                              <h3 style="font-size:16px;margin: 0;">SHOW HOURS</h3>
                            </td>
                            <td>
                              <p style="margin:0 0 4px 0">4th – 8th August 2022</p>
                              <p style="margin:0">10am – 7pm</p>
                            </td>
                          </tr>
                          <tr>
                            <td width="50%">
                              <h3 style="font-size:16px;margin: 0;">ENTRY IN TO EXHIBITIONS HALLS</h3>
                            </td>
                            <td> 
                              <p style="margin:0 0 4px 0">4th – 8th August 2022</p>
                              <p style="margin:0">10am – 7pm</p>
