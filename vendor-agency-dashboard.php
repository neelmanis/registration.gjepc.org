                ...
                <?php  } ?>
                        ...
                        <div class="field">
						    ...
						    <select name="payment_made_for" id="payment_made_for" class="selectField">
						    	...
						    	$sql_event = "SELECT * FROM `visitor_event_master` WHERE `status` ='1' AND `shortcode`=EVENT_SELECTED  order by `serial_no` ASC";  
                                       ...
                                       <tbody>
                                       	<?php 
                                        	...
                                        	<tr>
												...
												<td>
                                             	<?php if ( $rowVisitors['person_status'] =='Y' && ($global_category_status_premiere_unique['status'] =="" || $global_category_status_premiere_unique['status'] =="P")) { ?>
													...
													<?php } else { ?>
															<button class="primary confirmShow" data-visitorid="<?php echo $rowVisitors['id']; ?>" data-event='signature23' data-category="<?php echo $rowVisitors['category']; ?>"  > Confirm for EVENT_SIGNATURE_2023 </button>
													<?php } ?>
                                       			<?php } ?>
