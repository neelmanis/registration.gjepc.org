  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%; border:5px solid #287194;height:553.7px;overflow:hidden;" valign="top">
            <div style="height:553.7px; position:relative">
              <table cellpadding="8" cellspacing="0" style="width: 100%;">
                ...
                <div style="background: #287194; width:100%; color:#fff; padding:10px 0; position:absolute; bottom:0; text-align:center">
                  <strong style="font-size: 30px;">OV</strong><br>
                  <p style="font-size: 28px; margin: 0; font-size: 20px; ">OVERSEAS VISITOR</p>
                </div>
          ...
          <td style="width: 50%; height:553.7px; border:5px solid #287194;">
            <div style="height:553.7px; position:relative">
              ...
              <div style="background: #287194; width:100%; color:#fff; padding:22.5px 0; position:absolute; bottom:0; text-align:center">
        ...
        <tr>
          ...
          <td align="center" style="width: 50%; border:5px solid #287194; height:553.7px; overflow:hidden" valign="middle">
          ...
          <td style="width: 50%; border:5px solid #287194; height:549px">
                ...
                <tr>
                  ...
                  <td colspan="2">
                    ...
                    <ul style="font-size:10px; margin-bottom:0; padding-left:15px">
                      ...
                      <li>Visitor badge which was blocked due to breach of security norms will not be allowed to visit GJEPC&apos;s any shows in the future.</li>

                      <li>For security reasons, luggage should be deposited at the baggage counter located near Registration Hall.</li>

                      <li>Visitor should abide by the terms and conditions applicable for registration of international visitors set by "The Gem & Jewellery Export Promotion Council (GJEPC)".</li>

                      <li>Photography/Videography inside the exhibition is strictly prohibited. GJEPC&apos;s officials reserve the right to confiscate the camera/phone.</li>
