...
$year = $_REQUEST['year'];
if($show  =="iijs"){
	$show_val  = "IIJS PREMIERE 2022";
}else if($show  =="signature"){
	$show_val  = "IIJS SIGNATURE 2023";
}else if($show  =="tritiya"){
	$show_val = "IIJS TRITIYA 2023";
}
...
<div class="inner_container">
	...
	<?php	
     $sql_signature ="select * from exh_registration where uid='$uid' AND `show`='$show_val' order by gid desc";
	...
	if($result_signature['event_selected']=="iijstritiya23"){ $event_for="IIJS PREMIERE 2022"; $event_show = "IIJS TRITIYA 2022";} 
