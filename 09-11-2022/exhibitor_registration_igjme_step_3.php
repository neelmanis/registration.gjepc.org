...
{ //echo '<pre>'; print_r($_REQUEST); exit;
	...
	//echo '<pre>'; print_r($stallInfo); exit;
                        ...
                        <form class="cmxform" method="post" name="from1" id="form1">
							...
							<div class="clear"></div>
                                ...
                                <?php 
                                   ...
                                   // echo "select * from exh_registration where uid='$registration_id' and `show`='IGJME 2022' and last_yr_section_flag='1' and  curr_last_yr_check='N' order by exh_id desc limit 0,1";
                                    $query1=$conn->query("select * from exh_registration where uid='$registration_id' and `show`='IGJME 2022' and last_yr_section_flag='1' and  curr_last_yr_check='N' order by exh_id desc limit 0,1");
                                    ...
                                    $query=$conn->query("select * from exh_registration where uid='$registration_id'  and `show`='IGJME' AND  event_selected='igjme23'");
                                ...
                                <div class="field_box">
                                    ...
                                    <select class="form-control" name="selected_premium_type" id="selected_premium_type" <?php if($selected_premium_type!=""){?> disabled="disabled"<?php }?>>
                                        ...
                                        <?php 
                                        $sql="SELECT * FROM iijs_premium_master where status='Y'";
                                        $query=$conn->query($sql);
                                        while($result=$query->fetch_assoc()){
                                        ?>
