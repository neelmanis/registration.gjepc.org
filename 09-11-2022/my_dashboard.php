	...
	border-bottom: 1px solid #000;
						...
						<div class="border">
							...
							<ul class="nav nav-tabs customTabs pt-2" id="myTab" role="tablist">
                              ...
                              <li class="nav-item ">
                                <a class="nav-link active" id="contact-tab" data-toggle="tab" href="#igjme" role="tab" aria-controls="contact" aria-selected="false">Online Payment Details IGJME 2023</a>
                              </li>
                              <?php } ?>
                            </ul>
							<div class="tab-content box-shadow p-2" id="myTabContent" >
                              ...
                              <div class="tab-pane fade <?php if($countigjmeShows=='1'){?>show active<?php } ?>" id="igjme" role="tabpanel" aria-labelledby="contact-tab">
                                <?php
