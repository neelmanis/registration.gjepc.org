...
<!--                 <h2 class="text-center title mb-2">Multiple Registration Package  </h2>
  ...
  <h2 class="title text-center mb-2">Combo Visitor Registration Package for  IIJS Signature 2023 & IIJS Tritiya 2023</h2>
   ...
   <table class="responsive_table mb-3">
    ...
    <tbody>
      <tr>
        <td data-column="Dates">25th Sept - 20th Nov 2022</td>
        <td data-column="Members">2700</td>
        <td data-column="Non-Members">3500</td>
      </tr>
      <tr>
        <td data-column="Dates">21st Nov - 31st Dec 2022</td>
  ...
  <table class="responsive_table mb-3">
    ...
    <tbody>
      <tr>
        <td data-column="Dates">4th May - 20 Nov  2022</td>
        <td data-column="Members">2000</td>
        <td data-column="Non-Members">2500</td>
      </tr>
      <tr>
  ...
  <table class="responsive_table mb-3">
    ...
    <tbody>
      <tr>
        <td data-column="IIJS Tritiya 2023">Phase 1</td>
        <td data-column="Dates">4th May - 10th Feb 2023</td>
        <td data-column="Members">2000</td>
        <td data-column="Non-Members">2500</td>
      </tr>
      <tr>
