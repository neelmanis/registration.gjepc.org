...
$sql = "select * from exh_reg_payment_details where uid='$registration_id' AND (`show`='IIJS SIGNATURE 2023' || `show`='IIJS TRITIYA 2023' || `show`='IGJME') AND allow_visitor='N' order by payment_id desc limit 0,1";
$ans = $conn->query($sql);
$nans=$ans->num_rows;
if($nans>0){
...
height: 100%;
z-index: 9999;
background: url('https://gjepc.org/assets/images/logo.webp') 50% 50% no-repeat rgb(249,249,249);
opacity: 80;
}
</style>
