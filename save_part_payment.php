...
{	   
		...
		$orderId = "PR".$registration_id.$strNo;
	//	$orderId = "PART3".$strNo;
	...
	//	$cheque_tds_Netamount = 100;	
		...
		$payment_percentage = $_POST['payment_percentage'];
		
		$show = "IIJS TRITIYA 2023";
		$event_selected = "iijstritiya23";
		$year = "2023";
	
	if(isset($registration_id) && $registration_id!="")
	{
	$insertUTR = "INSERT INTO `utr_history`(`post_date`, `registration_id`,`gcode`,`utr_number`,`tdsAmount`,`cheque_tds_per`,`payment_percentage`,`amountPaid`, `razorpay_order_id`, `merchant_order_id`,`payment_status`,`payment_date`,`show`,`event_selected`, `year`, `status`,`error_description`,`comment`,`payment_made_for`,source) VALUES (NOW(),'$registration_id','$gid','$merchant_order_id','$cheque_tds_amount','$tds_per','$payment_percentage','$cheque_tds_Netamount','$razorpayOrderId','$merchant_order_id','pending','$payment_date','$show','$event_selected','$year','1','PART','PART','PART','PART')";
	...
	$payLog = "INSERT INTO `space_payment_log`(`registration_id`,`gid`,`merchant_order_id`,`amount`, `razorpay_order_id`,`post_date`,`source`,`payment_status`,`event_selected`) VALUES ('$registration_id','$gid','$merchant_order_id','$cheque_tds_Netamount','$razorpayOrderId','$payment_date','PART','pending','$event_selected')";
...
<table width="100%" border="0" background="#fff" cellpadding="0" cellspacing="0">
	<tr>
    	...
    	<td align="right"><a href="https://gjepc.org/iijs-signature/"><img src="https://gjepc.org/iijs-tritiya/assets/images/iijs_logo.png"/></a></td>
    </tr>  
