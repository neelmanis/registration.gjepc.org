...
$closetime = strtotime("24-05-2022 23:55:00");
?>
	<?php
	/* IVR Start */
...
<body>
				...
				<div class="content_area">					
					...
					*/	?>
					...
					{	?>
						...
						<div class='box_dash_container box-shadow'>
						<div class='box_title'><h3>IIJS EVENTS</h3></div>
						<div class='d-flex justify-content-center col-100'>
						<?php
		...
		<form method="POST" name="agreeForm" id="agreeForm" autocomplete="off">

			<div class="row">
				<div class="col-md-4"><a href="exhibitor_registration_print_application.php?show=iijs&year=2022" target="_blank" style="display: table;" class="btn" title="View Summary">IIJS PREMIERE 2022 application summary </a>		</div>
        <!-- IIJS SIGNATURE APPLICATION CHECK -->
	...
	<!-- 	<p>Terms and conditions -
		<input type="radio" name="agree" id="agree" value="YES" <?php if($agree=="YES"){ echo "checked='checked'"; echo 'disabled=disabled'; }?> <?php echo ($agree=="YES" || $agree=="NO" ? "disabled" :"" );?> >YES 
		
		<input type="radio" name="agree" id="agree" value="NO" <?php if($agree=="NO"){ echo "checked='checked'"; echo 'disabled=disabled'; }?> <?php echo ($agree=="YES" || $agree=="NO" ? "disabled" :"" );?> >NO 

		 </p>
		 -->
		<?php if($count == 0){ ?>&nbsp; &nbsp; <label for="agree" generated="true" class="error"></label><br/>
		<strong> I have read and hereby accept and agree </strong>
			
		<input type="hidden" name="saveAgree" value="saveInfo">
		...
		<?php } ?>
					...
					{
						echo "<div class='box_dash_container box-shadow'>
						<div class='box_title'><h3>IIJS Premiere 2022 Show</h3></div>
						<div class='d-flex justify-content-center col-100'>";						
						$sqlt = "select * from exh_registration where uid='$registration_id' and `show`='IIJS PREMIERE 2022' ";
						$anst = $conn->query($sqlt);
						$countxx = $anst->num_rows;
	...
	border-bottom: 1px solid #000;
						...
						<div class="border">
							<ul class="nav nav-tabs customTabs pt-2  " id="myTab" role="tablist">
							  ...
							  <li class="nav-item ">
							    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">IIJS SIGNATURE 2023</a>
							  </li>
							  <li class="nav-item ">
							    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">IIJS TRITIYA 2023</a>
							  </li>
							</ul>
							<div class="tab-content box-shadow p-2" id="myTabContent" >
							  ...
							  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
							  	<?php
									...
									<input type="hidden" id="gidData" value="<?php echo $sign_gidData;?>">
									<input type="hidden" id="net_payable_amount" value="<?php echo base64_encode($sign_amountPaid);?>">
									<input type="hidden" name="action" value="submit">
									 </form>
									<?php } ?>
							  </div>
							  ...
							  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
							  	<?php
									...
									<input type="hidden" id="gidData" value="<?php echo $tritiya_gidData;?>">
									<input type="hidden" id="net_payable_amount" value="<?php echo base64_encode($tritiya_amountPaid);?>">
									<input type="hidden" name="action" value="submit">
									 </form>
									<?php } ?>
							  </div>
