...
<div class="clear"></div>
<p style="color: red;">Note: All the Exhibitors visiting the exhibition should be fully vaccinated</p>
<div class="clear"></div>
<?php 
						...
						<div class="row">
							...
							<div class="col-12 mb-2">
								<div class="d-block">
									...
									<p>1. I have read and understood the terms and conditions at IIJS SIGNATURE 2022<br/>
									2.	I confirm that the upload vaccination certificate is genuine and valid.<br/>
									3.	I agree to abide by the terms and conditions applicable set by "The Gem & Jewellery Export Promotion Council (GJEPC)".<br/>
									4.	I accept that GJEPC reserves the rights of admission to the show. <br/>
									5.	The last date of 2nd dose vaccination that will be permitted entry to the show is 23rd December 2021<br/>
									6.	<b>"Fully Vaccinated"</b> certificate is mandatory for entry at IIJS Signature 2022 <br/>
									</p>
								</div>
...
<table  cellspacing="0" cellpadding="0" class="common">
   ...
   <!-- <th valign="middle">Dose 1 Status</th>-->
	...
	while($row = $query->fetch_assoc()){
		$badge_id = $row['visitor_id'];
		$badge_info = $conn->query("SELECT * FROM iijs_badge_items WHERE `Badge_Item_ID`='$badge_id '");
		$badge_row = $badge_info->fetch_assoc();
	...
	<!--<td valign="middle"><?php echo $dose1_status;?></td>-->
