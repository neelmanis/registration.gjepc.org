        ...
        <tr>
          <td valign="top" style="width:332pt; height:432pt;">
            <div style="padding:10px 30px;">
              <img src="images/qr_code/assets/logos2.svg" style="width:280px;margin-top:20px; " alt="">
          ...
          <td valign="top" style="width:100pt; height:432pt; position: relative;">
            <div style="position:absolute; top:-9pt; bottom:-9pt; left:0; width:100%; background:#124645;">
              <div style="width:100%; padding-top:18pt; padding-left:10px">
                <img src="./images/qr_code/assets/earth.png" style="width:100px;"  alt="">
              </div>
              <div>
                <img src="./images/qr_code/assets/bird2.svg" style="width:100%;"  alt="">
              </div>
              <div style="position: absolute; bottom:0; left:10px; width:100%;">
                <img src="./images/qr_code/assets/gjepcLogo2.svg" style="width:100px" alt="">
              </div>
            </td>
        </tr>
      </table>
