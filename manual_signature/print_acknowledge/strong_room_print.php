    ...
    <form name="form1" method="post" action="#" id="form1">
     <div>&nbsp;</div>
        <table class="table_display_ack" style="margin: 0px auto;">
            ...
            <tr align="center">
                <td>STRONG ROOM FACILITY FORM</td>
            </tr>
            <tr>
                <td align="left">
...
<table id="tblMain_ExhibitorInfo" cellpadding="0" cellspacing="0" width="700">
    ...
    <tr>
        <td style="height: 18px" class="black_subhead" align="left" valign="top" width="125px">&nbsp;Exhibitor ID</td>
    ...
    <tr>
        ...
        <td style="height: 18px" class="black_subhead" align="left" valign="top" width="125px">
            <span id="PrintAck_ExhibitorInfo1_lblTxt">Date</span></td>
        <td style="height: 18px" align="left" valign="top">  : 
            ...
            <tr>
                <td>
                    <table class="table_display">
                        <tbody><tr>
                            <td align="left"></td>
                            <td align="left"><strong> Key Person 1</strong></td>
                            <td align="left" width="50"></td>
                            <td align="left"></td>
                            <td align="left"><strong>Key Person 2</strong></td>
                        </tr>
                        <tr>
                            <td align="left">Name</td>
                            <td align="left"> : <?php echo getKeyName($keyperson1);?></td>
                            <td align="left">&nbsp;</td>
                            <td align="left">Name</td>
                            <td align="left"> : <?php echo getKeyName($keyperson2);?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <img src="../images/badges/<?php echo $_SESSION['EXHIBITOR_CODE'];?>/<?php echo getKeyPhoto($keyperson1);?>" style="height:100px;width:100px;border-width:0px;"></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top"> Photograph</td>
                            <td align="left">
                                <img  src="../images/badges/<?php echo $_SESSION['EXHIBITOR_CODE'];?>/<?php echo getKeyPhoto($keyperson2);?>" style="height:100px;width:100px;border-width:0px;"></td>
                        </tr>
                        <tr>
...
Call Centre No. : 1800-103-4353 Missed Call No: +91 7208048100</p>
</td>
                        </tr>
                        <tr>
