...
<title>STALL ALLOTMENT LETTER</title>
<link href="IIJS%202013_files/styles_print.css" rel="stylesheet" type="text/css"></head>
<body style="">
...
<font face="Arial, Helvetica, sans-serif" size="-1">
    ...
    <table width="100%" border="0px" cellspacing="0" cellpadding="5">
      <tr>
        <td colspan="2" align="right"><img src="../images/logo.png" height="105px" /></td>
      </tr>
      ...
      <tr>
        <td width="50%">Ref. No : <b>GJEPC/D/EVENT/21/22</font>/<?php echo $Exhibitor_Gid;?></b></td>
      ...
      <tr>
        <td colspan="2"><b>Sub : Stall allotment at IIJS SIGNATURE 2022</font></b></td>
      </tr>
      
      <tr>
        <td colspan="2">This has a reference to your participation at IIJS SIGNATURE 2022, to be held at BOMBAY EXHIBITION CENTRE - MUMBAI from 18th - 21st FEBRUARY 2022</td>
      </tr>
      
      <tr>
        <td colspan="2">We confirm having allotted to you following stall/s subject to terms & conditions as per the application form, contract and the declaration form which is duly signed and submitted to the council by you for participating at IIJS SIGNATURE 2022</td>
      </tr>
      <tr><td height="5px" colspan="2"></td></tr>
      ...
      <tr>
        <td colspan="2" align="center">        
           ...
           <!-- <td><b>Scheme</b></td>-->
            ...
            <td><?php echo $Exhibitor_StallType;?></td>
      ...
      <tr>
        <td colspan="2">We wish you a successful participation in IIJS SIGNATURE 2022 and look forward to your all round co-operation</td>
      </tr>
      <tr><td height="5px" colspan="2"></td></tr>
      
      <tr>
        <td colspan="2"><b>Note : This is only letter of allotment of stall at IIJS SIGNATURE 2022. The possession of stall/s is purely subject to full payment of the space rental</b></td>
      </tr>
      <tr><td height="5px" colspan="2"></td></tr>
      ...
      <tr>
        <td colspan="2">(P.S. Stall confirmation subject to realization of NEFT/RTGS)<br />
      ...
      <tr>
        ...
        <tr>
        <td rowspan="2" align="left" valign="middle"><img src="https://www.gjepc.org/images/gjepc_logo.png" height="60px" /></td>
        <td align="center"><font size="+1" face="Times New Roman, Times, serif"><b>The Gem & Jewellery Export Promotion Council</b></font></td>
        <td rowspan="2" align="right" valign="middle"><img src="../images/logo.png" height="65px" /></td>
        </tr>
        <tr>
        <td align="center">
		
        <font size="1">D2B, Ground Floor,'D' Tower, West Core,Bharat Diamond Bourse, <br />'G' Block, Bandra Kurla Complex, Bandra East, Mumbai – 400051.<br />
        Call Centre No. : 1800-103-4353 &nbsp;&nbsp; Missed Call No: +91 7208048100 &nbsp;&nbsp; Email: iijs@gjepcindia.com
        </font>
        </td>
        </tr>
        </table>
