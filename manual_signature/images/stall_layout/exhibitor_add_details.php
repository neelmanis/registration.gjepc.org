...
$sale_order_number=$_POST['sale_order_number'];
$Exhibitor_Gid=$_POST['Exhibitor_Gid'];
$Customer_No=$_POST['Customer_No'];
$billing_bp_no=$_POST['billing_bp_no'];
...
$Exhibitor_Mobile=$_POST['Exhibitor_Mobile'];
...
$Exhibitor_Registration_ID=$_POST['Exhibitor_Registration_ID'];
...
<table border="0" cellspacing="0" cellpadding="0" class="formManual">
	<tr>
    <td class="bold">Exhibitor SO No</td>
    <td>:</td>
    <td><input type="text" name="sale_order_number" id="sale_order_number" class="textField" value="<?php echo $sale_order_number;?>"/>
    <br />
    <span id="name_error" class="error_msg"></span>
   </td>
    <td>&nbsp;</td>
    <td class="bold">Exhibitor Gid</td>
    <td>:</td>
    <td><input type="text" name="Exhibitor_Gid" id="Exhibitor_Gid" class="textField" value="<?php echo $Exhibitor_Gid;?>" /></td>
  </tr>
  <tr>
    <td class="bold">Exhibitor BP No</td>
    <td>:</td>
    <td><input type="text" name="Customer_No" id="Customer_No" class="textField" value="<?php echo $Customer_No;?>"/>
    <br />
    <span id="name_error" class="error_msg"></span>
   </td>
    <td>&nbsp;</td>
    <td class="bold">Exhibitor Billing BP No</td>
    <td>:</td>
    <td><input type="text" name="billing_bp_no" id="billing_bp_no" class="textField" value="<?php echo $billing_bp_no;?>" /></td>
  </tr>
  <tr>
    <td class="bold">Exhibitor Code</td>
    <td>:</td>
    <td><input type="text" name="Exhibitor_Code" id="Exhibitor_Code" class="textField" value="<?php echo $Exhibitor_Code;?>"/>
    <br />
    <span id="name_error" class="error_msg"></span>
   </td>
    <td>&nbsp;</td>
    <td class="bold">Exhibitor Mobile No</td>
    <td>:</td>
    <td><input type="text" name="Exhibitor_Mobile" id="Exhibitor_Mobile" class="textField" value="<?php echo $Exhibitor_Mobile;?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td >
    <input type="text" name="allotted_women" class="textField" value="0">
    </td>
   </tr>
  <tr>
	...
	<td>&nbsp;</td>
	<td class="bold">Exhibitor_Registration_ID</td>
    <td>:</td>
    <td><input type="text" name="Exhibitor_Registration_ID" class="textField" value="<?php echo $Exhibitor_Registration_ID;?>"> </td> 
   </tr>
   <tr>
    <td class="bold">Exempt Gst</td>
    <td>:</td>
    <td><input type="text" name="exempt_gst" class="textField" value="0"> </td> 
