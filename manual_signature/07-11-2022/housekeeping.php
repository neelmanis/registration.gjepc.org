...
<span style="margin-left:40%;" class="spanbox">Deadline : <strong><?php echo getFormDeadLine(6,$conn);?></strong></span>
...
if($_REQUEST['auth']=="admin" || $_SESSION['ACCESS']=="ADMIN" && $current_time >= $formDeadLine){ ?>
<input name="submit" id="submit" type="submit" value="Submit"  class="maroon_btn" /> 
<?php } else if($Application_Complete=='P'){ ?>
<input name="submit" id="submit" type="submit" value="Submit"  class="maroon_btn" /> 
<?php } 
