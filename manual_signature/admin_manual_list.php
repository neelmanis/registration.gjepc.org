...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>    
	...
	<?php if($Exhibitor_Section != "machinery"){ ?>
	<td><td><a href="images/pdf/<?php echo $Exhibitor_Area; ?>.pdf" target="_blank" style="padding:10px;border:1px solid #FF0000;background:#999999;color:#FFFFFF;display: block">Click here to download stall layout</a></td></td>
	<?php } ?>
   <?php if($Exhibitor_Section != "machinery"){ ?>
    <td>
        <a href="images/pdf/IIJS_SIGNATURE_2023_EXH_MANUAL.pdf" target="_blank" style="padding:10px;border:1px solid #FF0000;background:#999999;color:#FFFFFF;display: block">Download Exhibitor Manual PDF</a> 
    </td>
    
	<?php } else { ?>
	<td><a href="images/pdf/IGJME_2023_EXH_MANUAL.pdf" target="_blank" style="padding:10px;border:1px solid #FF0000;background:#999999;color:#FFFFFF;display: block">Download Exhibitor Manual PDF</a></td>
	<?php } ?>
    </tr>
    <?php if ($Exhibitor_Section != "machinery") { ?>
        <tr>
...
<tr>
    ...
    <td>
    <?php 
	echo "<a href='wireless_internet_connection.php?auth=admin'>WIRED INTERNET CONNECTION (LAN)</a>";
...
<tr>
    <td>FORM NO.8</td>
    <td>
	<a href="electronic_surveillance.php?auth=admin">ELECTRONIC SURVEILLANCE (CCTV)</a>
