...
if($num>0)
{
	...
	$Catalog_Brief=stripslashes(htmlentities($fetch_catalog['Catalog_Brief']));
...
{		
		...
		$sql_insert="insert into iijs_catalog set Exhibitor_Code='$exhibitor_code',Exibitor_Name='$Exibitor_Name',Catalog_Phone='$Catalog_Phone',Catalog_ContactPerson='$Catalog_ContactPerson',Catalog_Fax='$Catalog_Fax',Catalog_Designation='$Catalog_Designation',Catelog_mobile='$Catelog_mobile',Catalog_Address1='$Catalog_Address1',Catalog_Email='$Catalog_Email',	Catalog_City='$Catalog_City',Catalog_Pincode='$Catalog_Pincode',Catalog_Website='$Catalog_Website',Catalog_CountryId='$Catalog_CountryId',Catalog_StallNo='$Catalog_StallNo',Catalog_State='$Catalog_State',Catalog_Brief='$Catalog_Brief',	Catalog_ProductLogo='$Catalog_ProductLogo',Catalog_CompanyLogo='$Catalog_CompanyLogo',brand_names='$brand_names', Info_Recieved='1',Application_Complete='P',Create_Date=NOW()";
...
<title>Compulsory Catalogue</title>
...
<li>If you fail to upload the company profile, product picture & logo of your company then the IIJS SIGNATURE show logo will be published or will be kept blank in your picture field of Exhibitor Catalogue.</li>
...
<p>Please upload a logo of your company and ensure that the size of the logo should not exceed 2MB, minimum resolution required is 300 dpi (Accepted Format JPG,PNG)</p>

<table border="0" cellspacing="0" cellpadding="0" class="formManual">
  <tr>
    <td width="37%"><div class="bottomSpace">
    <?php if($Catalog_CompanyLogo==""){ ?>
    	<img src="images/SIGNATURE-LOGO-4.jpg" width="300" height="130" alt="Company logo" />
    <?php }else{ ?>
