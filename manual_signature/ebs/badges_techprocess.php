...
if(isset($Exhibitor_Code) && $Exhibitor_Code!="")
{
	...
	$orderUpdate ="SELECT * FROM `iijs_payment_master` WHERE `Form_ID`='4' AND Payment_Master_OrderNo='$orderId' AND Exhibitor_Code='$Exhibitor_Code' AND Payment_Master_Approved='P'";
	...
	$tpslUpdate ="update iijs_payment_master set tpsl_txn_id_rand='$tpsl_txn_id' WHERE `Form_ID`='4' AND Payment_Master_OrderNo='$orderId' AND Exhibitor_Code='$Exhibitor_Code' AND Payment_Master_Approved='P'";
	...
	$mrctTxtID = $orderId;
	$currencyType = "INR";
	$returnURL = "https://" . $_SERVER['HTTP_HOST']."/manual_signature/badges_payment_success.php";
