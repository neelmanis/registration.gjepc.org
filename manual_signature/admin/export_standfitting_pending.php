...
<?PHP
  ...
  $export_filename = "StandfittingPending_" . date('Ymd') . ".xls";
...
inner join iijs_exhibitor d on a.`Exhibitor_Code`=d.`Exhibitor_Code` where a.`Application_Complete`='P'
group by a.`Exhibitor_Code`") or die('Query failed!'); */

$result = $conn ->query("SELECT a.`Exhibitor_Code`,a.`Exhibitor_Name`,a.`Exhibitor_Contact_Person`,a.`Exhibitor_Designation`,a.`Exhibitor_Code`,a.`Exhibitor_City`,a.`Exhibitor_Mobile`,a.`Exhibitor_Phone`,a.`Exhibitor_Email`,a.`Exhibitor_DivisionNo`,a.`Exhibitor_Section`,a.`Exhibitor_Area`,a.`Exhibitor_StallNo1`,a.`Exhibitor_StallNo2`,a.`Exhibitor_StallNo3`,a.`Exhibitor_StallNo4`,a.`Exhibitor_StallNo5`,a.`Exhibitor_StallNo6`,a.`Exhibitor_StallType`,a.`Exhibitor_Region`,b.`Application_Complete`,b.`Create_Date` FROM iijs_exhibitor a , `iijs_stand` b  where a.`Exhibitor_Code`=b.`Exhibitor_Code` and  b.`Application_Complete`='P'");
