...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  ?>
  <tr>
    <td><a href="#"><?php echo $rows['Exhibitor_Name']; ?></a></td>
    <td><?php echo $rows['Exhibitor_Contact_Person'];?></td>
    <td><a href="https://registration.gjepc.org/manual_signature/admin_login.php?action=admin_login&Exhibitor_Code=<?php echo $rows['Exhibitor_Code'];?>&auth=admin" target="_blank"><?php echo $rows['Customer_No'];?></td>
