...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <?php
	...
	{
	$sql.=" and a.ProductLogo_Approved='P'";
	}
	if($_SESSION['ProductLogo_Y']=="Y")
	{
	$sql.=" and a.ProductLogo_Approved='Y'";
	}
	if($_SESSION['ProductLogo_N']=="N")
	{
	$sql.=" and a.ProductLogo_Approved='N'";
	}
	
	if($_SESSION['CompanyLogo_P']=="P")
	{
	$sql.=" and a.CompanyLogo_Approved='P'";
	}
	if($_SESSION['CompanyLogo_Y']=="Y")
	{
	$sql.=" and a.CompanyLogo_Approved='Y'";
	}
	if($_SESSION['CompanyLogo_N']=="N")
	{
	$sql.=" and a.CompanyLogo_Approved='N'";
	}
