...
mkdir($path, 0777);
	...
	*/
		...
		$conn ->query("update gjepclivedatabase.globalExhibition set mobile='$Badge_Mobile',fname='$Badge_Name' where visitor_id='$Badge_Item_ID' and participant_Type='EXHM'");
		}
