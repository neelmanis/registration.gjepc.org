...
<?PHP
  ...
  /*$export_filename = "CCTVPending_" . date('Ymd') . ".xls";
...
inner join iijs_exhibitor a on a.`Exhibitor_Code`=b.Exhibitor_Code where b.Application_Complete='P'
...
function cleanData(&$str)
  ...
  // filename for download
  $filename = "CCTVPending_" . date('Ymd') . ".csv";
