...
$flag = false;
$sql="SELECT a.`Exhibitor_Code`,d.`Exhibitor_Name`,d.`Exhibitor_Contact_Person`,d.`Exhibitor_Designation`,d.`Exhibitor_City`,d.`Exhibitor_Mobile`
,d.`Exhibitor_Phone`,d.`Exhibitor_Email`,d.`Exhibitor_DivisionNo`,d.`Exhibitor_Section`,d.`Exhibitor_Area`,d.`Exhibitor_StallNo1`,d.`Exhibitor_StallNo2`,d.`Exhibitor_StallNo3`,d.`Exhibitor_StallNo4`,d.`Exhibitor_StallNo5`,d.`Exhibitor_StallNo6`,d.`Exhibitor_StallType`,d.`Exhibitor_Scheme`,d.`Exhibitor_Region`,a.`Info_Approved`,a.`Info_Reason`,a.`Application_Complete`,a.`Create_Date`,
SUM(CASE c.Item_ID when 2 then b.Item_Quantity ELSE 0 END) as 'Track Lights of 50 watt - Yellow',
...
FROM `iijs_stand` a inner join iijs_stand_items b on a.`Stand_ID`=b.`Stand_ID` 
inner join iijs_stand_items_master c on b.Item_Master_ID=c.Item_ID
inner join iijs_exhibitor d on a.`Exhibitor_Code`=d.`Exhibitor_Code` group by a.`Exhibitor_Code`";
