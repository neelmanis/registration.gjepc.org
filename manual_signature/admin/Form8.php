...
$message ='<table width="96%" bgcolor="#fbfbfb" style="margin:2% auto; border:2px solid #ddd; font-family:Arial, sans-serif; color:#333333; font-size:13px; border-radius:10px;">
		...
		<p>Your details for the Online Application for <strong>Form No. 8. ELECTRONIC SURVEILLANCE</strong> has been updated by IIJS Admin.</p>
...
<table border="0" cellspacing="0" cellpadding="0" class="formManual">
  <tr>
	...
	<td width="20"><input type="radio" name="cctv_company" id="cctv_company" value="asterix" disabled="disabled" <?php if($cctv_company=='asterix'){?> checked="checked"<?php }?> /></td>
    <td>M/s Asterix</td>
  </tr>
