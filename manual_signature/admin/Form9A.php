...
/*	echo $tmp;echo "<br/>";
	...
	$gstin	= str_replace(' ','',strtoupper(filter($_POST['gstin'])));
	$utr_no	= str_replace(' ','',filter($_POST['utr_no']));
...
$message ='<table width="96%" bgcolor="#fbfbfb" style="margin:2% auto; border:2px solid #ddd; font-family:Arial, sans-serif; color:#333333; font-size:13px; border-radius:10px;">
		...
		<tr>
		<td align="left" height="50px"><img src="https://gjepc.org/assets/images/logo.png" border="0" width="220"/></td>
...
<div id="main">
	<div class="content">
		...
		<a href="images/pdf/Safe_Rental_Indemnity_Bond_IIJS_Sig_2022.pdf" target="_blank" style="color:#F00;"><strong>AFFIDAVIT CUM INDEMNITY BOND</strong></a>
		</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="formManual" > 
    <tr>
    <th width="10" class="bold borderRight"><div align="center">Sr. No.</div></th>
    ...
    <th width="10" class="bold borderRight"><div align="center">Adj. Shelves</div></th>
    <th width="10" class="bold borderRight"> <div align="center">Drawers / Lockers</div></th>
    <th width="10" class="bold borderRight"><div align="center">Volume (In Ltrs.)</div></th>
    <th width="10" class="bold borderRight"><div align="center">Weight (In Kgs.)</div></th>
  </tr>
	<tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  ?>
    <tr>
      ...
      <td><div align="center"><?php echo $result['weight_kg'];?></div></td>
    </tr>
	<?php $i++;}?>
</table>
...
<table border="0" cellspacing="0" cellpadding="0" class="formManual" id="abc">
   <tr>
		...
		<th class="bold">Up To <br />Deadline 1</th>
		<th class="bold">Up To <br />Deadline 2</th>
		<th class="bold">Up To <br />Deadline 3</th>
...
<div class="clear">
 <input type="hidden" name="Exhibitor_Code" id="Exhibitor_Code" value="<?php echo $exhibitor_code;?>"/>
  ...
  <table border="0" cellspacing="0" cellpadding="0" class="formManual">
    <tr><td colspan="7" class="bold"><h2>Upload Safe Location Layout</h2></td></tr>
    <tr>
      <td colspan="7" >Please upload the safe location layout and accepted file formats are - JPG, JPEG and PNG and its size upto 2MB</td>
    </tr>
...
<div class="clear"></div>
  ...
  <table border="0" cellspacing="0" cellpadding="0" class="formManual">  
   ...
   <?php $Payment_Master_ID=getPaymentModeId($_REQUEST['Payment_Master_ID'],$conn);?>    
	...
	<tr>	
	<td width="143" class="bold" colspan="8"><sup>*</sup><input type="checkbox" name="iagree" id="iagree" value="Y" <?php if($iagree=='Y'){?> checked="checked"<?php }?> /> I have read and understood the terms and conditions as mentioned.
	<?php 
	$filename = "../images/safe/".$exhibitor_code.".pdf";
