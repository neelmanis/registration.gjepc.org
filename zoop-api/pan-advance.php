      ...
      <a class="navbar-brand" href="gstin-advance.php">GST Advance Verification</a>
        ...
        <section>
			...
			<div class="row" id="panFORM">
				...
				<div class="col-md-3">
                    <p class="text-center">PAN Status </p>
                </div>	
				<div class="col-auto">
                    <p class="glance_no" id="pan_status" style="font-weight:bold;">  </p>                              
                </div>	
				<div class="col-md-3">
                    <p class="text-center">Title</p>
                </div>	
				<div class="col-auto">
                    <p class="glance_no" id="user_title" style="font-weight:bold;">  </p>                              
                </div>	
				<div class="col-md-3">
                    <p class="text-center">First Name</p>
                </div>	
				<div class="col-auto">
                    <p class="glance_no" id="user_first_name" style="font-weight:bold;">  </p>                              
                </div>
				<div class="col-md-3">
                    <p class="text-center">Middle Name</p>
                </div>	
				<div class="col-auto">
                    <p class="glance_no" id="user_middle_name" style="font-weight:bold;">  </p>                              
                </div>
				<div class="col-md-3">
                    <p class="text-center">Last Name</p>
                </div>	
				<div class="col-auto">
                    <p class="glance_no" id="user_last_name" style="font-weight:bold;">  </p>                              
                </div>
			</div>
            </div>
	...
	$("#pan_no").on("change",function(){
        ...
        alert("Please enter PAN No!");
	 	...
	 	$.ajax({
	 			...
	 			url:'API/verify_pan_advance_script.php',
	 			dataType: "json",
	 			beforeSend: function(){
					$('#imgLoading1').show();
				...
				{ //alert(data.success);
					...
					if(data.response_code=="100")
					{
						...
						$('#pan_status').html(data.result.pan_status);
						$('#user_first_name').html(data.result.user_first_name);
						$('#user_middle_name').html(data.result.user_middle_name);
						$('#user_last_name').html(data.result.user_last_name);
						$('#user_title').html(data.result.user_title);
