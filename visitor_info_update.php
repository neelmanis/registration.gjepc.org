...
header("location:visitor_photo_update.php");
}
     ...
     ?>
        <form class="" id="single_visitor_update" enctype="multipart/form-data" autocomplete="off">  
           ...
           <div class="row">
                ...
                <div class="col-sm-6 col-md-4 form-group">
                    <label style="" ><strong style="color:#a89c5d" >Designation</strong> - <?php if($designation_type =='Owner'){?> <label class=""><span class=" ">Owner - <?php echo getVisitorDesignationID($designation,$conn); ?></span><?php } ?>
                       <?php if($designation_type =='Employee'){?> <label class=""><span class=" ">Employee - <?php echo getVisitorDesignationID($designation,$conn); ?></span><?php } ?></label><br>
                ...
                <div class="col-sm-6 col-md-4 form-group">
                    <label><strong style="color:#a89c5d">Gender </strong> - <?php if($gender=='M'){echo 'Male';}?> <?php if($gender=='F'){echo 'Female';}?><?php if($gender=='T'){echo 'Transgender';}?></label><br>
                </div>
           
                <div class="col-sm-6 col-md-4 form-group">
                    <label ><strong style="color:#a89c5d"> Mobile No</strong> - <?php echo $mobile_no;?></label>
                </div>
               ...
               <?php if($adhaar_no !==""){ ?> 
                <div class="col-sm-6 col-md-4 form-group">
                    <label><strong style="color:#a89c5d">Adhaar No</strong> - <?php echo $adhaar_no;?></label>
                </div>
                <?php } ?>
                <div class="col-sm-6 col-md-4 form-group">
                    <label> <strong style="color:#a89c5d">Pan No</strong> - <?php echo $pan_no;?></label>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 form-group">
                                ...
                                <div class="blah mb-2">
                                    <img  class="img-fluid " src="images/employee_directory/<?php echo $registration_id.'/photo/'.$emp_files.'/'.$photo;?>" alt="your image" style="display: block;"/>
                                </div>
                                 
                </div>
          
                <div class="col-sm-6 col-md-4 form-group">
                    <label ><strong style="color:#a89c5d">Individual Pan Card</strong></label>
                    <div class="blah">
                ...
                <div class="col-sm-6 col-md-4 form-group" id="EmployeeDiv" style="<?php if($designation_type =='Employee'){ echo "display: block"; }else{ echo "display: none";} ?>" >
                    <label ><strong style="color:#a89c5d">Salary Slip / Bank Statment</strong> :</label>
                    <div class="blah">
                ...
                <div class="col-sm-6 col-md-4 form-group " id="OwnerDiv" style="<?php if($designation_type =='Owner'){ echo "display: block"; }else{ echo "display: none";} ?>">
                    <label ><strong style="color:#a89c5d">GST Certificate</strong> :</label>
                    <div class="blah">
                ...
                <div class="col-12  mb-5" style="border-top: 1px dashed #a89c5d;"></div>
                 <div class="col-sm-6 col-md-6 form-group">
                   ...
                   <div class="blah mb-2">
                        ...
                        <?php } else{?>
                            <img id="blah_photo" class="img-fluid " src="images/employee_directory/<?php echo $registration_id.'/photo/'.$emp_files.'/'.$photo_new;?>" alt="your image" style="display: block;"/>
                        <?php }?>
