	...
	if($show=="tritiya"){
        ...
        <tbody>
			...
			<tr>
                ...
                <td><label class="cheque_tds_per_error"></label></td>
            </tr> 
			
			<tr>
                <td align="right">TDS Amount <span>*</span> </td>
                <td>
				<input name="cheque_tds_amount" type="text" id="cheque_tds_amount" class="textField" value="" autocomplete="off" onkeyup="return change_amount()"/>
                <br><label class="cheque_tds_amount_error"></label>
				</td>
                <td></td>
            </tr> 
