...
$sql = "select * from exh_reg_payment_details where uid='$registration_id' AND `show`='IIJS 2022' AND `year`='2022' AND allow_visitor='N' order by payment_id desc limit 0,1";
