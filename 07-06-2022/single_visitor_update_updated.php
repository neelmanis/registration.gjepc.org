                ...
                <div class="col-sm-6 col-md-4 form-group">
                    ...
                    <div class="d-flex">
                        <label class="container_radio col-auto"><span class="check_text ">Owner</span>
                            <input type="radio" <?php if($designation_type =='Owner'){echo 'checked="checked" ';}?> id="designation" name="designation" value="Owner" >
                            <span class="checkmark_radio"></span>
                        </label>
                        <label class="container_radio col-auto"><span class="check_text">Employee</span>
                            <input type="radio" <?php if($designation_type =='Employee'){echo 'checked="checked"';}?> id="designation" name="designation" value="Employee" >
                            <span class="checkmark_radio"></span>
                        </label>
                    </div>
                </div>
                  <div class="col-sm-6 col-md-4 form-group">
                                <label class="star">Designation List:</label>
                               
                                    
                                    <select class="select-control" name="designationList" id="designationList">
