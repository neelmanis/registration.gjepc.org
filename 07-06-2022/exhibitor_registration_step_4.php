...
{	
	...
	$paymentInfo = "UPDATE exh_reg_payment_details set int_type='$int_type', payment_mode='$payment_mode', bank_acc_no='$bank_acc_no', name_bank='$name_bank', name_bank_branch='$name_bank_branch', ifsc_code='$ifsc_code', int_acc_type='$int_acc_type',`tds_holder`='$tds_holder',`net_payable_amount`='$amountPay',`percentage`='$amount_payable', `cheque_tds_gross_amount`='$cheque_tds_gross_amount',`cheque_tds_per`='$cheque_tds_per',`cheque_tds_amount`='$cheque_tds_amount',`cheque_tds_Netamount`='$amountPay',`cheque_tds_deducted`='$cheque_tds_deducted' WHERE `show`='$eventDescription' AND event_selected='$event_selected' AND uid='$uid' AND gid='$gidData'";
 ...
 <!-- <tr valign="top">
  ...
  <tr valign="top">
   ...
   <!--<tr valign="top">
    ...
    <td width="48%">IIJS 2022 Participation charges</td>
    </tr>
    </table> -->
    </td>
    </tr>
