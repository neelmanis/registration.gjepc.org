...
$insertUTR_signature = "INSERT INTO `utr_history`(`post_date`, `registration_id`,`gcode`,`utr_number`,`tdsAmount`,`razorpay_signature`,`amountPaid`, `razorpay_order_id`, `merchant_order_id`,`payment_status`,`payment_date`,`show`,`event_selected`, `year`, `status`,`payment_made_for`,`source`) VALUES (NOW(),'$registration_id','$gid_signature','$merchant_order_id','0','$razorpay_signature','$amountPay_signature','$razorpayOrderId','$merchant_order_id','pending','$payment_date','IIJS SIGNATURE 2023','signature23','$year','1','SPACE','stepwise')";
$insertUTR_tritiya = "INSERT INTO `utr_history`(`post_date`, `registration_id`,`gcode`,`utr_number`,`tdsAmount`,`razorpay_signature`,`amountPaid`, `razorpay_order_id`, `merchant_order_id`,`payment_status`,`payment_date`,`show`,`event_selected`, `year`, `status`,`payment_made_for`,`source`) VALUES (NOW(),'$registration_id','$gid_tritiya','$merchant_order_id','0','$razorpay_signature','$amountPay_tritiya','$razorpayOrderId','$merchant_order_id','pending','$payment_date','IIJS TRITIYA 2023','iijstritiya23','$year','1','SPACE','stepwise')";
...
<form name='razorpayform' action="rz_comobo_verify.php" method="POST">
