	...
	if($count>0) 
	{
		...
		{ 							
			if(in_array($option_value['visitor_id'], $finalvisitoridarray)) {
				$data = array("status"=>'warning', "message"=>"Already registered for all event combo. To get your badge please upload your vaccination certificate on below given link <a href='https://registration.gjepc.org/visitor-covid-report-upload.php'>Click here</a>");
