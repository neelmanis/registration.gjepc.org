...
<div class="inner_container">
	...
	?>
        <div class="field_box"> 
            <div class="field_name">IIJS PREMIERE 2021 Participant :</div>
		...
		<div class="field_box"> 
            <div class="field_name">IIJS PREMIERE 2021 NEW Participant :</div>
            <div class="field_input" style="padding-top:5px;">
            <div class="chkbox" style="width:100px;">
              <span class="chkbox" style="width:100px;">
        ...
        <?php if($num1>0){ ?>
        <div class="field_box">
            <div class="field_name">IIJS PREMIERE 2020 Year details :</div>
       ...
       <div class="field_box">
        ...
        Same area but different location as of previous year Signature 2020<br/>
		...
		<?php if($selected_area!=9){?>
        <input type="radio" id="option" class="bgcolor" name="option" value="Less area as previous year" <?php /*if($option=="Less area as previous year"){?> checked="checked" <?php } */?> /> Less area as previous year Signature 2020<?php } ?>
