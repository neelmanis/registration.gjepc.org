...
//razorpay_order_id
$sqlAPI = "SELECT * FROM `utr_history` WHERE 1 AND registration_id='".$_SESSION['USERID']."' AND (`event_selected` = 'iijstritiya23') AND (payment_status='pending' || payment_status='' || payment_status='captured') AND (razorpay_order_id!='' || razorpay_order_id IS NULL)";
