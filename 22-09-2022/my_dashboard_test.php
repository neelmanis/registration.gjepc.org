...
<script src="js/save_payment_test.js?v=1.2" type="text/javascript"></script>
			...
			<div class="bold_font text-center">
				...
				<div class="content_area">					
					...
					*/	?>
					...
					//	echo '<a href="exhibitor_registration_print_application.php?show=tritiya&year=2023" target="_blank" class="btn col-100" title="View Summary">Click here to access Exhibitor Manual </a>';
						}	
						echo '</div></div>';
					}
					
					if($_SESSION['COUNTRY']=="IN" && $_SESSION['member_type']=="NON_MEMBER" && $_SESSION['member_type']=="INTERNATIONAL")
					{
						echo "<div class='box_dash_container box-shadow'>
						<div class='box_title'><h3>IIJS  Show</h3></div>
						<div class='d-flex justify-content-center col-100'>";						
						...
						//echo '<a href="exhibitor_registration_print_application.php?show=tritiya&year=2023" target="_blank" class="btn col-100" title="View Summary">Click here to view the application summary</a>';
						}	
						echo '</div></div>';
					} ?>
