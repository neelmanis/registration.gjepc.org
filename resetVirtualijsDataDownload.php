...
$sqlx = "SELECT * FROM gjepclivedatabase.visitor_order_history where payment_made_for='iijs21' order by Create_date ASC limit $start,$limit";
...
if($username=="mukesh@kwebmaker.com" && $password=="123456"){
	if($sqlDatas->num_rows > 0) {
				...
				while($result=$sqlDatas->fetch_assoc())
				{
					...
					/*..................................Get Delivery ID.....................................*/
					$id=$result['id'];
					$conn->query("update visitor_order_history set downlaod_status='N' where id='$id' and payment_made_for='iijs21'");	
				}
				$strResponse=array(
								"Result"=>'',
								"Message"=>'Success',
