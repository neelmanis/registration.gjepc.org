...
if($action=="generate_badge"){
   $category = filter($_REQUEST['category']);
    ...
    if($category == "VIS" || $category == "IGJME" ){
      ...
      $sql = "SELECT * FROM  globalExhibition WHERE pan_no='$pan_no' AND ( participant_Type ='VIS' OR participant_Type='IGJME' ) ";
      ...
      // if($face_status !="Y"){
      //   $message_warning = "Face photo approval is pending";
      // }
  ...
  <div class="clear"> </div>
      ...
      <div class="container_wrap my-5">
        <div class="container">
         ...
         <?php //echo $evt_name; ?>GENERATE BADGE FOR IIJS PREMIERE 2022  
          </div>
          <div id="loginForm">
            <div class="box-shadow">
              ...
              <div class="formwrapper2 d-block">
                ...
                <div class="row">
                    ...
                    <div class="col-12" >
                      <input type="radio" name="category" class="category" id="category_contr" value="CONTR" data-ref="mobile" ><label for="category_contr">Committee member / Organizers / GUEST / Agency</label>
                    </div>                        
