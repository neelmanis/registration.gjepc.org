...
<!--     <p><span class='blink d-block'>Fully vaccinated visitors are mandatory.</span> </p> -->
      <div id="loginForm">
                ...
                <div class="row">
                  ...
                  <div class="col-12 form-group mb-0">
                      <div class="row nvv_btn">
                       ...
                       <!--  <div class="col-12 col-sm mb-3 mb-sm-0">
                          <a href="https://registration.gjepc.org/intl-visitor-covid-report-upload.php" class="gold_text fade_anim">Upload Vaccination Certificate</a>
                        </div> -->
                        <div class="col-12 col-sm mb-3 mb-sm-0">
                          <a href="https://registration.gjepc.org/international_user_registration.php" class="gold_text fade_anim">New International Company Visitor Registration</a>
                        </div>
  ...
  <?php }else{ ?>
    <div class="alert alert-light" role="alert">
              International Visitor Registration is closed now
            </div>
 <?php  } ?>
