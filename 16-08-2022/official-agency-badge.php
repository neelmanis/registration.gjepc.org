    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
            ...
            <div style="height:553.7px; position:relative">
              <table cellpadding="8" cellspacing="0" style="width: 100%;">
                ...
                <div style="background: #D4B5A6; width:100%; color:#000; padding:10px 0; position:absolute; bottom:0; text-align:center">
                  <strong style="font-size: 30px;">OA</strong><br>
                  <p style="font-size: 28px; margin: 0; font-size: 20px; ">OFFICIAL AGENCY</p>
                </div>
        ...
        <tr>
          ...
          <td style="width: 50%; border:5px solid #D4B5A6; height:549px">
