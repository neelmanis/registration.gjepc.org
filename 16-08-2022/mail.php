<?php 
    ...
    <tbody>    
        ...
        <tr>           
        	<td colspan="3" id="content">
                ...
                <tr>
                <td style="padding:0 10px;" align="left">Order ID: COMBO231345947 </td>
                <!--<td style="padding:0 60px;" align="right">Date: '.date("d-m-y").'</td>-->
                <td style="padding:0 60px;" align="right">Date: 18-05-22</td>
                </tr>                    
                </table>
                ...
                <tr>
                    ...
                    <td width="75%">CHANDUKAKA SARAF AND SONS PVT LTD </td>
                </tr>
                <tr>
                    <td width="20%">Rupees: </td>
                    <td width="75%">124800/-</td>
                </tr>
				<tr>
	...
	$subject = "Thank you for registering at IIJS PREMIERE 22 & IIJS SIGNATURE 23 & IIJS TRITIYA 23 SHOW"; 
	$cc = "";
