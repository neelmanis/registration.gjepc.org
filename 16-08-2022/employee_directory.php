...
$sql = "select * from exh_reg_payment_details where uid='$registration_id' AND  (`show`='IIJS PREMIERE 2022' OR `show`='IIJS SIGNATURE 2023' OR `show`='IIJS TRITIYA 2023' OR `show`='COMBO ( IIJS SIGNATURE 2023 + IIJS TRITIYA 2023)') AND allow_visitor='N' order by payment_id desc limit 0,1";
$ans = $conn->query($sql);
$nans=$ans->num_rows;
if($nans>0){
