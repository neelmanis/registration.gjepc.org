...
$sqlx = "SELECT id,post_date,uniqueIdentifier as 'unique_code',registration_id,visitor_id as 'RegistrationNumber',company,fname as 'Name',mobile,pan_no,designation,photo_url,participant_Type as 'category',dose1_status,dose2_status,status,agency_category,committee,updateStatus,isReplaced FROM globalExhibition where 1 AND isDataPosted='N' and participant_Type='CONTR' and status='Y' order by post_date desc limit 0,50"; /* CONTR */
