...
$insertUTR = "INSERT INTO `utr_history`(`post_date`, `registration_id`,`gcode`,`utr_number`,`tdsAmount`,`razorpay_signature`,`amountPaid`, `razorpay_order_id`, `merchant_order_id`,`payment_status`,`payment_date`,`show`,`event_selected`, `year`, `status`,`payment_made_for`,`source`) VALUES (NOW(),'$registration_id','$gid','$merchant_order_id','0','$razorpay_signature','$amountPay','$razorpayOrderId','$merchant_order_id','pending','$payment_date','$eventDescription','$event_selected','$year','1','SPACE','stepwise')";
