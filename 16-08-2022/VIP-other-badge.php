  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%; border:5px solid #EE1C25;height:553.7px;overflow:hidden;" valign="top">
            <div style="height:553.7px; position:relative">
              ...
              <h1 style="font-size:8rem;text-align:center;margin:100px 0 0 0">VIP</h1>

             
                <div style="background: #EE1C25; width:100%; color:#fff; padding:22.5px 0; position:absolute; bottom:0; text-align:center">
          ...
          <td style="width: 50%; height:553.7px; border:5px solid #EE1C25;">
            <div style="height:553.7px; position:relative">
        ...
        <tr>
          ...
          <td align="center" style="width: 50%; border:5px solid #EE1C25; height:553.7px; overflow:hidden" valign="middle">
          ...
          <td style="width: 50%; border:5px solid #EE1C25; height:549px" valign="top">
