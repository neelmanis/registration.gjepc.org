...
$sqlx = "SELECT id,post_date,uniqueIdentifier as 'unique_code',registration_id,visitor_id as 'RegistrationNumber',company,fname as 'Name',mobile,pan_no,designation,photo_url,participant_Type as 'category',dose1_status,dose2_status,status,agency_category,committee,updateStatus,isReplaced FROM globalExhibition where 1 AND isDataPosted='N' and (event!='iijstritiya23' && event!='signature23') and participant_Type='VIS' and status!='R' AND registration_id='600912205' order by post_date desc limit 0,5"; /* INTL Visitor */
