...
if($_REQUEST['action']=='SEND')
{
	if($data['application_status']=='0')
	{
		...
		<!--	<p>Following are your login credentials:</p>
			...
			IIJS SIGNATURE 2022 SHOW Team</p>
			</td>
			</tr>
			</table>
		</td>
		...
		//$to = $data['email'];
		$subject = "Thank you for registering to visit IIJS SIGNATURE 2022"; 
	...
	<p>Details given below on the IIJS SIGNATURE 2022 SHOW, has been updated.</p>
	...
	//	 $to =$data['email']; 
		 $subject = "IIJS SIGNATURE 2022 - Update"; 
		 $headers  = 'MIME-Version: 1.0' . "\n"; 
		 $headers .= "Cc:overseas@gjepcindia.com" . "\n";
		 $headers .= 'Content-type: text/html; charset=iso-8859-1'. "\n"; 
    ...
    <tbody>    
        ...
        <tr>           
        	<td colspan="3" id="content">
				<p> Dear '.$data['title'].' '.$data['first_name'].' '.$data['last_name'].',</p>
				<p> Thank you for registering at IIJS SIGNATURE 2022. Your registration is completed.</p>
	...
	//	$to =$data['email'];
		...
		header("location:intl_employee_directory.php");
		exit;
?> 
...
<!--                <div>              
              ...
              <div class="box-shadow">
				...
				<?php 
				if($data['trade_show']=='IIJS SIGNATURE 2022'){ ?>
				<div class="maroonBtn" style="margin-right:10px;"><a href="i_v_r.php?id=<?php echo $eid; ?>" target="_blank">View Your Application </a></div>
					...
					<span><strong>IIJS SIGNATURE 2022 Application 
					<?php if($data['application_approved']=='Y' && $data['trade_show']=='IIJS SIGNATURE 2022'){ echo "Done"; } elseif($data['application_approved']=='N'){ echo "Disapproved";}else{echo "Pending";}?>  </strong></span>
					</div>			
				...
				<?php } else {	?>
					...
					<tr> 
						<td>	
							...
							<option value="IIJS SIGNATURE 2022" selected="selected">IIJS SIGNATURE 2022</option>
							</select> 	
						</td>
					</tr>
