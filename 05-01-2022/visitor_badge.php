...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title><?php echo $evt_name;?> VISITOR BADGE GENERATE</title>
    ...
    function panAction(){
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          $("#chkPendingPANStatus").text("Records not found for this pan");
  ...
  <div class="clear"> </div>
      ...
      <div class="container_wrap my-5">
        <div class="container">
         ...
         GENERATE DOMESTIC VISITOR BADGE 
          </div>
          <div id="loginForm">
...
<div class="col-md-1"></div>
                    <div class="col-md-5">
                      ...
                      <h2 class="title text-center" style="font-size:22px">Visitor parking</h2>

                      <img src="assets/park.jpeg" class="img-fluid mb-4" alt="">

                      <p class="text-center"><strong>OR</strong></p>

                      <a href="https://m.parkplus.io/book-parking?locType=search&lat=19.1524904&lng=72.8528372" target="_blank" class="w-100 btn btn-submit">Parking Portal</a>
                ...
                <div id="badgeSuccess">
                  <p>Thank you for downloading your IIJS SIGNATURE 2023 badge. <a href="https://registration.gjepc.org/visitor-badge.php"><b>Click here</b></a> if not downloaded automatically. </p>
                </div>
