...
$sqlx = "SELECT id,post_date,uniqueIdentifier as 'unique_code',registration_id,visitor_id as 'RegistrationNumber',company,fname as 'Name',mobile,pan_no,designation,photo_url,participant_Type as 'category',face_status,dose1_status,dose2_status,status,agency_category,committee,updateStatus,isReplaced,event,days_allow,isDataPosted_Offline,country,state,city FROM globalExhibition where 1 AND isDataPosted_Offline='N' and event!='iijstritiya23' and participant_Type!='CONTR' and status!='R' order by post_date desc limit 0,500"; /* All */

//$sqlx = "SELECT id,post_date,uniqueIdentifier as 'unique_code',registration_id,visitor_id as 'RegistrationNumber',company,fname as 'Name',mobile,pan_no,designation,photo_url,participant_Type as 'category',face_status,dose1_status,dose2_status,status,agency_category,committee,updateStatus,isReplaced,event,days_allow,isDataPosted_Offline,country,state,city FROM globalExhibition where 1 AND isDataPosted_Offline='N' and event!='iijstritiya23' and participant_Type='INTL' and status!='R' order by post_date desc limit 0,500"; /* INTL */

//$sqlx = "SELECT id,post_date,uniqueIdentifier as 'unique_code',registration_id,visitor_id as 'RegistrationNumber',company,fname as 'Name',mobile,pan_no,designation,photo_url,participant_Type as 'category',face_status,dose1_status,dose2_status,status,agency_category,committee,updateStatus,isReplaced,event,days_allow,isDataPosted_Offline,country,state,city FROM globalExhibition where 1 AND isDataPosted_Offline='N' and event!='iijstritiya23' and participant_Type='VIS' and status!='R' order by post_date desc limit 0,500"; /* VIS */
