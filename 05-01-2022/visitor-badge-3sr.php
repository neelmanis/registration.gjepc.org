  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%; border:5px solid #bfcdca;height:553.7px;overflow:hidden;" valign="top">
            <div style="height:553.7px; position:relative">
              ...
              <div style="background:#000; color:#fff; width:50px; height:50px; line-height:38px; position:absolute; bottom:90px; right:10px; border-radius:100px; padding:0; text-align:center;"><strong>3SR</strong></div>

             
                <div style="background: #bfcdca; width:100%; color:#000; padding:10px 0; position:absolute; bottom:0; text-align:center">
                  <strong style="font-size: 30px;">V</strong><br>
                  <p style="font-size: 28px; margin: 0; font-size: 20px; ">TRADE VISITOR</p>
                </div>
          ...
          <td style="width: 50%; height:553.7px; border:5px solid #bfcdca;">
            <div style="height:553.7px; position:relative">
              ...
              <table cellpadding="8" cellspacing="0" align="center" style="background:#f2f2f2; padding:10px 15px">
                        ...
                        <tr>
                          <td align="center">
                            <h3 style="font-size:16px;margin: 0;">ENTRY INTO EXHIBITION HALL</h3> <br>
              ...
              <div style="background: #bfcdca; width:100%; color:#000; padding:22.5px 0; position:absolute; bottom:0; text-align:center">
        ...
        <tr>
          ...
          <td align="center" style="width: 50%; border:5px solid #bfcdca; height:553.7px; overflow:hidden" valign="middle">
          ...
          <td style="width: 50%; border:5px solid #bfcdca; height:549px" valign="top">
