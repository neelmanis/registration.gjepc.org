...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>IIJS INTERNATIONAL VISITOR Covid REGISTRATION</title>
...
<!-- End Facebook Pixel Code -->
    ...
    $('.loaderWrapper').delay(1000).fadeOut();
    $("#chkEmailStatus").text("Your Application is Pending");    
    }else if(data.status =='notApplied') {
    $('.loaderWrapper').delay(1000).fadeOut();
    $("#chkEmailStatus").html("Application Not Yet applied...");
    ...
    if(data['status'] == "success"){    
        setTimeout(function(){
		window.location = "intl-visitor-covid-report-upload.php";
		}, 3000);
  ...
  <body>
	...
	<div class="clear"> </div>
      ...
      <div class="container_wrap" style="padding:50px 0 0 0;">
        ...
        INTERNATIONAL VISITOR COVID REPORT UPLOAD
        </div>
          <div id="loginForm" >
            <div class="box-shadow">
              ...
              <div class="formwrapper2">
                ...
                <div class="d-flex flex-row  form-setup">
                    <div class="col-100 d-flex justify-around flex-wrap form-group">
                      ...
                      <div class="col-100" style="margin-top: 10px;">
                        <input type="email" class="form-control"  style="width: 90%;" id="email_id" name="email_id" autocomplete="off"/ >
                ...
                <div class="d-flex flex-column ">
                  <div class="d-flex flex-row">
                    <div class="col-50 col-m-100 d-flex  flex-wrap form-group">
                      ...
                      <input type="hidden" name="action" value="verify_email_id">
                    </div>
                  </div>
                </div>
                ...
                <div class="d-flex flex-row">
                    ...
                    <p style="font-size: 15px"><strong>International Visitor Registration</strong> 
					<a href="https://registration.gjepc.org/international_user_registration.php" class="gold_text">Click Here</a></p>
                    </div>                    
                </div>
              </form> 
              <!--<div>
                <span>Registration Under Maintainance</span>
              </div>-->
