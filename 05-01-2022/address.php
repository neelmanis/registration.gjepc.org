     ...
     <div class="bold_font text-center">
      ...
      <div id="loginForm" class="box-shadow">
            ...
            <div id="" class="row">
			  ...
			  <div class="col-sm-6 col-md-4 form-group">
                <label>GST </label>
                <input id="gst_number" type="text" name="gst_number" class="form-control" value="<?php echo $gst_number;?>" maxlength="15">
				<span id="gstError" class="error"></span>
              </div>
                <div class="col-sm-6 col-md-4 form-group">
                <label>GST Copy </label>
                <input id="gst_copy" type="file" name="gst_copy" class="form-control">
