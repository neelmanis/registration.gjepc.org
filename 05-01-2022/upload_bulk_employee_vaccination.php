      ...
      <div class="container_wrap my-5">
        <div class="container">
          ...
          <div class="bold_font text-center">
              ...
              Upload Employee Vaccination Certificate
          </div><p><span class='blink d-block'>Fully vaccinated visitors are mandatory</span> </p>
          <div id="loginForm">
            ...
            <form method="POST" name="regisForm" id="regisForm">
                ...
                <div class="row">
					<div class="col-md-6 form-group">
						<?php
						$checkHistory = "SELECT * FROM `visitor_order_history` WHERE registration_id='$registration_id' AND (`show`='signature23' || `show`='iijs22' || `show`='combo23') AND `status`='1' AND payment_status='Y' group by visitor_id";
						...
						<select name="visitor_id" id="visitor_id" class="form-control">
							...
							<option value="<?php echo $vis_list_row['visitor_id']?>"><?php echo getVisitorName($vis_list_row['visitor_id'],$conn);?>  (<?php echo getVisitorDesignationID(getVisitorDesignation($vis_list_row['visitor_id'],$conn),$conn);?>)</option>
						<?php }
						} ?>
						</select>
					</div>
				  ...
				  <div class="col-12">
                    ...
                    <label>
                      <input type="radio" id="dose2" name="valueType" value="dose2"/>Final 
                    </label>
                  </div>
                  ...
                  <div class="col-12 mb-2">
                    <div class="d-block">
                      ...
                      <ul class="inner_under_listing mt-3">
                        <li>I have read and understood the <a href="pdf/Visitor-Terms-Conditions-IIJS-Signature-2022.pdf" target="_blank"><strong>terms and conditions</strong></a> with regard to the visitor's registration.</li>
                  ...
                  <div class="col-12 p-0">
					<?php
					$i=1;
					$sql="SELECT * FROM visitor_lab_info WHERE registration_id='$registration_id' AND (category_for='VIS' || category_for='IGJME') order by create_date desc";
                  ...
                  <table class="w-100 responsive_table">
                    ...
                    <tbody>
						...
						{
							$visitor_name  = getVisitorName($rows['visitor_id'], $conn);
					...
					$dose1_certificate = "https://registration.gjepc.org/images/covid/vis/".$rows['registration_id']."/vaccine_certificate/".$rows['dose1']."";
                    $dose2_certificate = "https://registration.gjepc.org/images/covid/vis/".$rows['registration_id']."/vaccine_certificate/".$rows['dose2']."";
						?>
                     <tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
                        ...
                        <td data-column="Mobile"><?php echo filter($mobile_no);?></td>
...
function covidAction(){
	    ...
	    $.ajax({
		    type:'POST',
		    url:"upload-bulk-covid-report-ajax.php",
		    ...
		    success:function(data){
			    ...
			    if(data.status == 'success'){
					...
					$("#formWrapper").html('<div class="col-12"><div class="alert alert-success" role="alert">'+data.message+'</div></div>');
					 setTimeout(function(){
					    window.location = "upload_bulk_employee_vaccination.php";
					  },3000)
