...
<script>
  $("#option").live('change',function(){
	...
	if($('#selected_premium_type_hid').val()!='')
	  ...
	  <?php } else if($event_selected=='signature'){ ?>
	  var url = 'signature_combo_ajax.php';
	  var getdata = "actiontype=optionValue&&option="+option+"&&lastYearArea="+lastYearArea+"&&section="+section+"&&lastYearSignatureArea="+lastYearArea;
	  <?php } ?>
...
<div class="inner_container">
	...
	if($event_selected=='signature'){ $lastYearEvent = "IIJS Signature 2022"; }
