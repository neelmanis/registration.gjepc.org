...
{	   
		...
		$orderId = "AL".$registration_id.$strNo;
	//	$orderId = "ALLOTS23".$strNo;
...
if(isset($_POST['razorpay_payment_id']) && isset($_POST['razorpay_order_id']) ) 
{
	...
	$sqlmx="select contact_person,region from exh_reg_general_info where uid='$registration_id' and event_selected='iijs' AND event_for='$show' order by id desc limit 0,1";
...
<table width="100%" border="0" background="#fff" cellpadding="0" cellspacing="0">
	<tr>
    	...
    	<td align="right"><a href="https://gjepc.org/iijs-premiere/"><img src="'.LOGO.'"/></a></td>
    </tr>  
	...
	<tr>
    	...
    	<p>We have received your Payment for Stall Booking at IIJS PREMIERE 2022</p>  	
    	</td>
    </tr>
