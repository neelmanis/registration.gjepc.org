...
if($_SESSION['eventInfo']['event_selected']=="signature"){ $event_for="IIJS SIGNATURE 2022"; $eventMail = "IIJS SIGNATURE 2022"; } 
...
<table width="100%" border="0" background="#fff" cellpadding="0" cellspacing="0">
	<tr>
    	...
    	<td align="right"><a href="https://gjepc.org/iijs-signature/"><img src="https://registration.gjepc.org/images/signature-logo.png"/></a></td>
    </tr> 
...
<table width="100%" border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="8" bgcolor="#f4f4f4" style="border-collapse:collapse; float:left;">
    ...
    <tr>
        ...
        <td>'.getSection_desc($resultm['section'],$conn).'</td>
    </tr>
	<tr>
 ...
 <!-- <tr valign="top">
  ...
  <tr valign="top">
   ...
   <!--<tr valign="top">
    ...
    <td width="48%">IIJS SIGNATURE 2022 Participation charges</td>
    </tr>
    </table> -->
    </td>
    </tr>
	...
	<p>Kind Regards,</p>   
	<p><strong>IIJS SIGNATURE Team,</strong></p>
...
<div class="inner_container">
    ...
    <div class="form_main">        
        ...
        <strong>Section :</strong>&nbsp; <?php echo getSection_desc($section,$conn);?> <br />
        ...
        <div class="clear"></div>
        </div><?php if($event_selected=='iijs'){?><p><strong><span style="color: red;">Applicants are requested to make 100% Advance payment for IIJS Premiere 2021 after adjusting the advance payment done earlier.</span></strong></p><?php } ?>
		...
		<?php  if($getstallInfo['last_yr_participant']=="YES"){ ?>
		<div class="field_box">
...
<p>All the applicant members will have to update the details of advance payment along with UTR number and TDS on the dashboard after successful submission of online space application along with payment details before the deadline.
A system generated notification will be sent to you on successful approval of your application</p>
		...
		<input type="checkbox" name="agree" id="agree" style="display: inline-block;" checked><strong> I have read and hereby accept and agree <a href="https://gjepc.org/emailer_gjepc/21.10.2021/index2.html" target="_blank" style="color: red"> Stall booking circular </a>,<a href="https://gjepc.org/emailer_gjepc/21.10.2021/Guideline-for-Booth-Allotment.pdf" target="_blank" style="color: red"> Guidelines Rules Regulations for Allotment of Booths</a> , <a href="https://gjepc.org/emailer_gjepc/21.10.2021/TERMS-RULES-REGULATIONS.pdf" target="_blank" style="color: red"> Terms & Conditions </a></strong> 
