  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%; border:5px solid #feea3d;height:553.7px;overflow:hidden;" valign="top">
            <div style="height:553.7px; position:relative">
              <table cellpadding="8" cellspacing="0" style="width: 100%;">
                ...
                <div style="background: #feea3d; width:100%; color:#000; padding:10px 0; position:absolute; bottom:0; text-align:center">
                  <strong style="font-size: 30px;">MV</strong><br>
                  <p style="font-size: 28px; margin: 0; font-size: 20px; ">MACHINERY TRADE VISITOR</p>
                </div>
          ...
          <td style="width: 50%; height:553.7px; border:5px solid #feea3d;">
            <div style="height:553.7px; position:relative">
              ...
              <p style="margin:0 0 10px 0"><strong>SHOW TIMINGS - </strong>10 am - 07 pm</p> <br/>

              <table cellpadding="8" cellspacing="0" align="center" style="background:#f2f2f2; padding:10px 15px; ">

                        <tr>
                          <td align="center" colspan="2">
                            <h3 style="font-size:16px;margin: 0;">ENTRY INTO EXHIBITION HALL</h3>
                          </td>
                        </tr>

                        <tr>
                          <td><strong>4<sup>th</sup> - 7<sup>th</sup> August 2022</strong></td>
                          <td>10 am - 6.30 pm</td>
                        </tr>

                        <tr>
                          <td><strong>8<sup>th</sup> August 2022</strong></td>
                          <td>10 am - 6.00 pm</td>
                        </tr>
              ...
              <div style="background: #feea3d; width:100%; color:#000; padding:22.5px 0; position:absolute; bottom:0; text-align:center">
        ...
        <tr>
          ...
          <td align="center" style="width: 50%; border:5px solid #feea3d; height:553.7px; overflow:hidden" valign="middle">
          ...
          <td style="width: 50%; border:5px solid #feea3d; height:549px" valign="top">
            ...
            <div>
              ...
              <ul style="font-size:10px; margin-bottom:0; padding: 0 20px">
                    ...
                    <li>Visitor who are administered with both covid vaccine doses must upload the 2nd vaccination dose certificate. </li>

                    <li>The badge holder must follow and adhere the rules & regulations & security procedures set by GJEPC to enter the exhibition halls.</li>

                    <li>GJEPC reserves the right to postpone or cancel or transfer or change date, time, and the location of the Exhibition, and shall have no claims whatsoever in this regard.</li>

                    <li>Visitor needs to display the physical badge all the times during the exhibition as and when requested by authorities.</li>

                    <li>GJEPC reserves the right to refuse admission/suspend entry to the show of any visitors, exhibitors or their representative and any other categories of badges for security reasons and/or creating disturbance or discomfort of any kind to the show, also GJEPC reserves the right to admit any pre-registered visitor as per its discretion, even if the visitor&apos;s badges have been issued and paid for the show.</li>

                    <li>Person under the age of 18 years and above 65 years are not permitted to enter the show nor be the booth attendant/technicians/workers.</li>
                    ...
                    <li>Only Jewellery and Machinery businesspeople can register, associate, non-jewellers are not allowed.</li>

                    <li>Visitor Badge will not be issued to the Participant Companies at IIJS Premiere Show 2022.</li>

                    <li>If your company becomes exhibitor for any show, then your visitor registration for that show will get automatically cancelled.</li>

                    <li>Photography/Videography inside the exhibition is strictly prohibited. Council&apos;s officials reserve the right to confiscate the camera/phone and further, if deemed fit cancel your registration. </li>
