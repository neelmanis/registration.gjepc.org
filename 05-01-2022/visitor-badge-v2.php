  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%;">
            <div style="border:5px solid #bfcdca;height:551px;overflow:hidden;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="2" align="center" >
                      <div style="background:#bfcdca; padding:10px 0;  color: #000; margin:21px -8px 0 -8px">
          ...
          <div style="border:5px solid #bfcdca; height:551px">
              <table cellpadding="8" cellspacing="0" style="width: 100%;">
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <td  align="center" style="background: #bfcdca; color:#000">
