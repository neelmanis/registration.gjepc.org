  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%;">
            <div style="border:5px solid #e6c4ab;height:551px;overflow:hidden;">
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="2" style="text-align:center">
                       <p style="margin-bottom:0; background:#e6c4ab; color:#000; display:table; margin-left:auto; border-radius:100%; width:50px; height:50px; line-height:35px;margin-top:-30px;"><b>3SR</b></p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2" align="center" style="background:#e6c4ab; padding:21px 0; font-size: 28px; color: #000;font-weight:bold;">
                      PRESS
                    </td>
                  </tr>
                </tbody>
            ...
            <div>
              <table cellpadding="8" cellspacing="0" style="width: 100%;">
                <tbody>
                  ...
                  <tr>
                    <td  align="center" style="background: #e6c4ab; color:#000">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                        <p style="margin:0"><strong>SHOW TIMINGS - </strong>10:00 am to 7:00 pm</p> <br/>
                        <table cellpadding="8" cellspacing="0" align="center" style="background:#f2f2f2; padding:10px 15px">
                          ...
                          <tr>
                            <td><strong>04-08-2022 to 07-08-2022</strong></td>
                            <td>10:00 am to 6.30 pm</td>
                          </tr>

                          <tr>
                            <td><strong>08-08-2022</strong></td>
        ...
        <tr>
          ...
          <td style="width: 50%;">
            ...
            <div style="border:5px solid #e6c4ab; height:551px">
