...
if($action == "get_employees"){
	...
	$sql_vis = "SELECT CONCAT(first_name, ' ', last_name) AS visitor_name, eid,application_approved FROM ivr_registration_details 
			...
			WHERE ivr_registration_details.eid = ivr_registration_history.visitor_id and ivr_registration_history.payment_status='Y' and ivr_registration_history.payment_made_for='$show' ) AND `application_approved`='Y' AND `uid`='".$_SESSION['USERID']."'";
