...
if($action=="save")
{
	...
	function uploadOwnerImage($file_name,$file_temp,$file_type,$file_size,$id,$name)
	{
		...
		{
			if((($file_type == "image/jpg") || ($file_type == "image/jpeg") || ($file_type == "image/png") || ($file_type == "application/pdf")) && $file_size < 5242880)
			{
				$random_name = rand();
					...
					<form class="" method="POST" enctype="multipart/form-data" name="regisForm" id="regisForm" autocomplete="off"> 
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-4 form-group">
								...
								<input type="file" class="form-control" id="pan_copy" name="pan_copy" autocomplete="off" accept=".jpg,.jpeg,.png,.pdf"/>(Kindly upload Max 5MB. jpeg, png)
							</div>

					    	<div class="col-sm-6 col-md-4 form-group">
					      		<label><span style="color: red;" />*</span>GST annexture (Showing the Owner's Name): </label>
					      		<input type="file" class="form-control" id="partner" name="partner" autocomplete="off" accept=".jpg,.jpeg,.png,.pdf"/>(Kindly upload Max 5MB. jpeg, png)
					    	</div>
					   
							<div class="col-sm-6 col-md-4 form-group">
					      		<label><span style="color: red;" />*</span>Photo (Passport size): </label>
					      		<input type="file" class="form-control" id="photo"  name="photo" value="" autocomplete="off" accept=".jpg,.jpeg,.png,.pdf"/>(Kindly upload Max 5MB. jpeg, png) 
					    	</div>
