  ...
  <body style="margin:0; padding:0; ">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody style="height:100%">
        ...
        <tr>
          <td style="width: 50%; border:5px solid #19938A;height:553.7px;overflow:hidden;" valign="top">
              ...
              <table cellpadding="8" cellspacing="0" style="width: 100%;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width:50%;vertical-align: top;">
                      <p style="font-size:10px;margin:-15px auto 0"><strong>SHOW TIMINGS</strong></p>
                      <p>10 am - 07 pm</p>
                      <h3 style="font-size:10px;margin: 0;">ENTRY INTO EXHIBITION HALL</h3>
                     
                        <p><strong>3<sup>rd</sup> August 2022</strong></p>
                        <p>10 am - 06 pm</p>
                     
                        <p><strong>4<sup>th</sup> August 2022</strong></p>
                        <p>07 am - 08 pm</p>
                     
                        <p><strong>5<sup>th</sup> - 8<sup>th</sup> August 2022</strong></p>
                        <p>08 am - 08 pm</p>
                ...
                <div style="background: #19938A; width:100%; color:#fff; padding:10px 0; position:absolute; bottom:0; text-align:center">
                  <strong style="font-size: 30px;">E</strong><br>
                  <p style="font-size: 28px; margin: 0; font-size: 20px; ">EXHIBITOR</p>
                </div>
          ...
          <td style="width: 50%; height:553.7px; border:5px solid #19938A;">
            <div style="height:553.7px; position:relative">
              ...
              <table cellpadding="8" cellspacing="0" align="center" style="background:#f2f2f2; padding:10px 15px">
                      ...
                      <p style="font-size:20px text-align: center; margin:12px  0;"><strong> IIJS. WHERE BUSINESS HAPPENS</strong></p>
              ...
              <div style="background: #19938A; width:100%; color:#fff; padding:22.5px 0; position:absolute; bottom:0; text-align:center">
        ...
        <tr>
          ...
          <td align="center" style="width: 50%; border:5px solid #19938A; height:553.7px; overflow:hidden" valign="middle">
          ...
          <td style="width: 50%; border:5px solid #19938A; height:549px" valign="top">
              ...
              <table width="100%" cellspacing="0" cellpadding="10">
                ...
                <tr>
                  ...
                  <td colspan="2">
                    ...
                    <li>Exhibitor badge which was blocked due to breach of security norms will not be allowed to visit GJEPC&apos;s any shows in the future.</li>
