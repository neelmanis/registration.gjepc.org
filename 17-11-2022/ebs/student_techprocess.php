...
if(isset($registration_id) && $registration_id!=""){
	...
	$orderUpdate ="SELECT * FROM `visitor_order_detail` WHERE orderId='$orderId' AND regId='$registration_id' AND payment_status='P'";
	...
	$tpslUpdate ="update visitor_order_detail set tpsl_txn_id_rand='$tpsl_txn_id' WHERE orderId='$orderId' AND regId='$registration_id'";
	...
	$returnURL = "https://" . $_SERVER['HTTP_HOST']."/student_payment_success.php";
...
//echo $sequence = $reqType."|".$mrctCode."|".$mrctTxtID."|".$currencyType."|".$total_payable."|".$itc."|".$reqDetail."|".$txnDate."|".$bankCode."|".$locatorURL."|".$s2SReturnURL."|".$tpsl_txn_id."|".$cardID."|".$custID."|".$custname."|".$timeOut."|".$mobNo."|".$key."|".$iv."|".$returnURL; exit; 
   ...
   $transactionRequestBean = new TransactionRequestBean();
    ...
    $transactionRequestBean->returnURL = $returnURL . '?registration_id=' . $registration_id;
