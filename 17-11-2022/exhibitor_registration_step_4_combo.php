...
// $checks = "select * from exh_reg_payment_details where  uid = $uid and (`show` = 'IIJS TRITIYA 2023' or `show` = 'IIJS SIGNATURE 2023' and `year` = 2023)";
...
/*-------------------------------------------IIJS Data Insert Process Start--------------------------------------------------------*/
	...
	/*Common Data for both iijs & Signature start*/	
		...
		// else if(empty($cheque_tds_Netamount) && $tds_holder=="Yes" && $getiijsInfo['last_yr_participant'] == "YES") { $cheque_tds_Netamount_error = "Please Select Net Amount Payable"; }
		 ...
		 if(empty($signature_tds_holder) && $getsignatureInfo['last_yr_participant'] == "YES") { 
...
/*-------------------------------------------Signature Data Insert Process Start--------------------------------------------------------*/
		...
		$checks_signature = "select uid,gid from exh_reg_payment_details where uid='$uid' AND `show`='IIJS SIGNATURE 2023'   limit 0,1";//or `show`='IIJS TRITIYA 2023'
		$querycheck = $conn->query($checks_signature);
		$numCount_signature = $querycheck->num_rows; 
		$resultData = $querycheck->fetch_assoc();
		$gid_signature_update = $_SESSION['gid_signature'];
		$gid_tritiya_update = $_SESSION['gid_tritiya']; 
		if($numCount_signature >0)
		{
			/* Update Step 1 Data */
			$year= '2023';
			$company_name = strtoupper(str_replace(array('&amp;','&AMP;'), '&', $getgeneralInfo['company_name']));
			$update_signature = "UPDATE exh_reg_general_info set uid='$uid',company_name='".$company_name."',membership_id='".$getgeneralInfo['membership_id']."',membership_date='".$getgeneralInfo['membership_date']."',bp_number='".$getgeneralInfo['bp_number']."',address1='".$getgeneralInfo['address1']."',address2='".$getgeneralInfo['address2']."',address3='".$getgeneralInfo['address3']."',billing_address_id='".$getgeneralInfo['billing_address_id']."',get_billing_bp_number='".$getgeneralInfo['get_billing_bp_number']."',billing_gstin='".$getgeneralInfo['billing_gstin']."',billing_address1='".$getgeneralInfo['billing_address1']."',billing_address2='".$getgeneralInfo['billing_address2']."',billing_address3='".$getgeneralInfo['billing_address3']."',bcity='".$getgeneralInfo['bcity']."',bpincode='".$getgeneralInfo['bpincode']."',bcountry='".$getgeneralInfo['bcountry']."',btelephone_no='".$getgeneralInfo['btelephone_no']."',bfax_no='".$getgeneralInfo['bfax_no']."',billing_address_same='".$getgeneralInfo['billing_address_same']."',pan_no='".$getgeneralInfo['pan_no']."',tan_no='".$getgeneralInfo['tan_no']."',city='".$getgeneralInfo['city']."',pincode='".$getgeneralInfo['pincode']."',country='".$getgeneralInfo['country']."',telephone_no='".$getgeneralInfo['telephone_no']."',mobile='".$getgeneralInfo['mobile']."',fax_no='".$getgeneralInfo['fax_no']."',email='".$getgeneralInfo['email']."',membership_certificate_type='".$getgeneralInfo['membership_certificate_type']."',gst='".$getgeneralInfo['gst']."',kyc='".$getgeneralInfo['kyc']."',website='".$getgeneralInfo['website']."',contact_person='".$getgeneralInfo['contact_person']."',contact_person_desg='".$getgeneralInfo['contact_person_desg']."',contact_person_desg_show='".$getgeneralInfo['contact_person_desg_show']."',contact_person_co='".$getgeneralInfo['contact_person_co']."',contacts='".$getgeneralInfo['contacts']."',participant_type='".$getgeneralInfo['participant_type']."',region='".$getgeneralInfo['region']."',modified_date=NOW(),year='$year',company_type='".$getgeneralInfo['company_type']."',iec_number='".$getgeneralInfo['iec_number']."',dir_name='".$getgeneralInfo['dir_name']."',din_number='".$getgeneralInfo['din_number']."',cin_number='".$getgeneralInfo['cin_number']."',cast='".$getgeneralInfo['cast']."' where uid='$uid' and id = '$gid_signature_update' AND `event_for`='IIJS SIGNATURE 2023'"; 
			$result1 = $conn->query($update_signature);

			$update_tritiya = "UPDATE exh_reg_general_info set uid='$uid',company_name='".$company_name."',membership_id='".$getgeneralInfo['membership_id']."',membership_date='".$getgeneralInfo['membership_date']."',bp_number='".$getgeneralInfo['bp_number']."',address1='".$getgeneralInfo['address1']."',address2='".$getgeneralInfo['address2']."',address3='".$getgeneralInfo['address3']."',billing_address_id='".$getgeneralInfo['billing_address_id']."',get_billing_bp_number='".$getgeneralInfo['get_billing_bp_number']."',billing_gstin='".$getgeneralInfo['billing_gstin']."',billing_address1='".$getgeneralInfo['billing_address1']."',billing_address2='".$getgeneralInfo['billing_address2']."',billing_address3='".$getgeneralInfo['billing_address3']."',bcity='".$getgeneralInfo['bcity']."',bpincode='".$getgeneralInfo['bpincode']."',bcountry='".$getgeneralInfo['bcountry']."',btelephone_no='".$getgeneralInfo['btelephone_no']."',bfax_no='".$getgeneralInfo['bfax_no']."',billing_address_same='".$getgeneralInfo['billing_address_same']."',pan_no='".$getgeneralInfo['pan_no']."',tan_no='".$getgeneralInfo['tan_no']."',city='".$getgeneralInfo['city']."',pincode='".$getgeneralInfo['pincode']."',country='".$getgeneralInfo['country']."',telephone_no='".$getgeneralInfo['telephone_no']."',mobile='".$getgeneralInfo['mobile']."',fax_no='".$getgeneralInfo['fax_no']."',email='".$getgeneralInfo['email']."',membership_certificate_type='".$getgeneralInfo['membership_certificate_type']."',gst='".$getgeneralInfo['gst']."',kyc='".$getgeneralInfo['kyc']."',website='".$getgeneralInfo['website']."',contact_person='".$getgeneralInfo['contact_person']."',contact_person_desg='".$getgeneralInfo['contact_person_desg']."',contact_person_desg_show='".$getgeneralInfo['contact_person_desg_show']."',contact_person_co='".$getgeneralInfo['contact_person_co']."',contacts='".$getgeneralInfo['contacts']."',participant_type='".$getgeneralInfo['participant_type']."',region='".$getgeneralInfo['region']."',modified_date=NOW(),year='$year',company_type='".$getgeneralInfo['company_type']."',iec_number='".$getgeneralInfo['iec_number']."',dir_name='".$getgeneralInfo['dir_name']."',din_number='".$getgeneralInfo['din_number']."',cin_number='".$getgeneralInfo['cin_number']."',cast='".$getgeneralInfo['cast']."' where uid='$uid' and id = '$gid_tritiya_update' AND `event_for`='IIJS TRITIYA 2023'"; 
			$result1 = $conn->query($update_tritiya);

			/* Update Step 2 Data */
			$comp_desc = trim($getcompanyInfo['comp_desc']);
			$comp_desc = str_replace("'","\'", $comp_desc); 
			$update_companyInfo = "UPDATE exh_reg_company_details set we_are_jewellery='".$getcompanyInfo['we_are_jewellery']."', we_are_loose='".$getcompanyInfo['we_are_loose']."',we_are_machinery='".$getcompanyInfo['we_are_machinery']."', we_are='".$getcompanyInfo['we_are']."', we_are_jewellery_any_other='".$getcompanyInfo['we_are_jewellery_any_other']."',we_are_loose_any_other='".$getcompanyInfo['we_are_loose_any_other']."',we_are_machinery_any_other='".$getcompanyInfo['we_are_machinery_any_other']."', we_are_any_other='".$getcompanyInfo['we_are_any_other']."',comp_desc='".$comp_desc."',last_yr_turn_over='".$getcompanyInfo['last_yr_turn_over']."' where uid='$uid' and gid = '$gid_signature_update' AND `show`='IIJS SIGNATURE 2023' AND event_selected='signature23'";
			$result2 = $conn->query($update_companyInfo);
			if(!$result2) { die('Error: Company Details Update query failed' . $conn->error); }	
			$update_tritiyaInfo = "UPDATE exh_reg_company_details set we_are_jewellery='".$getcompanyInfo['we_are_jewellery']."', we_are_loose='".$getcompanyInfo['we_are_loose']."',we_are_machinery='".$getcompanyInfo['we_are_machinery']."', we_are='".$getcompanyInfo['we_are']."', we_are_jewellery_any_other='".$getcompanyInfo['we_are_jewellery_any_other']."',we_are_loose_any_other='".$getcompanyInfo['we_are_loose_any_other']."',we_are_machinery_any_other='".$getcompanyInfo['we_are_machinery_any_other']."', we_are_any_other='".$getcompanyInfo['we_are_any_other']."',comp_desc='".$comp_desc."',last_yr_turn_over='".$getcompanyInfo['last_yr_turn_over']."' where uid='$uid' and gid = '$gid_tritiya_update' AND `show`='IIJS TRITIYA 2023' AND event_selected='iijstritiya23'";
			$result3 = $conn->query($update_tritiyaInfo);
			if(!$result3) { die('Error: Company Details Update query failed' . $conn->error); }	
			
			/* Update Step 3 Data */
			$stallInfos_signature = "UPDATE exh_registration set options='".$getsignatureInfo['option']."',woman_entrepreneurs='".$getsignatureInfo['woman_entrepreneurs']."',last_yr_participant='".$getsignatureInfo['last_yr_participant']."',section='".$getsignatureInfo['section']."',category='".$getsignatureInfo['category']."',selected_area='".$getsignatureInfo['selected_area']."',selected_scheme_type='".$getsignatureInfo['selected_scheme_type']."',selected_premium_type='".$getsignatureInfo['selected_premium_type']."',tot_space_cost_rate='".floatval($getsignatureInfo['tot_space_cost_rate'])."',tot_space_cost_discount='".$getsignatureInfo['tot_space_cost_discount']."',get_tot_space_cost_rate='".$getsignatureInfo['get_tot_space_cost_rate']."',get_category_rate='".$getsignatureInfo['get_category_rate']."',selected_scheme_rate='".$getsignatureInfo['selected_scheme_rate']."',selected_premium_rate='".$getsignatureInfo['selected_premium_rate']."',sub_total_cost ='".$getsignatureInfo['sub_total_cost']."',security_deposit='".$getsignatureInfo['security_deposit']."',govt_service_tax='".$getsignatureInfo['govt_service_tax']."',grand_total='".$getsignatureInfo['grand_total']."',incentive='".$getsignatureInfo['incentive']."',discount='".$getsignatureInfo['discount']."',incentive_value='".$getsignatureInfo['incentive_value']."',discount_value='".$getsignatureInfo['discount_value']."' where uid='$uid' and gid = '$gid_signature_update' AND  `show`='IIJS SIGNATURE 2023' AND event_selected='signature23'";
			$stallResult = $conn->query($stallInfos_signature);	
			if(!$stallResult) { die('Error: Stall Details Update query failed' . $conn->error); }
			$stallInfos_tritiya = "UPDATE exh_registration set options='".$getTritiyaInfo['option']."',woman_entrepreneurs='".$getTritiyaInfo['woman_entrepreneurs']."',last_yr_participant='".$getTritiyaInfo['last_yr_participant']."',section='".$getTritiyaInfo['section']."',category='".$getTritiyaInfo['category']."',selected_area='".$getTritiyaInfo['selected_area']."',selected_scheme_type='".$getTritiyaInfo['selected_scheme_type']."',selected_premium_type='".$getTritiyaInfo['selected_premium_type']."',tot_space_cost_rate='".floatval($getTritiyaInfo['tot_space_cost_rate'])."',tot_space_cost_discount='".$getTritiyaInfo['tot_space_cost_discount']."',get_tot_space_cost_rate='".$getTritiyaInfo['get_tot_space_cost_rate']."',get_category_rate='".$getTritiyaInfo['get_category_rate']."',selected_scheme_rate='".$getTritiyaInfo['selected_scheme_rate']."',selected_premium_rate='".$getTritiyaInfo['selected_premium_rate']."',sub_total_cost ='".$getTritiyaInfo['sub_total_cost']."',security_deposit='".$getTritiyaInfo['security_deposit']."',govt_service_tax='".$getTritiyaInfo['govt_service_tax']."',grand_total='".$getTritiyaInfo['grand_total']."',incentive='".$getTritiyaInfo['incentive']."',discount='".$getTritiyaInfo['discount']."',incentive_value='".$getTritiyaInfo['incentive_value']."',discount_value='".$getTritiyaInfo['discount_value']."' where uid='$uid' and gid = '$gid_tritiya_update' AND  `show`='IIJS TRITIYA 2023' AND event_selected='iijstritiya23'";
			$stallResult1 = $conn->query($stallInfos_tritiya);	
			if(!$stallResult1) { die('Error: Stall Details Update query failed' . $conn->error); }

			

			if($_POST["signature_tds_holder"] == 'Yes' ) {
				$amountPay_signature = $conn->real_escape_string($_POST["signature_cheque_tds_Netamount"]);
			} else if($_POST["tds_holder"] == 'No' ) {
				$amountPay_signature = $conn->real_escape_string($_POST["signature_net_payable_amount"]);
			} else {
				$amountPay_signature = $conn->real_escape_string($_POST["signature_net_payable_amount"]);
			}

			if($_POST["tritiya_tds_holder"] == 'Yes' ) {
			...
			$amountPay = $amountPay_signature+$amountPay_tritiya;
			...
			$paymentInfo_signature = "UPDATE exh_reg_payment_details set int_type='$int_type', payment_mode='$signature_payment_mode', bank_acc_no='$bank_acc_no', name_bank='$name_bank', name_bank_branch='$name_bank_branch', ifsc_code='$ifsc_code', int_acc_type='$int_acc_type',`tds_holder`='$signature_tds_holder',`net_payable_amount`='$signature_net_payable_amount',`percentage`='$signature_amount_payable', `cheque_tds_gross_amount`='$cheque_tds_gross_amount',`cheque_tds_per`='$signature_cheque_tds_per',`cheque_tds_amount`='$signature_cheque_tds_amount',`cheque_tds_Netamount`='$signature_cheque_tds_Netamount',`cheque_tds_deducted`='$signature_cheque_tds_deducted' WHERE  uid='$uid' and gid = '$gid_signature_update' and `show`='IIJS SIGNATURE 2023' and event_selected='signature23' ";
			$result4 = $conn->query($paymentInfo_signature);
			if(!$result4) { die('Error: ' . $conn->error); }

			$paymentInfo_tritiya = "UPDATE exh_reg_payment_details set int_type='$int_type', payment_mode='$tritiya_payment_mode', bank_acc_no='$bank_acc_no', name_bank='$name_bank', name_bank_branch='$name_bank_branch', ifsc_code='$ifsc_code', int_acc_type='$int_acc_type',`tds_holder`='$tds_holder',`net_payable_amount`='$tritiya_net_payable_amount',`percentage`='$tritiya_amount_payable', `cheque_tds_gross_amount`='$cheque_tds_gross_amount',`cheque_tds_per`='$tritiya_cheque_tds_per',`cheque_tds_amount`='$tritiya_cheque_tds_amount',`cheque_tds_Netamount`='$tritiya_cheque_tds_Netamount',`cheque_tds_deducted`='$tritiya_cheque_tds_deducted' WHERE uid='$uid' and gid = '$gid_tritiya_update' and `show`='IIJS TRITIYA 2023' and event_selected='iijstritiya23' ";
			$result5 = $conn->query($paymentInfo_tritiya);
			if(!$result5) { die('Error: ' . $conn->error); }

			include 'rz_combo_pay.php';
		}  else {
			$generalInfo_signature = "insert into exh_reg_general_info set uid='$uid',company_name='".$getgeneralInfo['company_name']."',membership_id='".$getgeneralInfo['membership_id']."',membership_date='".$getgeneralInfo['membership_date']."',bp_number='".$getgeneralInfo['bp_number']."',address1='".$getgeneralInfo['address1']."',address2='".$getgeneralInfo['address2']."',address3='".$getgeneralInfo['address3']."',billing_address_id='".$getgeneralInfo['billing_address_id']."',get_billing_bp_number='".$getgeneralInfo['get_billing_bp_number']."',billing_gstin='".$getgeneralInfo['billing_gstin']."',billing_address1='".$getgeneralInfo['billing_address1']."',billing_address2='".$getgeneralInfo['billing_address2']."',billing_address3='".$getgeneralInfo['billing_address3']."',bcity='".$getgeneralInfo['bcity']."',bpincode='".$getgeneralInfo['bpincode']."',bcountry='".$getgeneralInfo['bcountry']."',btelephone_no='".$getgeneralInfo['btelephone_no']."',bfax_no='".$getgeneralInfo['bfax_no']."',billing_address_same='".$getgeneralInfo['billing_address_same']."',pan_no='".$getgeneralInfo['pan_no']."',tan_no='".$getgeneralInfo['tan_no']."',city='".$getgeneralInfo['city']."',pincode='".$getgeneralInfo['pincode']."',country='".$getgeneralInfo['country']."',telephone_no='".$getgeneralInfo['telephone_no']."',mobile='".$getgeneralInfo['mobile']."',fax_no='".$getgeneralInfo['fax_no']."',email='".$getgeneralInfo['email']."',gst='".$getgeneralInfo['gst']."',kyc='".$getgeneralInfo['kyc']."',website='".$getgeneralInfo['website']."',contact_person='".$getgeneralInfo['contact_person']."',contact_person_desg='".$getgeneralInfo['contact_person_desg']."',contact_person_desg_show='".$getgeneralInfo['contact_person_desg_show']."',contact_person_co='".$getgeneralInfo['contact_person_co']."',contacts='".$getgeneralInfo['contacts']."',event_for='IIJS SIGNATURE 2023',event_selected='signature23',participant_type='".$getgeneralInfo['participant_type']."',region='".$getgeneralInfo['region']."',created_date=NOW(),isCombo='Y',year='2023',company_type='".$getgeneralInfo['company_type']."',iec_number='".$getgeneralInfo['iec_number']."',dir_name='".$getgeneralInfo['dir_name']."',din_number='".$getgeneralInfo['din_number']."',cin_number='".$getgeneralInfo['cin_number']."',cast='".$getgeneralInfo['cast']."' ";
			...
			if($gid_signature!='') //check gid is not blank
			{
				...
				/*========================================================================================================================*/
				$companyInfo_signature = "INSERT into exh_reg_company_details set gid='".$gid_signature."', uid='$uid', we_are_jewellery='".$getcompanyInfo['we_are_jewellery']."', we_are_loose='".$getcompanyInfo['we_are_loose']."',we_are_machinery='".$getcompanyInfo['we_are_machinery']."', we_are='".$getcompanyInfo['we_are']."', we_are_jewellery_any_other='".$getcompanyInfo['we_are_jewellery_any_other']."',we_are_loose_any_other='".$getcompanyInfo['we_are_loose_any_other']."',we_are_machinery_any_other='".$getcompanyInfo['we_are_machinery_any_other']."', we_are_any_other='".$getcompanyInfo['we_are_any_other']."',comp_desc='".$conn->real_escape_string($getcompanyInfo['comp_desc'])."',last_yr_turn_over='".$getcompanyInfo['last_yr_turn_over']."',created_date=NOW(),`show`='IIJS SIGNATURE 2023',event_selected='signature23',isCombo='Y',year='2023'";
				...
				if($gid_tritiya!='') //check gid is not blank
				{
					...
					/*========================================================================================================================*/
					$companyInfo_tritiya = "INSERT into exh_reg_company_details set gid='".$gid_tritiya."', uid='$uid', we_are_jewellery='".$getcompanyInfo['we_are_jewellery']."', we_are_loose='".$getcompanyInfo['we_are_loose']."',we_are_machinery='".$getcompanyInfo['we_are_machinery']."', we_are='".$getcompanyInfo['we_are']."', we_are_jewellery_any_other='".$getcompanyInfo['we_are_jewellery_any_other']."',we_are_loose_any_other='".$getcompanyInfo['we_are_loose_any_other']."',we_are_machinery_any_other='".$getcompanyInfo['we_are_machinery_any_other']."', we_are_any_other='".$getcompanyInfo['we_are_any_other']."',comp_desc='".$conn->real_escape_string($getcompanyInfo['comp_desc'])."',last_yr_turn_over='".$getcompanyInfo['last_yr_turn_over']."',created_date=NOW(),`show`='IIJS TRITIYA 2023',event_selected='iijstritiya23',isCombo='Y',year='2023'";
...
$(window).ready(function(){
	...
	$("#step_4_combo").on("submit",function(){
  ...
  //       });
		...
		$("input[name='tritiya_tds_holder']").click(function () {
            if ($("#tritiya_chkYes").is(":checked")) {
                $("#tritiya_tds_holder").show();
            } else {
                $("#tritiya_tds_holder").hide();
            }
        });
     ...
     function change_amount_signature() {
        var net_payable_amount = $("#signature_net_payable_amount").val();
        var cheque_tds_amount = $("#signature_cheque_tds_amount").val();
		var cheque_tds_per = $("#signature_cheque_tds_per").val();
     ...
     function change_amount_tritiya() {
        var net_payable_amount = $("#tritiya_net_payable_amount").val();
        var cheque_tds_amount = $("#tritiya_cheque_tds_amount").val();
		var cheque_tds_per = $("#tritiya_cheque_tds_per").val();
		...
		if(net_payable_amount != '' || net_payable_amount != 0)
		{
			...
			var amount = net_payable_amount - cheque_tds_amount;
			if(amount>0 && get_tds_amount >= cheque_tds_amount && cheque_tds_amount>0){
			$("#tritiya_cheque_tds_Netamount").val(amount); 
			$("#pay").attr("disabled",false);
			} else { 
			alert('TDS Amount should be less than selected TDS percentage of Gross Amount'); 
			$("#pay").attr("disabled",true);
			$("#tritiya_cheque_tds_amount").val('');
			}
		} else {
			alert("Please Select Amount Payable");
			return false;
...
<div class="inner_container">
    ...
    <div class="wrap">
		<div class="row mb-4">
			<div class="col-12 col-md-4 border pt-3" style="display:none;">
		        ...
		        <p><strong>Section :</strong>&nbsp; <?php echo getSection_description($getiijsInfo['section'],$conn);?> </p>
			...
			<div class="col-12 col-md-6 border pt-3">
		        ...
		        <strong>Section :</strong>&nbsp; <?php echo getSection_description($getsignatureInfo['section'],$conn);?> <br />
			...
			<div class="col-12 col-md-6 border pt-3">
			  ...
			  <!--       <strong>Option :</strong>&nbsp; <?php //echo $getTritiyaInfo['option'];?> <br /> -->
			        <strong>Section :</strong>&nbsp; <?php echo getSection_description_tritiya($getTritiyaInfo['section'],$conn);?> <br />
...
<form action="" method="post" id="step_4_combo">
		...
		<div class="field_box" id="holder_star">
            ...
            <div class="field_box">
				...
				<div class="field_input"> 
				<input name="cheque_tds_amount" type="text" id="cheque_tds_amount" class="textField"  autocomplete="off"  value="<?php echo $cheque_tds_amount;?>" />
		...
		// }
		?>  
		<option value="RTGS" <?php if($payment_mode=="ONLINE") { echo "selected"; } ?> >ONLINE</option>               
        </select>
        ...
        <div class="field_input">
			<select class="textField" name="signature_amount_payable" id="signature_amount_payable"/>
				 ...
				 <option <?php if($signature_amount_payable =="25"){echo "selected";}?> value="25">25%</option>
				 <?php } else { ?>
				 <option <?php if($signature_amount_payable =="25"){echo "selected";}?> value="25">25%</option>
		...
		<?php if(strtoupper($getsignatureInfo['last_yr_participant']) =="YES" || strtoupper($getsignatureInfo['last_yr_participant']) =="NO"){ ?>
		<div class="field_box">
        <div class="field_name"><strong>TDS Deducted</strong></div>
        <div class="field_input">
		Yes <input type="radio" id="signature_chkYes" value="Yes" name="signature_tds_holder" <?php if( $signature_tds_holder=="Yes"){echo "checked";}?> />
		No <input type="radio" id="signature_chkNo" value="No" name="signature_tds_holder"  <?php if($signature_tds_holder=="No"){echo "checked";}?>/></label>
		</div>
		<label for="signature_tds_holder" generated="true" class="error" style="display: inline-block;"></label>
         <?php if(isset($signature_tds_holder_error)){ echo "<span style='color: red;display: inline-block;'>".$signature_tds_holder_error.'</span>';} ?>
        <div class="clear"></div>
        </div>		
		...
		<div class="field_box" id="signature_holder_star" >	
			...
			<div class="field_box">
				...
				<option  value="">--Select TDS percentage--</option>
			     <option <?php if($signature_cheque_tds_per =="2"){echo "selected";}?> value="2">2 %</option>
				 <option <?php if($signature_cheque_tds_per =="10"){echo "selected";}?> value="10">10 %</option>
				</select>				
                <br><label class="error" id="signature_cheque_tds_per_error"></label>
                 <?php if(isset($signature_cheque_tds_per_error)){ echo "<span style='color: red;'>".$signature_cheque_tds_per_error.'</span>';} ?>
            ...
            <div class="field_box">
                <div class="field_name">TDS Amount <span>*</span> :</div> 
				<div class="field_input"> 
				<input name="signature_cheque_tds_amount" type="number" id="signature_cheque_tds_amount" class="textField" value="<?php echo $signature_cheque_tds_amount;?>" autocomplete="off" onkeyup="return change_amount_signature()" />
                <br><label class="error" id="signature_cheque_tds_amount_error"></label>
                 <?php if(isset($signature_cheque_tds_amount_error)){ echo "<span style='color: red;'>".$signature_cheque_tds_amount_error.'</span>';} ?>
			...
			<div class="field_box">
                <div class="field_name">Net Amount<span>*</span> :</div>
                <div class="field_input">
				<input name="signature_cheque_tds_Netamount" value="<?php echo $signature_cheque_tds_Netamount;?>" type="text" id="signature_cheque_tds_Netamount" class="textField" />
                <br><label class="error" id="signature_cheque_tds_Netamount_error"></label>
                 <?php if(isset($signature_cheque_tds_Netamount_error)){ echo "<span style='color: red;'>".$signature_cheque_tds_Netamount_error.'</span>';} ?>
		...
		?>     
		<option value="RTGS" <?php if($signature_payment_mode=="ONLINE") { echo "selected"; } ?> >ONLINE</option>       
        </select>
        ...
        <div class="field_input">
			<select class="textField" name="tritiya_amount_payable" id="tritiya_amount_payable"/>
				 <option value=""> Select Payable Amount  </option>
				 <?php if(strtoupper($getsignatureInfo['last_yr_participant'])=="NO"){ ?>
				 <option <?php if($tritiya_amount_payable =="25"){echo "selected";}?> value="25">25%</option>
				 <?php } else { ?>
				 <option <?php if($tritiya_amount_payable =="25"){echo "selected";}?> value="25">25%</option>
		...
		<div class="field_box" id="tritiya_holder_star" >	
            ...
            <div class="field_box">
                <div class="field_name">TDS Amount <span>*</span> :</div> 
				<div class="field_input"> 
				<input name="tritiya_cheque_tds_amount" type="text" id="tritiya_cheque_tds_amount" class="textField" value="<?php echo $tritiya_cheque_tds_amount;?>" autocomplete="off" onkeyup="return change_amount_tritiya()"/>
		...
		// }
		?>  
		<option value="RTGS" <?php if($tritiya_payment_mode=="ONLINE") { echo "selected"; } ?> >ONLINE</option>               
        </select>
    	...
    	<!-- RTGS description -->
        <div id="rtgs_desc" style="margin-bottom:10px;font-size:12px; display: none;">
...
A system generated notification will be sent to you on successful approval of your application</p>
        ...
        <div class="field_input"><input type="submit" class="button" value="submit" id="pay" name="submit" /> </div>
        <div class="clear"></div>
        </div>
