...
arrowimages: {down:[], right:['rightarrowclass', 'right.gif']},
...
//		)
	...
	if (smoothmenu.shadow.enable && smoothmenu.css3support){ //if shadows enabled and browser supports CSS3 shadows
		...
		var css3shadow=parseInt(smoothmenu.shadow.offsetx)+"px "+parseInt(smoothmenu.shadow.offsety)+"px 5px #777" //construct CSS3 box-shadow value
