...
if($_SESSION['redirectLink'] !="institute"){
 echo "<script>alert('Company not allow to register'); window.location = 'my_dashboard.php';</script>";
}
								...
								<form id="item_selection" name="item_selection" method="POST" onSubmit="return validate()">
									<div class="row">
												<div class="col-12 form-group">
													<div class="title margin_t duo"><a href="student_directory.php" class="cta" title="ADD / Edit Application">Manage Directory</a>
													</div>
												</div>
													...
													<table class="responsive_table">
														...
														<thead>
															<tr>
																...
																<th scope="col" width="35%">Select Student</th>
											...
											<td data-column="Show">
												<select name="payment_made_for" id="payment_made_for" onchange="get_employees(this.value)" class="select-control" style="width:100%">
													<option value="">--- Please Select One ---</option>
														<?php 
														$sql_event = "SELECT * FROM `visitor_event_master` WHERE `status` ='1' AND id='2'";
										...
										<div class="content" id="data"></div>
												...
												<div class="title margin_t">                
												    ...
												    <div class="row">
														...
														<form name="visitorRegn" action="student_payment_thankyou.php" method="POST" onsubmit="document.getElementById('myButton').disabled=true;
