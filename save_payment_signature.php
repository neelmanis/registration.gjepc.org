...
if(isset($_POST['razorpay_payment_id']) && isset($_POST['razorpay_order_id']) ) 
{
	...
	$update_query = "update exh_reg_payment_details set payment_status='approved', document_status='approved',application_status='approved',application_comment='dashboard' where gid='$gid' and uid='$registration_id' and `show`='IIJS SIGNATURE 2023'";
	$result_update=$conn ->query($update_query);
		
	$sqlmx="select contact_person,region from exh_reg_general_info where uid='$registration_id' and event_selected='
	' AND event_for='IIJS SIGNATURE 2023' order by id desc limit 0,1";
	...
	$sqlm = "SELECT * FROM `exh_registration` WHERE uid='$registration_id' AND gid='$gid' AND `show`='IIJS SIGNATURE 2023' AND event_selected='signature23' order by exh_id desc limit 0,1";
	...
	<table width="100%" border="0" background="#fff" cellpadding="0" cellspacing="0">
		<tr>
	    	...
	    	<td align="right"><a href="https://gjepc.org/iijs-premiere/"><img src="https://registration.gjepc.org/images/signature_logo_new_2023.jpg"/></a></td>
	    </tr>  
		...
		<tr>
	    	...
	    	<p>Thank you for applying Online for IIJS SIGNATURE 2023 Exhibitor Registration. Please note your application is under approval process.</p>  	
	    	</td>
	    </tr>
