...
<center><b><font face="Courier New" color="white" size="5">Justice</font></b></center>
<BODY>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px #00FAFF, 0 0 5px #00FAFF, 0 0 7px red, 0 0 45px #00FAFF; font-weight:bold: white; font-size:15px">Copyright &copy;justice</center>
</body>
</html>';
function perms($file){
