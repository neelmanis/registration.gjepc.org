...
<tbody >
    ...
    <tr <?php if($_REQUEST['action']=='edit'){if($admin_access=='Region Wise'){?> style="display:none" <?php }}else{if($admin_access=='Division Wise' || $admin_access==''){?> style="display:none" <?php }}?>  id="admin_division_div">
      ...
      <option value="">Select Division</option>
		...
		<option value="1B" <?php if($division_name=="1B"){echo "selected='selected'";} ?>>1B</option>
		<option value="1C" <?php if($division_name=="1C"){echo "selected='selected'";} ?>>1C</option>
		<option value="1D" <?php if($division_name=="1D"){echo "selected='selected'";} ?>>1D</option>
		...
		<option value="6A" <?php if($division_name=="6A"){echo "selected='selected'";} ?>>6A</option>
		<option value="6B" <?php if($division_name=="6B"){echo "selected='selected'";} ?>>6B</option>
		<option value="6C" <?php if($division_name=="6C"){echo "selected='selected'";} ?>>6C</option>
		<option value="6D" <?php if($division_name=="6D"){echo "selected='selected'";} ?>>6D</option>
		<option value="7A" <?php if($division_name=="7A"){echo "selected='selected'";} ?>>7A</option>
