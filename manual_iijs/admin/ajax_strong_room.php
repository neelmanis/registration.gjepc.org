...
if(isset($_POST['actiontype']) && $_POST['actiontype']=="getBadgeDetails"){
	...
	$query=mysql_query("select * from iijs_badge_items where Badge_Item_ID='$Badge_Item_ID'");
    ...
    echo "<td>Photo</td>";
    echo "<td>:</td>";
    echo "<td><img src='../images/badges/$rows[Exhibitor_Code]/$rows[Badge_Photo]' width='150px' height='120' /></td>";
    echo "</tr></table>";
