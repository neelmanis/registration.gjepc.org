...
<?PHP
  ...
  $export_filename = "Pending_badge_for_approval" . date('Ymd') . ".xls";
	...
	$result = $conn ->query("SELECT b.Badge_Item_ID as 'ID',a.Exhibitor_Name as 'Company Name',b.Badge_Name as 'Person name',b.Badge_Designation,b.Badge_Mobile,b.Badge_Approved FROM manual_iijs2021.iijs_exhibitor a, manual_iijs2021.iijs_badge_items b where a.Exhibitor_Code=b.Exhibitor_Code and Badge_Approved='P'") or die('Query failed!');
