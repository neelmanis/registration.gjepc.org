...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: manage_so_housekeep.php?action=view");
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="manage_house_keeping.php">Home</a> > House Keeping SO</div>
</div>

<div id="main">
	<div class="content">
    	<div class="content_head">
		<div class="content_head_button">House Keeping Services</div>
			<div class="content_head_button"><a href="export_so_housekeeping_generated.php"> Export SO Data</a></div>
		</div>  
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <?php
	...
	{
	$sql.=" and (b.Exhibitor_Name like '%".$_SESSION['Exhibitor_Name']."%' || a.orderId like '%".$_SESSION['Exhibitor_Name']."%')";
	}
	//echo $sql;
...
?>	
<div class="pages_1">Total number of Memberships: <?php echo $rCount;?><?php echo pagination($limit,$page,'manage_so_housekeep.php?action=view&page=',$rCount); //call function to show pagination?></div>        
...
$(".so").click(function() {
	...
	if (confirm('Are you sure you want to Create Housekeeping Sales order')) {
		$.ajax({
		url: "sap_housekeep_api.php",
		method:"POST",
