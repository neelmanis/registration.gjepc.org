...
{	//echo "<pre>"; print_r($_POST);exit;
	...
	$query="SELECT a.*,b.* FROM `iijs_wirelessinternet` a,iijs_payment_master b WHERE 1 and a.`Payment_Master_ID`=b.`Payment_Master_ID` and a.Exhibitor_Code='$exhibitor_code' and b.Form_ID='7' and b.txn_status!='300' AND b.Payment_Master_Approved='Y' order by b.Payment_Master_ID asc";
	...
	{	
	$item_material = trim(getSap_material_no($itemsResult['WirelessInternet_Items_Master_Id']));
