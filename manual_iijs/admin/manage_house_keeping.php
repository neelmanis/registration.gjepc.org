...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="manage_house_keeping.php">Home</a> > House Keeping Services</div>
</div>

<div id="main">
	<div class="content">
    	<div class="content_head"><div class="content_head_button">House Keeping Services</div></div>
<div class="content_details1">
<?php 
	if($_SESSION['admin_role']=='Super Admin')
	{
		$sql5="SELECT a.*,b.* FROM `iijs_housekeeping` a,iijs_exhibitor b WHERE 1 and a.`Exhibitor_Code`=b.Exhibitor_Code";		
	}else if($_SESSION['admin_role']=='Admin')
	{
		if($_SESSION['admin_admin_access']=='Region Wise')
		{
		$sql5="SELECT a.*,b.* FROM `iijs_housekeeping` a,iijs_exhibitor b WHERE 1 and a.`Exhibitor_Code`=b.Exhibitor_Code and b.Exhibitor_Region='".$_SESSION['admin_region_name']."'";
		}else
		{
		$sql5="SELECT a.*,b.* FROM `iijs_housekeeping` a,iijs_exhibitor b WHERE 1 and a.`Exhibitor_Code`=b.Exhibitor_Code and b.Exhibitor_DivisionNo='".$_SESSION['admin_division_name']."'";
		}
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <?php
	...
	if($_SESSION['admin_role']=='Super Admin')
	{
		$sql="SELECT a.*,b.* FROM `iijs_housekeeping` a,iijs_exhibitor b WHERE 1 and a.`Exhibitor_Code`=b.Exhibitor_Code";		
	}else if($_SESSION['admin_role']=='Admin')
	{
		if($_SESSION['admin_admin_access']=='Region Wise')
		{
		$sql="SELECT a.*,b.* FROM `iijs_housekeeping` a,iijs_exhibitor b WHERE 1 and a.`Exhibitor_Code`=b.Exhibitor_Code and b.Exhibitor_Region='".$_SESSION['admin_region_name']."'";
		}else
		{
		$sql="SELECT a.*,b.* FROM `iijs_housekeeping` a,iijs_exhibitor b WHERE 1 and a.`Exhibitor_Code`=b.Exhibitor_Code and b.Exhibitor_DivisionNo='".$_SESSION['admin_division_name']."'";
		}
	}
	...
	{
	$sql.="a.Payment_Approved='P' or ";
	}
	if($_SESSION['Payment_Y']=="Y")
	{
	$sql.="a.Payment_Approved='Y' or ";
	}
	if($_SESSION['Payment_N']=="N")
	{
	$sql.="a.Payment_Approved='N' or ";
	}
  ...
  <tr>
	...
	?>
   	...
   	<td><a href="Form16.php?HouseKeeping_ID=<?php echo $rows['HouseKeeping_ID'];?>&Exhibitor_Code=<?php echo $rows['Exhibitor_Code'];?>" class="edit">Edit</a></td>
  </tr>
...
?>	
<div class="pages_1">Total number of Memberships: <?php echo $rCount;?><?php echo pagination($limit,$page,'manage_house_keeping.php?action=view&page=',$rCount); //call function to show pagination?></div>        
