...
{	//echo "<pre>"; print_r($_POST);exit;
	...
	$query="SELECT a.*,b.* FROM `iijs_stand` a,iijs_payment_master b WHERE 1 and a.`Payment_Master_ID`=b.`Payment_Master_ID` and a.Exhibitor_Code='$exhibitor_code' and b.Form_ID='3' and b.txn_status='300' and b.Payment_Master_OrderNo='$order_id' order by b.Payment_Master_ID asc";
