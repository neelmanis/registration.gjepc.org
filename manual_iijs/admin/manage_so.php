...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: manage_so.php?action=view");
}
...
<title> Manual || Manage SALES Order</title>
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="search_application.php">Home</a> > Manage Sales Order</div>
</div>

<div id="main">
	<div class="content">
    	<div class="content_head">
			<div class="content_head_button">Manage Sales Order</div>
			<div class="content_head_button"><a href="export_so_generated.php"> Export SO Data</a></div>
		</div>		
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  <tr class="orange1">
	...
	{
		$sql="SELECT a.*,b.Exhibitor_Name,b.Exhibitor_Country_ID FROM `iijs_payment_master` a,iijs_exhibitor b WHERE (a.`Form_ID`='3' || a.`Form_ID`='4' || a.`Form_ID`='7') AND a.txn_status='300'";		
	}else if($_SESSION['admin_role']=='Admin')
	{
		if($_SESSION['admin_admin_access']=='Region Wise')
		{
		$sql="SELECT a.*,b.Exhibitor_Name,b.Exhibitor_Country_ID FROM `iijs_payment_master` a,iijs_exhibitor b WHERE (a.`Form_ID`='3' || a.`Form_ID`='4' || a.`Form_ID`='7') AND a.txn_status='300' and b.Exhibitor_Region='".$_SESSION['admin_region_name']."'";		
		}else
		{
		  $sql="SELECT a.*,b.Exhibitor_Name,b.Exhibitor_Country_ID FROM `iijs_payment_master` a,iijs_exhibitor b WHERE (a.`Form_ID`='3' || a.`Form_ID`='4' || a.`Form_ID`='7') AND a.txn_status='300' and b.Exhibitor_DivisionNo='".$_SESSION['admin_division_name']."'";
		}
	} 
	
	if($_SESSION['Exhibitor_Name']!="")
	{
	$sql.=" and (b.Exhibitor_Name like '%".$_SESSION['Exhibitor_Name']."%' || a.Payment_Master_OrderNo like '%".$_SESSION['Exhibitor_Name']."%')";
	}
...
?>	
<div class="pages_1">Total number of order: <?php echo $rCount;?><?php echo pagination($limit,$page,'manage_so.php?action=view&page=',$rCount); //call function to show pagination?></div>        
</div>
</div>
...
$(".so").click(function() {
	...
	//alert(Form_ID);
	if(Form_ID=='3'){ var ajaxurl  = 'sap_standfitting_api.php'; msg = 'Are you sure you want to Create Standfitting Sales order'; }
	if(Form_ID=='4'){ var ajaxurl  = 'sap_badges_api.php';       msg = 'Are you sure you want to Create Badges Sales order'; }
	if(Form_ID=='7'){ var ajaxurl  = 'sap_wifi_api.php';         msg = 'Are you sure you want to Create Wifi Sales order'; }
		//alert(ajaxurl);
