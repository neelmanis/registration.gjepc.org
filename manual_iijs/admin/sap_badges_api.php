...
{	//echo "><pre>"; print_r($_POST);exit;
	...
	$ssx = "select * from  iijs_badge_items where Badge_ID='$Badge_ID' and (Badge_Type='M' || Badge_Type='R' || Badge_Type='E' || Badge_Type='S')";
	...
	{	
		...
		if($Badge_Type=="M"){
			...
			$item_material = "5000000079";
			$item_rate = $itemsResult['Surcharge'];
		}else if($Badge_Type=="E"){
			$item_material = "5000000077";
			if($Create_date>'2021-08-21')
			{ $item_rate = $surcharge; } else { $item_rate = 0; }			
		}
		$item_qty = "1";
