...
<?PHP
  ...
  $export_filename = "StrongRoomDisApproved_" . date('Ymd') . ".xls";
  $result = $conn ->query("SELECT a.`Exhibitor_Code`,d.`Exhibitor_Name`,d.`Exhibitor_Contact_Person`,d.`Exhibitor_Designation`,d.`Exhibitor_Code`,d.`Exhibitor_Address1`,d.`Exhibitor_Address2`,d.`Exhibitor_Address3`,d.`Exhibitor_City`,d.`Exhibitor_State`,con.`Country_Name`,d.`Exhibitor_Pincode`,d.`Exhibitor_Mobile`
...
inner join iijs_badge_items c on c.Badge_Item_ID=a.keyperson2 inner join iijs_country_master con on con.Country_ID=d.Exhibitor_Country_ID where a.`Application_Complete`='N'
