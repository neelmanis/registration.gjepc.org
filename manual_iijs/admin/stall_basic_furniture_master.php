...
if (($_REQUEST['action']=='update')&&($_REQUEST['id']!=''))
{
	...
	$w_track_light=$_REQUEST['w_track_light'];
	$tall_showcase=$_REQUEST['tall_showcase']; 
	 $top_glass_showcase=$_REQUEST['top_glass_showcase']; 
	$m2_window_glass_unit=$_REQUEST['m2_window_glass_unit']; 
	$m1_window_glass_unit= $_REQUEST['m1_window_glass_unit']; 
	$id=$_REQUEST['id'];	
	$sql="update iijs_stall_basic_furniture set ex_section='$ex_section',ex_area='$ex_area',ex_stall_type='$ex_stall_type',no_of_table='$no_of_table',chair='$chair',dustbin='$dustbin',plug_point='$plug_point',50_w_track_light='$w_track_light', tall_showcase='$tall_showcase',top_glass_showcase='$top_glass_showcase',2m_window_glass_unit='$m2_window_glass_unit',1m_window_glass_unit='$m1_window_glass_unit' where id='$id'";	
	if (!$conn ->query($sql))
	{
		die('Error: ' . mysqli_error());
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  	<tr class="orange1">
		...
		<td>Dustbin</td>
		<td>Plug Point</td>
		<td>50_w_track_light</td>
		<td>Tall showcase</td>
		<td>Top glass showcase</td>
		<td>2m Window Glass Unit</td>
		<td>1m Window Glass Unit</td>
	...
	$result = $conn ->query("SELECT * FROM iijs_stall_basic_furniture where 1".$attach." ");
    $rCount=0;
   $rCount = $result->num_rows;		
    ...
    ?>
 	...
 	<tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
		...
		<td><?php echo $row['50_w_track_light']; ?></td>
		<td><?php echo $row['tall_showcase']; ?></td>
		<td><?php echo $row['top_glass_showcase']; ?></td>
		<td><?php echo $row['2m_window_glass_unit']; ?></td>
		<td><?php echo $row['1m_window_glass_unit']; ?></td>
...
if(($_REQUEST['action']=='add') || ($_REQUEST['action']=='edit'))
{
  ...
  if(($_REQUEST['id']!='') || ($_REQUEST['action']=='edit'))
  {
		...
		$w_track_light=$row2['50_w_track_light']; 
		$m2_window_glass_unit=$row2['2m_window_glass_unit']; 
		$m1_window_glass_unit= $row2['1m_window_glass_unit']; 
		}
  }
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
    ...
    <td><input type="text" name="plug_point" id="plug_point" class="input_txt" value="<?php echo $plug_point; ?>" /></td>
     ...
     <tr>
    <td class="content_txt">50_w_track_light <span class="star">*</span></td>
    <td><input type="text" name="w_track_light" id="w_track_light" class="input_txt" value="<?php echo $w_track_light; ?>" /></td>
    </tr>
    ...
    <tr>
    <td class="content_txt">2m_window_glass_unit<span class="star">*</span></td>
    <td><input type="text" name="m2_window_glass_unit" id="m2_window_glass_unit" class="input_txt" value="<?php echo $m2_window_glass_unit; ?>" /></td>
    </tr>
	<tr>
    <td class="content_txt">l m_window_glass_unit <span class="star">*</span></td>
    <td><input type="text" name="m1_window_glass_unit" id="m1_window_glass_unit" class="input_txt" value="<?php echo $m1_window_glass_unit; ?>" /></td>
    </tr>
