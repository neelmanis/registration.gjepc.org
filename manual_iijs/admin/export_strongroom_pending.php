...
<?PHP
  ...
  $export_filename = "StrongRoomPending_" . date('Ymd') . ".csv";
...
inner join iijs_badge_items c on c.Badge_Item_ID=a.keyperson2 inner join iijs_country_master con on con.Country_ID=d.Exhibitor_Country_ID where a.`Application_Complete`='P'
