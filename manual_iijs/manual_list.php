...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>    
	...
	<?php //$specific_area != null && $specific_area != '' && isset($specific_area) ? $Exhibitor_Area = $Exhibitor_Area.'_'.$specific_area : $Exhibitor_Area = $Exhibitor_Area; ?>
...
<tr>
	...
	if($app_status=="P" || $app_status=="N" || $app_status=="Y")
	{
		...
		//echo "<a href='#' onclick='something();'>EXHIBITOR BADGES</a>";		
	} else	{
		echo "<a href='exhibitors_badges.php'>EXHIBITOR BADGES</a>";
		//echo "<a href='#' onclick='something();'>EXHIBITOR BADGES</a>";		
...
<tr>
    <td>FORM NO.8</td>
    <td><a href="electronic_surveillance.php">ELECTRONIC SURVEILLANCE</a></td>
