...
if(isset($_POST['save']) && $_POST['save']=="Save" )
{
	...
	$iijs_safe_rental = $conn ->query("insert into iijs_safe_rental set Exhibitor_Code='$Exhibitor_Code',gstin='$gstin',utr_no='$utr_no',Location_Layout='$Location_Layout',Create_Date='$Create_Date',Modify_Date='$Create_Date',Payment_Master_ID='$Payment_Master_ID'");
	...
	$subject = "IIJS PREMIERE 2022 Exhibitor Manual - SAFE RENTAL";	
...
if(isset($_POST['update']))
{
	...
	$rent = $conn ->query("update iijs_safe_rental set Location_Layout='$Location_Layout',Layout_Approve ='P',Layout_Reason='',Application_Complete='P',utr_no='".$_POST['utr_no']."' where Safe_Rental_ID='$Safe_Rental_ID'");
...
<li>
	...
	<a href="images/pdf/Safe_Rental_Indemnity_Bond_IIJS_Premiere_2022.pdf" target="_blank" ><strong>"AFFIDAVIT CUM INDEMNITY BOND"</strong> </a>printed on your company's letter head and <br />
    <strong>Return to:</strong><br />
     The Gem &amp; Jewellery Export Promotion Council<br />
     AW 1010, Tower A, G Block, Bharat Diamond Bourse, <br />
     Next to ICICI Bank, Bandra-Kurla Complex, <br />
     Bandra Kurla Complex,<br />
     Bandra (E) Mumbai 400 051 - India<br />
     Tel: +91 22 4226 3600 Fax: +91-22 26524764<br />
...
<li>The final deadline for the online form submission is 21st August 2021.</li>
<?php }if($Exhibitor_Country_ID=='IN'){?>
...
<table width="533" border="0" cellpadding="0" cellspacing="0" class="formManual" > 
  ...
  <?php 
  $i=1;
  $querys=$conn->query("select * from iijs_safe_rental_master");
...
<table border="0" cellspacing="0" cellpadding="0" class="formManual" id="abc">
    <tr>
		...
		<th class="bold">Up To <br />11/07/2022</th>
...
<div class="clear">
  ...
  <table border="0" cellspacing="0" cellpadding="0" class="formManual">
	...
	<?php 
	$query=$conn ->query("select gstin,utr_no,Location_Layout,Layout_Approve,Layout_Reason from iijs_safe_rental where Safe_Rental_ID='".$_REQUEST['Safe_Rental_ID']."'");
...
<?php }?>
	...
	<?php } else { if($current_time <= $formDeadLine) { ?>
