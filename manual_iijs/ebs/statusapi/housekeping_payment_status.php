...
//$q=$conn->query("select * from manual_iijs2021.iijs_housekeeping where orderId='HOUSE21547725'");
$orderId=$_REQUEST['orderID'];
if($orderId!="")
	$q=$conn->query("select * from manual_iijs2021.iijs_housekeeping where 1 and  orderId='$orderId'");
else	
	$q=$conn->query("select * from manual_iijs2021.iijs_housekeeping where Payment_Approved='P'");
...
while($r=$q->fetch_assoc()){
	...
	$qregID=$conn->query("select * from manual_iijs2021.iijs_exhibitor where Exhibitor_Code='$Exhibitor_Code'");
