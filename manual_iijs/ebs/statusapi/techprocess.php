...
$date=date("Y-m-d");
$q=$conn->query("select * from visitor_order_detail where payment_status='P' AND regId='$registration_id'");
...
while($r=$q->fetch_assoc()){
	...
	*/
	...
	//if($txn_status=="mukesh"){
		...
		$ssx = "SELECT * FROM `visitor_order_temp` WHERE `registration_id`='$registration_id' AND `show`='$show' AND orderId='$orderId' AND `year`='$year'";
		$query_result=$ssx->fetch_assoc();
