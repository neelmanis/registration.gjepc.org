...
//$q=$conn->query("select * from manual_iijs2021.iijs_payment_master where Form_ID='3' and Payment_Master_Approved='P' limit 1000,100");
$Payment_Master_OrderNo=$_REQUEST['orderID'];
//$q=$conn->query("select * from manual_iijs2021.iijs_payment_master where Form_ID='3' and Payment_Master_OrderNo='$Payment_Master_OrderNo'");

if($Payment_Master_OrderNo!="")
	$q=$conn->query("select * from manual_iijs2021.iijs_payment_master where 1 AND Form_ID='3' AND Payment_Master_OrderNo='$Payment_Master_OrderNo'");
else	
	$q=$conn->query("select * from manual_iijs2021.iijs_payment_master where 1 AND Form_ID='3' AND Payment_Master_Approved='P'");
