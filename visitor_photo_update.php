...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title><?php echo $evt_name;?> Visitor Photo Update </title>
...
<!-- End Facebook Pixel Code -->
  ...
  var regExp = /[a-zA-z]{5}\d{4}[a-zA-Z]{1}/; 
    ...
    setTimeout(function(){
    window.location = "visitor_info_update.php"; 
    }, 3000);
    }
  ...
  <div class="clear"> </div>
      ...
      <div class="container_wrap my-5">
        <div class="container">
         ...
         <?php //echo $evt_name; ?> IIJS PREMIERE 2022 - PHOTO UPLOAD
          </div>
          <div id="loginForm">
