...
if($action=='ADD')
{
$applicant_name=mysql_real_escape_string(strtoupper($_REQUEST['applicant_name']));
$applicant_company_name=mysql_real_escape_string(strtoupper($_REQUEST['applicant_company_name']));
...
<td style="padding:30px;">
    ...
    <tr>
    <td align="left"> <img src="https://iijs.org/images/logo.png"> </td>
  <td align="right" height="60px"><img src="https://gjepc.org/images/gjepc_logon.png" /></td>
    </tr>    
   ...
   <p>Thank you for confirming your presence at IIJS PREMIERE 2019. We are in receipt of your reservation request and the same has been forwarded to the respective hotel for further process. A formal confirmation email will be shared with you shortly via your email address submitted in the form.</p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#751b53">
    <td style="text-align:center; color:#fff;">Copyright, IIJS PREMIERE 2019. All Rights Reserved.</td>
  </tr>
</table>
   </td>
    </tr>
  ...
  4) 100% retention for the entire length of stay will be applicable for any cancellation/amendments post 15th July 2019.<br />
  ...
  10)*Incase of any change in the rate of taxes mandated by the Government at any future date, the same would be applicable and charged on the final billing.</td>
    </tr>
...
<map name="Map" id="Map"><area shape="rect" coords="0,0,185,67" href="https://www.iijs.org/"  target="_blank" style="outline:none;"/><area shape="rect" coords="82,58,83,71" href="#" /></map>
...
<area shape="rect" coords="2,0,312,68" href="https://www.gjepc.org/"  target="_blank" style="outline:none;" />
  ...
  // $to = "neelmani@kwebmaker.com";
   $subject = "Hotel Registration Application Status - IIJS PREMIERE 2019"; 
   $headers  = 'MIME-Version: 1.0' . "\n"; 
   $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\n"; 
   $headers .= 'From: Hotel IIJS PREMIERE 2019 <hotels@gjepc.org>';
...
$("#applicant_country").change(function(){
  ...
  hotel_details_id=$("#hotel_details_id").val();
  if(hotel_details_id==2 || hotel_details_id==6 || hotel_details_id==8 || hotel_details_id==9 || hotel_details_id==10 || hotel_details_id==14 || hotel_details_id==18 || hotel_details_id==19 ||  hotel_details_id==22 || hotel_details_id==23 || hotel_details_id==25 || hotel_details_id==27 || hotel_details_id==30 || hotel_details_id==31 || hotel_details_id==34 || hotel_details_id==35 || hotel_details_id==36)
  {
    $('#share_div').show("");
  }else
  {
  ...
  ck_in_mm=$("#ck_in_mm").val();
  ck_in_yyyy=$("#ck_in_yyyy").val();
  check_in_date=ck_in_yyyy+"-"+ck_in_mm+"-"+ck_in_dd;
  
  ck_out_dd=$("#ck_out_dd").val();
  ck_out_mm=$("#ck_out_mm").val();
  ck_out_yyyy=$("#ck_out_yyyy").val();
  check_out_date=ck_out_yyyy+"-"+ck_out_mm+"-"+ck_out_dd;
  
  
  if(ck_out_dd==1 || ck_out_dd==2)
  {
    if(ck_out_mm==7)
      {
        alert("Kindly select August month");
        $("#ck_out_mm").focus();
        return false;
      }
  }
  ...
  $.ajax({ type: 'POST',
  url: 'ajax_hotel.php',
  data: "actiontype=calculatePayment&diffDays="+diffDays+"&hotel_details_id="+hotel_details_id+"&no_of_room="+no_of_room,
  dataType:'html',
  beforeSend: function(){
           },
  success: function(data){  
...
<div class="inner_container">
  ...
  <tr>
    ...
    <td id="hotelDiv"><select name="hotel_details_id" id="hotel_details_id" class="bgcolor">
        ...
        <?php
        $query=$conn->query("SELECT * from iijs_hotel_details WHERE hotel_id = '$_REQUEST[hid]'");
    ?>
    ...
    <td><input type="text" name="no_of_room" id="no_of_room" class="bgcolor" maxlength="1"/></td>
  </tr>
</table>
 ...
 <tr id="share_div" style="display:none;">
  ...
  <tr>
    ...
    <li>100% retention for the entire length of stay will be applicable for any cancellation/amendments post 15th July 2019. </li>
  ...
  <li>*Incase of any change in the rate of taxes mandated by the Government at any future date, the same would be applicable and charged on the final billing.</li>
    </ol>
...
function myFunction() {
    ...
    location.href="https://iijs.org/hotel_registration.php";
    }
