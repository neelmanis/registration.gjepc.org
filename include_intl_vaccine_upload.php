				...
				<div class="row">
					<div class="col-12">
						...
						<label class="d-inline-block mr-5">
							<input type="radio" id="dose2" name="valueType" value="dose2"/>&nbsp;&nbsp;Final vaccination certificate
						</label>
						<!-- <label class="d-inline-block mr-5">
					...
					<div class="col-12 mb-2">
						<div class="d-block">
							...
							<a href="pdf/<?php echo getTermsandCondition($_SESSION['show'],$conn)?>" target="_blank"><strong>terms and conditions </strong></a> with regard to the visitor's registration at <?php echo getVisEventName($_SESSION['show'],$conn); ?>,
							<br/>
