	...
	GSTINvalidation = () => {
        ...
        if (fi.files.length > 0) {
            for (const i = 0; i <= fi.files.length - 1; i++) {
                ...
                if (file >= 5120) {
                    //alert("File too Big, please select a file less than 2MB");
					$("#gstinSizeError").text("Please select a file less than 5MB"); 
                } /* else if(file < 2048) {
                    alert(
                      "File too small, please select a file greater than 2mb");
                }  else {
					...
					success: function(data){
								 ...
								 if(data==0){
									...
									$.ajax({		
										type: 'POST',
										url: 'ajax.php',
										data: "actiontype=checkGstinApi&company_gstn="+company_gstn,
										dataType:'json',
										beforeSend: function(){
													$('.loader').show();
												},
													  	...
													  	if(data.success == true){
														   if(data.response_code=="100"){
															...
															$("#chkpanuser").html(""); 
														   	...
														   	$("#gstVerifyIcon").hide();
														   	$('#submit').attr("disabled", true);
															$("#chkpanuser").html("Please enter valid GST number").css("color", "red"); 
														   }
														}else{
															$("#gstVerifyIcon").hide();
															$('#submit').attr("disabled", true);
...
<body>
    ...
    <div class="container_wrap">
		<div class="container">
           ...
           <h2 class="title2">Create Account : Domestic User Registration Step - 1</h2>
           	...
           	<div class="d-flex flex-column ">
              	...
              	<div class="row">
					...
					<div class="col-sm-6 col-md-4 form-group">
						...
						<input type="file" class="form-control" id="pan_no_copy" name="pan_no_copy" value="" onchange="PANvalidation()" accept=".jpg,.jpeg,.png,.pdf"/> (Kindly upload Max 2MB. jpeg, png,pdf)<p class="fail" id="panSizeError"></p>	
					</div>			
					...
					<div class="col-sm-6 col-md-4 form-group" id="gst_status">
					...
					<div class="col-sm-6 col-md-4 form-group">
						...
						<input type="file" class="form-control" id="gst_copy" name="gst_copy" value="" onchange="GSTINvalidation()" accept=".jpg,.jpeg,.png,.pdf"/><p class="fail" id="gstinSizeError"></p>
 ...
 <div class="form-group col-lg-4 col-md-6">
					...
					<div class="col-sm-6 col-md-4 form-group" id="organisation_name">
					...
					<div class="col-12">
	  					...
	  					<h4 class="gold_head"><strong>Terms of Agreement</strong></h4>
						
						<div class="body_text">
							These are the general terms and conditions of &nbsp;Gems and Jewellery Export Promotion Council&nbsp;(GJEPC) for use of the GJEPC web site. Please read these terms and conditions carefully as your use of the Site is subject to them. GJEPC reserves the right at its sole discretion to change, modify or add to these terms and conditions without prior notice to you. By continuing to use the Site you agree to be bound by such amended terms.
