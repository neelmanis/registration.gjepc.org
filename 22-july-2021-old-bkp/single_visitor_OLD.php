...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  var regExp = /[a-zA-z]{5}\d{4}[a-zA-Z]{1}/; 
    ...
    $('.loaderWrapper').delay(1000).fadeOut();
    $("#chkPendingPANStatus").html("Payment Already Done...");
   ...
   $("#chkPendingPANStatus").text("You are already registered for this show ");
    ...
    $("#otpSuccess").text("Otp Sent Successfuly");
    $("#otpError").text("");
  ...
  <body>
	...
	<div class="clear"> </div>
      ...
      <div class="container_wrap">
        <div class="container">
          <span class="headtxt">IIJS Visitor Registration </span>
          <div id="loginForm">
              ...
              <form method="POST" id="panForm" autocomplete="off">
                ...
                <div class="d-flex flex-column ">
                  <div class="d-flex flex-row">
                    ...
                    <!--  <div class="d-flex flex-row">
                    <div class="col-50 d-flex  flex-wrap form-group">
                    <p style="font-size: 15px">Register Your Company <a href="domestic_user_registration_step1.php" style="color: blue">Click Here</a></p>
                    </div>                    
                  </div> -->
              </form>
               ...
               <form class="" method="POST" id="sendOTP" autocomplete="off">
                <div class="d-flex flex-column ">
                  <div class="d-flex flex-row">
                    <div class="col-50 d-flex justify-around flex-wrap form-group">
                      ...
                      <div class="col-50">
                        <!-- <input type="text" class="form-control" id="company" name="company" autocomplete="off" disabled /> -->
                        <p id="company"></p>
                      </div>
                    </div>
                    <div class="col-50 d-flex justify-around flex-wrap form-group">
                      ...
                      <div class="col-50">
                        <!--  <input type="text" class="form-control" id="name" name="name" autocomplete="off" disabled /> -->
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <div class="col-50 d-flex justify-around flex-wrap form-group">
                      ...
                      <div class="col-50">
                        <!-- <input type="text" class="form-control" id="email" name="email" autocomplete="off" disabled /> -->
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <div class="col-50 d-flex justify-around flex-wrap form-group">
                      ...
                      <div class="col-50">
                        ...
                        <!-- <input type="text" class="form-control" id="photo" name="photo" autocomplete="off" disabled /> -->
                      </div>
                    </div>
                    <div class="col-50 d-flex justify-around flex-wrap form-group">
                ...
                <form  method="POST"  id="verifyOTP" autocomplete="off">
                  <div class="d-flex flex-column ">
                     <div class="d-flex flex-row form-setup">
