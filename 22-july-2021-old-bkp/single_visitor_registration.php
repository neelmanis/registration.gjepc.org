  ...
  <body>
    <div class="wrapper">
      ...
      <div class="container_wrap">
        <div class="container">
          <h3 class="headtxt" style="margin-top: 50px">IIJS SIGNATURE SHOW - Visitor Registration </h3>
          <div style="display: none;" id="modals">
            ...
            <table class="table_responsive">
              <tbody>
                <tr>
                  <td style="width: 33.33%">Alphabetic Company</td>
                  <td style="width: 33.33%">Dates to be visited</td>
                  <td style="width: 33.33%"rowspan="4">Maximum 2 person per company and for 2 consecutive days per company</td>
                </tr>
                <tr>
                  <td>A - J</td>
                    ...
                    <div class="col-50 d-flex justify-around flex-wrap form-group">
                      ...
                      <div class="col-50">
                        ...
                        <select name="payment_made_for" id="payment_made_for"  class="select-control" style="width:100%">
                          ...
                          <option value="signature2" <?php if($payment_made_for=="signature2") echo "selected"; ?>>IIJS SIGNATURE 2021 Show</option>
                        </select>
                        <?php } ?>
                      </div>
                    </div>
