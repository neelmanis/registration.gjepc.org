...
<?php
	...
	$vaccination_id=$rows['vaccination_id'];
	$vaccination_id_approval=$rows['vaccination_id_approval'];
	$vaccination_id_reason=$rows['vaccination_id_reason'];
	$vaccination_id_updated=$rows['vaccination_id_updated'];
...
function validation(){
	...
	/* vaccination_id validation */
	var vaccination_id=document.getElementById("vaccination_id").value;
	var vaccination_ext=check_vax_extension(vaccination_id);
	
	if(vaccination_id==""){
		document.getElementById("vaccination_error").innerHTML="Please Select file";
		/*flag_visit=1;*/
		return false;	
	}
	else if(!vaccination_ext){
		document.getElementById("vaccination_error").innerHTML="Invalid File";
		/*flag_visit=1;*/
		return false;
	}else{
		document.getElementById("vaccination_error").innerHTML="";
		/*flag_visit=0;*/
	}
...
<div class="inner_container">
    ...
    <div class="clear"></div>    
           ...
           <?php 
            ...
            <!-- ---------------------third photo end---------------------------------------->
            <div class="clear"></div>			
			<!-- --------------------- Vaccination Certificate start---------------------------------------->
            
			<div class="title"><b>Vaccination Certificate </b></div>
            <div class="clear"></div>
            <div class="borderBottom"></div>
			
            <div class="field bottomSpace">
            <div class="userPic">
            <?php if($vaccination_id=="")
			{
				echo "<img src='images/vaccination-icon.jpg' width='100' height='100' />";
			} else
			{ 
				echo "<a href='images/ivr_image/vaccination_id/$vaccination_id' target='_blank'><img src='images/pdf_icon.png'></a>";
            } 
			?>
            </div>

            <div class="leftFile">
            <div class="midTitle">Kindly upload a Vaccination Certificate <sup>*</sup> </div>
            <div class="clear"></div>
            <!--<p><strong>Filename</strong></p>-->
            <input name="vaccination_id" id="vaccination_id" type="file" class="textField" style="margin-bottom:10px; background:#fff;" <?php if($vaccination_id_approval=='Y'){?> disabled="disabled" <?php } ?> /><br>
            <span id="vaccination_error" class="error_msg"></span>
            <div class="clear"></div>
            </div>
            ...
            <div class="appr">
           <?php 
            if($vaccination_id_approval=='P')
            echo "Pending";
            else if($vaccination_id_approval=='Y')
            echo "Approved";
            else if($vaccination_id_approval=='D')
            echo "Disapproved  <span style='margin-left:50px;font-style:italic;'>$vaccination_reason</span>";	
            ?>
            </div>
            </div>
      ...
      <input type="submit" name="input" value="Submit" class="cta" />
        ...
        <?php if($personal_info_approval=='Y' && $photo_approval=='Y' && $valid_passport_copy_approval=='Y' && $visiting_card_approval=='Y' && $nri_photo_approval=='Y' && $vaccination_id_approval=='Y'){ ?>  
