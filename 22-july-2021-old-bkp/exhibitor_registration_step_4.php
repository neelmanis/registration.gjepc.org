...
if($_SESSION['eventInfo']['event_selected']=="signature"){ $event_for="IIJS Signature 2021"; } 
if($_SESSION['eventInfo']['event_selected']=="iijs"){ $event_for="IIJS 2021"; $eventMail = "IIJS Premiere 2021"; }
...
{	
	...
	if($region=='HO-MUM (M)'){$to_admin='mukesh@gjepcindia.com'; }
	if($region=='RO-CHE'){$to_admin='p.anand@gjepcindia.com'; }
	if($region=='RO-DEL'){$to_admin='pranabes@gjepcindia.com'; }
	if($region=='RO-JAI'){$to_admin='ajaypurohit@gjepcindia.com,shyambilochi@gjepcindia.com'; }
...
if($gid!='')
{
	...
	if($payment_mode=="RTGS"){
		...
		$cheque_dd_no = $conn->real_escape_string($_POST["cheque_dd_no"]);
		$cheque_dd_date = $conn->real_escape_string(date("Y-m-d", strtotime($_POST["cheque_dd_date"])));
		$cheque_drawn_bank_name = $conn->real_escape_string($_POST["cheque_drawn_bank_name"]);
		$cheque_drawn_branch_name = $conn->real_escape_string($_POST["cheque_drawn_branch_name"]);
	}
	...
	$cheque_tds_deducted = "";
		...
		//$sqlm = "select * from  exh_registration where uid='$uid' AND gid='$gid'";
		...
		if(empty($amount_payable)) {  $signup_error = "Please Select Amount Payable"; } else {
		...
		$insert_query = "insert into exh_reg_payment_details set gid='$gid', uid='$uid', int_type='$int_type', payment_mode='$payment_mode', cheque_dd_no='$cheque_dd_no', cheque_dd_date='$cheque_dd_date', cheque_drawn_bank_name='$cheque_drawn_bank_name', cheque_drawn_branch_name='$cheque_drawn_branch_name', bank_acc_no='$bank_acc_no', name_bank='$name_bank', name_bank_branch='$name_bank_branch', ifsc_code='$ifsc_code', int_acc_type='$int_acc_type', created_date=NOW(), payment_status='$payment_status', document_status='$document_status', application_status='$application_status', erp_push='$erp_push', `tds_holder`='$tds_holder',`net_payable_amount`='$net_payable_amount',`percentage`='$amount_payable', `cheque_tds_gross_amount`='$cheque_tds_gross_amount',`cheque_tds_per`='$cheque_tds_per',`cheque_tds_amount`='$cheque_tds_amount',`cheque_tds_Netamount`='$cheque_tds_Netamount',`cheque_tds_deducted`='$cheque_tds_deducted',`show`='$event_for',event_selected='$event_selected',year='$year'";
		$result4 = $conn->query($insert_query);
		if(!$result4) { die('Error: payment Details insert query failed' . $conn->error); }
...
<table width="100%" border="0" background="#fff" cellpadding="0" cellspacing="0">
	<tr>
    	...
    	<td align="right"><a href="https://gjepc.org/iijs-premiere/"><img src="https://registration.gjepc.org/images/IIJS-Premiere-2021-logo.png"/></a></td>
    </tr> 
	...
	<tr>
		...
		<p><strong>Application No. : EXREG/'.$eventMail.'/2021/'.$resultm['gid'].'</strong></p>
...
<table width="100%" border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="8" bgcolor="#f4f4f4" style="border-collapse:collapse; float:left;">
    ...
    <tr>
        ...
        <td valign="top">'.$resultm['selected_premium_type'].'</td>
    </tr>
	<tr>
        <td valign="top" height="83px"><strong>Scheme</strong></td>
        <td valign="top">'.$resultm['selected_scheme_type'].'</td>
    </tr>
</table>
...
<table width="100%" border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="8" bgcolor="#f4f4f4" style="border-collapse:collapse; float:right;">
  ...
  <tr valign="top">
   ...
   <!--<tr valign="top">
    ...
    <td width="48%">IIJS Premiere 2021 Participation charges</td>
    </tr>
    </table> -->
    </td>
    </tr>
	...
	<p>Kind Regards,</p>   
	<p><strong>IIJS Premiere Web Team,</strong></p>
...
<a href="#" style="text-decoration:none; color:#14b3da;">Registration Status</a> | <a href="#" style="text-decoration:none; color:#14b3da;">Travel & Hotel</a> | <a href="#" style="text-decoration:none; color:#14b3da;">Show Updates</a> | <a href="#" style="text-decoration:none; color:#14b3da;">Helpdesk</a> | <a href="#" style="text-decoration:none; color:#14b3da;">FAQs</a> | <a href="#" style="text-decoration:none; color:#14b3da;">OBMP</a>
	...
	*/
	...
	//$to = $_SESSION['EMAILID'].",".$to_admin.",notification@gjepcindia.com,iijs.gjepc@gmail.com"; 
	$to ='neelmani@kwebmaker.com,mukesh@gjepcindia.com';
	$subject = "Exhibitor Registration for ".$eventMail." (EXREG/".$eventMail."/2021/".$resultm['exh_id']."/dated".date('Y-m-d').")";
	$cc = "";
...
<div class="inner_container">
    ...
    <div class="form_main">        
		...
		<p><strong><span style="color: red;">All the applicants will have to update UTR No. and TDS Details on Dashboard after submitting space application form.</span></strong></p>
        </div>
        ...
        <div class="clear"></div>
        </div><?php if($event_selected=='iijs'){?><p style="text-align: center; line-height:10px; margin-bottom:10px;">* Advance provided for IIJS Premiere 2021 is not refundable</p><?php } ?>
		...
		<?php if($last_yr_participant=="YES"){ ?>
		<div class="field_box">
        <div class="field_name"><strong>TDS Deducted</strong></div>
        <div class="field_input">
		Yes <input type="radio" id="chkYes" value="Yes" name="tds_holder"/>
		No <input type="radio" id="chkNo" value="No" name="tds_holder"/></label>
		</div>
        <div class="clear"></div>
        </div>
		<?php } ?>
		...
		<div class="field_box" id="holder_star" <?php if($tds_holder!='Yes'){ ?> style="display: none"<?php } ?>>	
			...
			<div class="field_box">
				<div class="field_name">TDS Percentage @1.5%, 2 %,7.5%, 10%<span>*</span> : </div>
				<div class="field_input">
			...
			<div class="field_box">
                ...
                <div class="field_input">
				<input name="cheque_tds_Netamount" type="text" id="cheque_tds_Netamount" class="textField" value="<?php echo $cheque_tds_Netamount; ?>" />
		...
		<strong>RTGS/NEFT IFS Code : </strong> ICIC0000348<br/>
...
A system generated notification will be sent to you on successful approval of your application</p>
        ...
        <div class="field_input">
		<input type="text" name="bank_acc_no" id="bank_acc_no" class="bgcolor" value="<?php if($int_type == "N") echo $bank_acc_no; else echo $int_bank_acc_no; ?>"/>
        ...
        <div class="field_input">
		<input type="text" name="bank_name" id="bank_name" class="bgcolor" value="<?php if($int_type == "N") echo $name_bank; else echo $int_name_bank; ?>" />
        ...
        <div class="field_input">
		<input type="text" name="branch_name" id="branch_name" class="bgcolor" value="<?php if($int_type == "N") echo $name_bank_branch; else echo $int_name_bank_branch; ?>" />
        ...
        <div class="field_input"><input type="submit" class="button" value="Submit" /> </div>
        <div class="clear"></div>
        </div>
