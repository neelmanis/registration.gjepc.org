...
function uploadSingleVIsitorCovid($file_name,$file_temp,$file_type,$file_size,$mobile,$name)
{
	$upload_image = '';
	...
	else if($file_name != '')
	{
		...
		{
			$random_name = rand();
			 $target_path = $target_folder.$mobile."_".$file_name;
			if(@move_uploaded_file($file_temp, $target_path))
			{
				  $upload_image = $mobile."_".$file_name;
			}
			else
			{
				 $upload_image = "fail";
