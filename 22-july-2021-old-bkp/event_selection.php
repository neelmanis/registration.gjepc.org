...
if($action == "save")
{
	...
	if($count > 0){
	    ...
	    $sql = "INSERT INTO `exh_event_selected`(`event`, `year`, `registration_id`) VALUES ('$event','2021','$registration_id')";
	}
...
<div class="inner_container">
	...
	<?php
	$sql = "select * from exh_reg_payment_details where uid='$registration_id' AND `year`='2021' order by payment_id desc limit 0,1";
	$ans = $conn->query($sql);
    ...
    <form method="POST" name="eventForm" id="eventForm" autocomplete="off">
        ...
        <div class="d-flex flex-column ">
              <div class="d-flex flex-row form-setup">
				...
				$getEvent = "SELECT * FROM `exh_event_master` WHERE status='1'";
				else 
		...
		<input type="checkbox" name="agree" id="agree"style="display: inline-block;" ><strong> I have read the <a href="https://gjepc.org/emailer_gjepc/06.03.2021/03/index.html" target="_blank" style="color: red"> Stall booking circular </a>,<a href="https://gjepc.org/emailer_gjepc/06.03.2021/03/Booth%20Allotment%20Preference%20and%20Procedure%20at%20IIJS%20Signature%202021.pdf" target="_blank" style="color: red"> Guidelines Rules Regulations for Allotment of Booths</a> , <a href="https://gjepc.org/emailer_gjepc/06.03.2021/SIGNATURE_2021_Print_Acknowledge_Domestic_final.pdf" target="_blank" style="color: red"> Terms & Conditions </a></strong> 
