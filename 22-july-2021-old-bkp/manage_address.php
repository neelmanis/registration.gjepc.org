...
$sql = "select * from exh_reg_payment_details where uid='$registration_id' and `show`='SIGNATUURE 2021' AND allow_visitor='N' order by payment_id desc limit 0,1";
$ans = $conn->query($sql);
$nans=$ans->num_rows;
if($nans>0){
...
.address_box{width: 260px; min-height: 100px;background: #ccc;border-bottom:4px solid #a59459;border-radius: 7px}
    ...
    <div class="">
      ...
      <div id="loginForm">
        ...
        <div>
			...
			<div><a href="address.php" class="btn btn_add" style="float: left;" >Add Address</a><a href="visitor_registration.php"  class="btn btn_add" style="float: right;">Visitor Registration</a>
				<div class="clear"></div>
			</div>
