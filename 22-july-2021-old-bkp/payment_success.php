...
if(isset($_POST))
{
   ...
   /* echo "<pre>";
	...
	{		
		...
		$messagev = "Thank you for registration at IIJS SIGNATURE 2021. Your Registration Number is $visitor_id for ORDER ID $orderId.Your badge will be couriered shortly";
	//	get_data($messagev,$visitorMobile); 	
		
		$messageo = "Thank you for registration at IIJS SIGNATURE 2021. Your ORDER ID for Visitor registration is $orderId. Your badge will be couriered shortly";
    ...
    <tbody>    
    	<tr>
            <td align="left"><img id="ri" src="http://registration.gjepc.org/images/mailer/gjepc_logo.png">
		...
		<div id="formWrapper">
		<p>Your transaction is successfully Completed. Thank you for your participation in IIJS PREMIERE 2020.</p>
