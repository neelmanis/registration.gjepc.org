<div class="head_main">
	...
	<div class="logo pr-3"><a href="#"><img src="images/IIJS-Premiere-2021-logo.png?v=1.3" class="logo_img"></a></div>
  ...
  <div class="text-center">
    ...
    <a href="#" style="font-size:14px;">Change Password</a> </div>    
      ...
      <div  class="navi">
        ...
        <nav>
          <ul data-breakpoint="800" class="flexnav nav navigation-menu new_menu">
            <li><a href="https://gjepc.org/iijs-signature/">Home</a></li>
            <!--<li>
              <a href="#">About Show</a>
              <ul>
			...
			<li>
                ...
                <ul>
                   ...
                   <li><a href="https://gjepc.org/emailer_gjepc/06.03.2021/03/index.html" target="_blank" class="d-block"> Circular for Opening of Stall booking at 14th edition of IIJS Signature 2021, 07 to 12 April 2021 (6 days)</a></li>
            ...
            <li>
              ...
              <!--<ul>
                <li><a href="login.php?visitor=international">International Visitor Registration</a></li>
