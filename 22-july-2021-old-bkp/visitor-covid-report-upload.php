...
<!-- End Facebook Pixel Code -->
  ...
  var regExp = /[a-zA-z]{5}\d{4}[a-zA-Z]{1}/; 
    ...
    $('.loaderWrapper').delay(1000).fadeOut();
    $("#chkPendingPANStatus").html("You are not registered for any event");
        ...
        <div class="container">
          ...
          <div id="loginForm" >
            <div class="box-shadow">
              ...
              <!--<div><span>Virtual 2.0 Registration Closed Now</span></div>-->
           ...
           <h3 class="success">Please Check in your device for OTP Number</h3>  
               ...
               <!--  <div class="form-notes black_bg">
				...
				<li> <strong class="gold_text">For Approved Visitors</strong> </li>
