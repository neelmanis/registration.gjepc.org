...
$action=$_REQUEST['action'];
   ...
   $resultData=$conn->query($Data);
	...
	$company_name = $rowsData['company_name'];
...
<div id="form" style="display:flex; flex-wrap:wrap;">
    ...
    <input name="designation" id="designation" type="text" class="textField" value="<?php echo $designation;?>" autocomplete="off"/>
    ...
    <input name="company_name" type="text"  class="textField" id="company_name" value="<?php echo $company_name;?>" autocomplete="off"/>
    ...
    <input name="email" type="text" id="email" class="textField" value="<?php echo $email;?>" autocomplete="off"/>
    <div class="clear"></div>
    </div>            
...
<div class="form-item w-100" id="edit-terms-checkbox-wrapper">
    ...
    <div class="form-item w-100" id="edit-terms-checkbox-wrapper">
    <label class="option" for="edit-terms-checkbox"><input type="checkbox" name="visit_iijs_virtual" id="visit_iijs_virtual" checked value="1" class="form-checkbox"> I am interested to visit IIJS Premiere 2021 Show</label>
    <div class="clear"></div>
    </div>
    <div class="clear"></div>

<div class=""><input type="submit" name="submit" value="Proceed To Next Step" class="cta"></div>
<?php } else { ?>
