  ...
  <body>
    <div class="wrapper">
      ...
      <div class="container_wrap">
        <div class="container">
        <h3 class="headtxt" style="margin-top: 50px">IIJS Premiere SHOW - International Visitor Registration </h3>
        <div id="loginForm">
            ...
            <div id="formContainer">
              ...
              <?php			  
              $sqlPaymentCheck = "SELECT * FROM ivr_registration_details WHERE eid='$eid' AND uid= '$uid' AND trade_show='IIJS 2021'";
                  ...
                  <div class="d-flex flex-row form-setup">
                    <div class="col-50 d-flex justify-around flex-wrap form-group">
                      ...
                      <div class="col-50">
						...
						<option value="IIJS 2021">IIJS Premiere 2021</option>
						</select>
					</div>
                    </div>                    
                  </div>
