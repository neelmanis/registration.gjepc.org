...
$sql = "select * from exh_reg_payment_details where uid='$registration_id' AND `year`='2021' AND allow_visitor='N' order by payment_id desc limit 0,1";
...
{     
	...
	if($resultx)
	{
	$message = "Dear ".$name.", Welcome to IIJS SIGNATURE 2021, your data for Visitor badge has been updated successfully, you will be notified on approval/disapproval";
