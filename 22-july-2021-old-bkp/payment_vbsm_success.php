...
$message ='<table class="table2" width="80%" bgcolor="#fbfbfb" align="center" style="margin:2% auto; border:2px solid #ddd; font-family:Arial, sans-serif; color:#333333; font-size:13px; border-radius:10px;padding:10px;">	
	...
	//	$to =$email.',pvr@gjepcindia.com';
		$subject = "Thank you for registering at IIJS Virtual Show 2.0"; 
		...
		<h1 style="color:green;margin-top: 50px">Successful Registration</h1>
		<div id="formWrapper">
		<p>Thank you for registering to visit IIJS Virtual Show 2.0.</p>
		</div>
		<div class="clear"></div>
		</div>
		</div>
