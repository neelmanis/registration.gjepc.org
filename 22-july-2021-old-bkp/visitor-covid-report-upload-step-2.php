		...
		<div class="container">
			...
			<div class="row mt-5">
				...
				<div class="col-12 mt-3">
		            ...
		            <div class="alert-danger p-3"><p class="mb-0"><?php echo $_SESSION['vaccineStatusMessage'];?></p></div>
				...
				<div class="col-12 mb-2"  >
					...
					<div class="form-group row">
						<div class="col-6">
						    ...
						    <i>Files Allowed : pdf,jpg,jpeg,png</i>
						</div>
...
{   
  ...
  //       filesize: 2,
    ...
    var fallbackToStore = function() {
	   window.location.replace('gjepc://details?id=org.gjepc');
	};
	var openApp = function() {
	  window.location.replace('https://registration.gjepc.org/visitor-covid-report-upload-step-2.php://');
	};
