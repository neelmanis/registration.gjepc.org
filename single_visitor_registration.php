...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    agree:{
    required: "Please agree to whatsapp services before submitting"
    },
    },
    ...
    if(selected_show =="iijs22"){
      message = "Dear visitor - Are you sure you want to register for IIJS Premiere 2022 show , dated th - 8th August 2022  ";
    }else if(selected_show =="signature23"){
      message = "Dear visitor - Are you sure you want to register for IIJS Signature 2023 show , dated 5th - 9th January 2023  ";
    ...
    }else if(selected_show =="stcombo23"){
      message = "Dear visitor - Are you sure you want to register for IIJS Signature 2023 & IIJS Tritiya 2023 show. ";
    }else if(selected_show =="igjme23"){
      message = "Dear visitor - Are you sure you want to register for IIJS Machinery 2023 show. This badge is valid to visit only in MACHINERY Hall ";
    }
    if(confirm(message)){
      $.ajax({
      type:'POST',
             ...
             //    } else {
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4 form-group">
                    ...
                    <select name="payment_made_for" id="payment_made_for"  class="form-control" style="width:100%">
                      ...
                      <?php 
                      if($visitor_id == "40436"){
                        $sql_event_nm = "SELECT * FROM `visitor_event_master`  WHERE `id` = '2' OR `id` = '3' OR  `id` = '6'  order by `serial_no` ASC";  
                      }else{
              ...
              <form class="" method="POST" id="singleVisitorRegistration" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <?php
                     ...
                     // if($visitor_id == "40436"){
                        if(empty($registered_events)){
                          ...
                          if(in_array("signature23",$registered_events)){
                            $sql_event = "SELECT * FROM `visitor_event_master` WHERE  `id` = '3'   order by `serial_no` ASC";
                          }else if(in_array("iijstritiya23",$registered_events)){
                            $sql_event = "SELECT * FROM `visitor_event_master` WHERE  (`id` = '2' OR `id` = '4' )   order by `serial_no` ASC";
                          }else if(in_array("combo23",$registered_events) || in_array("stcombo23",$registered_events)){
                            $sql_event = "SELECT * FROM `visitor_event_master` WHERE `status` ='1'   limit 0";
                          }else if(in_array("igjme23", $registered_events) ){
                            $sql_event = "SELECT * FROM `visitor_event_master`    limit 0";
                          }else{
                            $sql_event = "SELECT * FROM `visitor_event_master` WHERE `status` ='1'  order by `serial_no` ASC";
                          }
                  ...
                  <div class="col-12 form-group">
                  <a class="" style="color: blue; cursor: pointer; font-size: 15px;" data-toggle="modal" data-target="#exampleModal133" > <input type="checkbox" name="agree_plantation" /> I agree to plant 5 trees with the cost of 155/- per tree.  <span class="blink">Click Here.</span></a>
                </div>
                     
                  <div class="col-12"><a data-fancybox data-src="#modals" href="javascript:;" class="agree-terms"></a></div>
                  <?php if(in_array("combo23",$registered_events) || in_array("tscombo23",$registered_events)){ ?> 
                  <div class="col-12">
                    <div class="alert alert-success" role="alert">
                     You are already registered for IIJS SIGNATURE 2023 + IIJS TRITIYA 2023 show
                    </div>

                  </div>
                  <?php } ?>
                  <?php if(in_array("signature23",$registered_events) ){ ?> 
                  <div class="col-12">
                    <div class="alert alert-success" role="alert">
                     You are already registered for IIJS SIGNATURE 2023 show
                    </div>

                  </div>
                  <?php }?>
                  <?php if(in_array("iijstritiya23",$registered_events) ){ ?> 
                  <div class="col-12">
                    <div class="alert alert-success" role="alert">
                     You are already registered for IIJS TRITIYA 2023 show
                    </div>
                  ...
                  <?php 
                  //if($registration_id =="600865002" || $registration_id == "600877871"){
